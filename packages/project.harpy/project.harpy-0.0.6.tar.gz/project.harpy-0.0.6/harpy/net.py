...
class Thread(threading.Thread):
    ...
    def __init__(self, sock: socket.socket, network: ipaddress.IPv4Network):
        super().__init__()

        self.sock = sock
        self.network = network

        self.src = sock.getsockname()[-1].hex()
        self.sha = self.src
...
class Sniffer(Thread):
    ...
    def __init__(self, s, n, db: dict[str, str], exclude: bool, strict: bool):
        super().__init__(s, n)
