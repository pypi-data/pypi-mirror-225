...
class Contract(models.Model):
    ...
    def update_sharing_mobiles_tariffs_after_joining_shared_bond(
        ...
        """When a contract joins a shared bond, update the mobile tariffs of those
        that used to share data with it accordingly"""
        ...
        elif len(sharing_contracts) == 2:
            # If shared bond takes a third mobile contract, change the tariff
            # from the two already sharing mobile contracts
