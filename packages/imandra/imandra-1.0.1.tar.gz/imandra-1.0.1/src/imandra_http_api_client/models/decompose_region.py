...
class DecomposeRegion(BaseModel):
    """
    DecomposeRegion
    """
    constraints: conlist(Dict[str, Any]) = Field(...)
    invariant: Optional[Dict[str, Any]] = None
    __properties = ["constraints", "invariant"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecomposeRegion:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecomposeRegion:
        """Create an instance of DecomposeRegion from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecomposeRegion.parse_obj(obj)

        _obj = DecomposeRegion.parse_obj({
