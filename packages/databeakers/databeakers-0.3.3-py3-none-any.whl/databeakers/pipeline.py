...
class Pipeline:
    ...
    def run_seed(
        ...
        **kwargs,
        ...
        """
        Current thinking on this is that all failed runs should be saved, but
        only in increments of save_partial_chunks.

        This allows inspection of the data to see what went wrong...
        Questions: why not save the rest, why not keep the count accurate?
        Answers: would need to go back to buffer approach, probably not worth
                 it
        """
