...
class CfnServer(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_transfer.CfnServer.ProtocolProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
        ...
        def __init__(self) -> None:
            ...
            *Allowed values* : One or more of ``SFTP`` , ``FTPS`` , ``FTP`` , ``AS2``
            ...
            Example::
                ...
                protocol_property = transfer.CfnServer.ProtocolProperty()
            '''
            self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_transfer.CfnServer.StructuredLogDestinationProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    class StructuredLogDestinationProperty:
        def __init__(self) -> None:
            ...
            Example::
                ...
                structured_log_destination_property = transfer.CfnServer.StructuredLogDestinationProperty()
            '''
            self._values: typing.Dict[builtins.str, typing.Any] = {}
        ...
        def __repr__(self) -> str:
            return "StructuredLogDestinationProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
...
class CfnUser(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_transfer.CfnUser.SshPublicKeyProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    class SshPublicKeyProperty:
        def __init__(self) -> None:
            ...
            *SshPublicKeyBody*
            ...
            Example::
                ...
                ssh_public_key_property = transfer.CfnUser.SshPublicKeyProperty()
            '''
            self._values: typing.Dict[builtins.str, typing.Any] = {}
        ...
        def __repr__(self) -> str:
            return "SshPublicKeyProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
