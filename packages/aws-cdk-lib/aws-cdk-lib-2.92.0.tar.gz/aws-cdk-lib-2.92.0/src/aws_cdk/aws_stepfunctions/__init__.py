...
class CfnStateMachine(
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_stepfunctions.CfnStateMachine.DefinitionProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    class DefinitionProperty:
        def __init__(self) -> None:
            ...
            Example::
                ...
                definition_property = stepfunctions.CfnStateMachine.DefinitionProperty()
            '''
            self._values: typing.Dict[builtins.str, typing.Any] = {}
...
class _DefinitionBodyProxy(DefinitionBody):
    ...
    def bind(
        ...
        *,
        ...
        return typing.cast("DefinitionConfig", jsii.invoke(self, "bind", [scope, sfn_principal, sfn_props]))
...
class FileDefinitionBody(
    ...
    def bind(
        ...
        *,
        ...
        return typing.cast(DefinitionConfig, jsii.invoke(self, "bind", [scope, _sfn_principal, _sfn_props]))
...
class StringDefinitionBody(
    ...
    def bind(
        ...
        *,
        ...
        return typing.cast(DefinitionConfig, jsii.invoke(self, "bind", [_scope, _sfn_principal, _sfn_props]))
