...
class DatabricksLoadControl:
    ...
    def write(self, source: str, path: str, file_name: str, file_extension: str = '', subsource: str = '', delimeter: str = '', encoding: str = '', column_name: str = '', column_type: str = '', default_value: str = '', environment: str = '', zone: str = '', region: str = '', user: str = '', email: str = '', status: str = '', columns: List[str] = [], header: str = 'true') -> None:
        """
        ...
        spark.sql(f"""
            INSERT INTO {load_control_database}.meta (source, subsource, delimeter, encoding, columns, header)
            VALUES ('{source}', '{subsource}', '{delimeter}', '{encoding}', '{''.join(columns)}', '{header}')       
        """)
