...
def _colored_text(txt: str, color: str) -> str:
    return color + txt + BASH_END_COLOR


def orange_text(txt: str) -> str:
    return _colored_text(txt, BASH_ORANGE_COLOR)


def purple_text(txt: str) -> str:
    return _colored_text(txt, BASH_PURPLE_COLOR)


def red_text(txt: str) -> str:
    return _colored_text(txt, BASH_RED_COLOR)


def green_text(txt: str) -> str:
    return _colored_text(txt, BASH_GREEN_COLOR)
