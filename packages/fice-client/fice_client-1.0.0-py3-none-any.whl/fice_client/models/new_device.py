...
class NewDevice(BaseModel):
    ...
    __properties = ["hostname", "ipaddress", "platform", "firmware", "configs"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewDevice:
        """Create an instance of NewDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewDevice.parse_obj(obj)

        _obj = NewDevice.parse_obj({
