...
class RuleWithInputContext(BaseModel):
    """
    RuleWithInputContext
    """
    ...
    __properties = ["name", "description", "ruleset", "kind", "platform", "severity", "command", "simplified", "definition", "hostname", "data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleWithInputContext:
        """Create an instance of RuleWithInputContext from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleWithInputContext:
        """Create an instance of RuleWithInputContext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleWithInputContext.parse_obj(obj)

        _obj = RuleWithInputContext.parse_obj({
            "name": obj.get("name"),
