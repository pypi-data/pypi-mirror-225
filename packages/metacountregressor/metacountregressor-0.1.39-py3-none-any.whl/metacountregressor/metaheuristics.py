...
def differential_evolution(objective_function, initial_slns=None, **kwargs):
    ...
    if objective_function.is_multi:
        ...
        iterations , solutions, best_solutions, best_fitness, best_struct, average_best = de.differential_evolution_run(initial_slns=initial_slns, mod_init = man)
...
class Metaheuristic(object):
    ...
    def _intialize(self, initial_slns = None, model_nature = None):
...
class SimulatedAnnealing(object):
    ...
    def run(self, initial_slns=None, mod_init = None):
        ...
        self._obj_fun.get_fitness(self.best_struct, muli =  self.pf.get_objective_is_multi(), verbose=True)
