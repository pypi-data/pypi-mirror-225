...
def test_title_fragments(wikipedia_lorem_ipsum):
	assert wikipedia_lorem_ipsum.title_fragments == ('Lorem', 'Ipsum')


def test_title_fragments_no_subpage(special_blank_page):
	new_title = special_blank_page / 'Foobar'
	assert new_title.title_fragments == tuple(['BlankPage/Foobar'])
