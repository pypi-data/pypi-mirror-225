...
class Transformer:
    ...
    @staticmethod
    def remove_currency_from_amount(value: str) -> str:
        """
    ...
    @staticmethod
    def extract_phone_number(value: str) -> int | ValidationError:
        """
        ...
        Returns:
            int: The extracted phone number
        """
        try:
    ...
    def extract_country_code(value: str) -> int | str | ValidationError:
        ...
        Returns:
            int: The extracted country code.
        """
        try:
            cleaned_number = Transformer.remove_punctuations_except_plus(value=value)
            phone_number = phonenumbers.parse(number=cleaned_number)
