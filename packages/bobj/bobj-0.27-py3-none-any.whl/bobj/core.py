...
class validate:
    def __init__(self, url, **kwargs):
        ...
        self.url = url
        self.login = login._bovalidation(self.url, **kwargs)
        self.user_management = users._usermanagement()
        self.folders_management = folders._foldermanagement()
        self.group_management = groups._groupmanagement()
