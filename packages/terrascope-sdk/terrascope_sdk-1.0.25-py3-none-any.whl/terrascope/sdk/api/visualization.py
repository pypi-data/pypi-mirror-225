...
from terrascope_api.models.visualization_pb2 import (
    VisualizationGetRequest, Visualization, VisualizerConfigAlgorithmVersionCreateRequest, VisualizerConfigAlgorithmVersionCreateResponse
)
...
class APIVisualization:
    ...
    async def create_visualizer_config_algo_version(self, visualizer_config_id: str,
                                            algorithm_version_id: str) -> VisualizerConfigAlgorithmVersionCreateResponse:
        request = VisualizerConfigAlgorithmVersionCreateRequest(
