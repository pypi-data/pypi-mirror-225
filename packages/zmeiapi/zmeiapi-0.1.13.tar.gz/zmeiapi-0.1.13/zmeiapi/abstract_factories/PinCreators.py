...
class FA3DPinsCreator(ABC):
    ...
    @abstractmethod
    def create_layers(self, cells_numbers, cells_types, pins_types, pins_materials, pins_radiuses, **kwargs):
        pass

    @abstractmethod
    def create_layer_pins(
            self, layer_cells_numbers, layer_cells_types, layer_pins_types, layer_pins_materials, layer_pins_radiuses,
            **kwargs
    ):
        pass
