...
class ClariusStreamer(Streamer):
    ...
    def newImageFn(self, newImage: "void const *", nfo: "_CusProcessedImageInfo const *", npos: "int", pos: "_CusPosInfo const *") -> "void":
...
class Colormap(object):
    ...
    def getAsOpenCLBuffer(self, device: "fast::OpenCLDevice::pointer") -> "cl::Buffer":
        ...
        """
        return _fast.Colormap_getAsOpenCLBuffer(self, device)
...
class ApplyColormap(ProcessObject):
    ...
    @staticmethod
    def create(colormap: "Colormap") -> "std::shared_ptr< fast::ApplyColormap >":
        r"""
        Create instance
        ...
        :return: instance
        """
        return _fast.ApplyColormap_create(colormap)
...
def ApplyColormap_create(colormap: "Colormap") -> "std::shared_ptr< fast::ApplyColormap >":
    r"""
    Create instance
    :type colormap: :py:class:`Colormap`
    :param colormap: Colormap to apply
...
class PatchGenerator(Streamer):
    ...
    @staticmethod
    def create(width: "int", height: "int", depth: "int"=1, level: "int"=0, magnification: "int"=-1, overlapPercent: "float"=0.0, maskThreshold: "float"=0.5, paddingValue: "int"=-1) -> "std::shared_ptr< fast::PatchGenerator >":
        r"""
    ...
    def setPatchMagnification(self, magnification: "int") -> "void":
...
def PatchGenerator_create(width: "int", height: "int", depth: "int"=1, level: "int"=0, magnification: "int"=-1, overlapPercent: "float"=0.0, maskThreshold: "float"=0.5, paddingValue: "int"=-1) -> "std::shared_ptr< fast::PatchGenerator >":
    r"""
    Creates a PatchGenerator instance
    :type width: int
    :param width: Width of patch (Note: patches can be smaller at boundaries and will be padded)
...
class PatchStitcher(ProcessObject):
    ...
    @staticmethod
    def create(patchesAreCropped: "bool"=False) -> "std::shared_ptr< fast::PatchStitcher >":
        r"""
        Create instance
        :rtype: :py:class:`PatchStitcher`
        :return: instance
        """
        return _fast.PatchStitcher_create(patchesAreCropped)
...
def PatchStitcher_create(patchesAreCropped: "bool"=False) -> "std::shared_ptr< fast::PatchStitcher >":
    r"""
    Create instance
    :rtype: :py:class:`PatchStitcher`
    :return: instance
...
class RegionList(object):
    ...
    @staticmethod
    def create(data: "std::vector< fast::Region,std::allocator< fast::Region > >") -> "std::shared_ptr< fast::RegionList >":
...
def RegionList_create(data: "std::vector< fast::Region,std::allocator< fast::Region > >") -> "std::shared_ptr< fast::RegionList >":
    return _fast.RegionList_create(data)
...
class TissueMicroArrayExtractor(Streamer):
    ...
    @staticmethod
    def create(level: "int"=0, areaThreshold: "float"=0.5) -> "std::shared_ptr< fast::TissueMicroArrayExtractor >":
        r"""
        Create instance
        :type level: int
        ...
        :return: instance
        """
        return _fast.TissueMicroArrayExtractor_create(level, areaThreshold)
...
def TissueMicroArrayExtractor_create(level: "int"=0, areaThreshold: "float"=0.5) -> "std::shared_ptr< fast::TissueMicroArrayExtractor >":
    r"""
    Create instance
    :type level: int
    :param level: Which image pyramid level to extract TMAs from. Default is 0 which is highest resolution level.
...
class TissueSegmentation(ProcessObject):
    ...
    @staticmethod
    def create(threshold: "int"=85, dilationSize: "int"=9, erosionSize: "int"=9, filterZeros: "bool"=True) -> "std::shared_ptr< fast::TissueSegmentation >":
        r"""
        ...
        """
        return _fast.TissueSegmentation_create(threshold, dilationSize, erosionSize, filterZeros)
...
def TissueSegmentation_create(threshold: "int"=85, dilationSize: "int"=9, erosionSize: "int"=9, filterZeros: "bool"=True) -> "std::shared_ptr< fast::TissueSegmentation >":
    r"""
    Create an instance of TissueSegmentation
...
class vsi_tile_header(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dummy1 = property(_fast.vsi_tile_header_dummy1_get, _fast.vsi_tile_header_dummy1_set)
    coord = property(_fast.vsi_tile_header_coord_get, _fast.vsi_tile_header_coord_set)
    level = property(_fast.vsi_tile_header_level_get, _fast.vsi_tile_header_level_set)
    offset = property(_fast.vsi_tile_header_offset_get, _fast.vsi_tile_header_offset_set)
    numbytes = property(_fast.vsi_tile_header_numbytes_get, _fast.vsi_tile_header_numbytes_set)
    dummy2 = property(_fast.vsi_tile_header_dummy2_get, _fast.vsi_tile_header_dummy2_set)

    def __init__(self):
        _fast.vsi_tile_header_swiginit(self, _fast.new_vsi_tile_header())
    __swig_destroy__ = _fast.delete_vsi_tile_header

# Register vsi_tile_header in _fast:
_fast.vsi_tile_header_swigregister(vsi_tile_header)

class ImagePyramidAccess(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, levels: "std::vector< fast::ImagePyramidLevel,std::allocator< fast::ImagePyramidLevel > >", fileHandle: "openslide_t *", tiffHandle: "TIFF *", stream: "std::ifstream *", vsiTiles: "std::vector< fast::vsi_tile_header,std::allocator< fast::vsi_tile_header > > &", imagePyramid: "std::shared_ptr< fast::ImagePyramid >", writeAccess: "bool", initializedPatchList: "std::unordered_set< std::string > &", readMutex: "std::mutex &", compressionFormat: "fast::ImageCompression"):
        _fast.ImagePyramidAccess_swiginit(self, _fast.new_ImagePyramidAccess(levels, fileHandle, tiffHandle, stream, vsiTiles, imagePyramid, writeAccess, initializedPatchList, readMutex, compressionFormat))

    def setPatch(self, level: "int", x: "int", y: "int", patch: "std::shared_ptr< fast::Image >") -> "void":
        return _fast.ImagePyramidAccess_setPatch(self, level, x, y, patch)

    def isPatchInitialized(self, level: "uint", x: "uint", y: "uint") -> "bool":
...
class ImagePyramid(SpatialDataObject):
    ...
    @staticmethod
    def create(*args) -> "std::shared_ptr< fast::ImagePyramid >":
        return _fast.ImagePyramid_create(*args)
    ...
    def getLevelForMagnification(self, magnification: "int", slackPercentage: "float"=0.5) -> "int":
        r"""
        Get level for a given magnification
        :type magnification: int
        :param magnification: Magnification amount (e.g. 40, 20, 10 etc.)
        :type slackPercentage: float
        ...
        :return: level
        """
        return _fast.ImagePyramid_getLevelForMagnification(self, magnification, slackPercentage)
...
def ImagePyramid_create(*args) -> "std::shared_ptr< fast::ImagePyramid >":
    return _fast.ImagePyramid_create(*args)
...
class ImageFileExporter(FileExporter):
    ...
    @staticmethod
    def create(filename: "std::string", compress: "bool"=False, resampleIfNeeded: "bool"=True) -> "std::shared_ptr< fast::ImageFileExporter >":
        r"""
        Create instance
        ...
        :return: instance
        """
        return _fast.ImageFileExporter_create(filename, compress, resampleIfNeeded)
...
def ImageFileExporter_create(filename: "std::string", compress: "bool"=False, resampleIfNeeded: "bool"=True) -> "std::shared_ptr< fast::ImageFileExporter >":
    r"""
    Create instance
...
class ImageExporter(FileExporter):
    ...
    @staticmethod
    def create(filename: "std::string", resampleIfNeeded: "bool"=True) -> "std::shared_ptr< fast::ImageExporter >":
        r"""
        Create instance
        :type filename: string
        :param filename:
        ...
        :return: 
        """
        return _fast.ImageExporter_create(filename, resampleIfNeeded)
...
def ImageExporter_create(filename: "std::string", resampleIfNeeded: "bool"=True) -> "std::shared_ptr< fast::ImageExporter >":
    r"""
    Create instance
    :type filename: string
    :param filename:
...
class Pipeline(object):
    ...
    def getAllPipelineOutputData(self, progressFunction: "std::function< void (float) >"=0) -> "std::map< std::string,fast::DataObject::pointer,std::less< std::string >,std::allocator< std::pair< std::string const,fast::DataObject::pointer > > >":
        r"""
        ...
        :type progressFunction: std::function< void (float) >
        :param progressFunction:
        :rtype: std::map< std::string,fast::DataObject::pointer,std::less< std::string >,std::allocator< std::pair< std::string const,fast::DataObject::pointer > > >
        :return: map of pipeline output data
        """
        return _fast.Pipeline_getAllPipelineOutputData(self, progressFunction)

    def getPipelineOutputData(self, name: "std::string", progressFunction: "std::function< void (float) >"=0) -> "fast::DataObject::pointer":
        r"""
        ...
        """
        return _fast.Pipeline_getPipelineOutputData(self, name, progressFunction)
