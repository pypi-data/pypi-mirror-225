...
from newgram.crypto import aes, rsa, prime
from newgram.errors import SecurityCheckMismatch
from newgram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "newgram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
