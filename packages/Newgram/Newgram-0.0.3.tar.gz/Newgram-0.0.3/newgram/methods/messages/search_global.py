...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~newgram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~newgram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~newgram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "newgram". Get the first 50 results
                async for message in app.search_global("newgram", limit=50):
                    print(message.text)
