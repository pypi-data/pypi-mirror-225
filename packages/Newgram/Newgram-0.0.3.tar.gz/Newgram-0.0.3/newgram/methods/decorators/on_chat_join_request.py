...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~newgram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, newgram.Client):
                self.add_handler(newgram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        newgram.handlers.ChatJoinRequestHandler(func, self),
