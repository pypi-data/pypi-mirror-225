...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~newgram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, newgram.Client):
                self.add_handler(newgram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        newgram.handlers.ChosenInlineResultHandler(func, self),
