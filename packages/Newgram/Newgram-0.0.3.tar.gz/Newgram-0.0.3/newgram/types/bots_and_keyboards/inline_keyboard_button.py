...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~newgram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~newgram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~newgram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~newgram.types.CallbackGame`, *optional*):
