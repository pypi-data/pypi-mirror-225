...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~newgram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, newgram.Client):
                self.add_handler(newgram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        newgram.handlers.ChatMemberUpdatedHandler(func, self),
