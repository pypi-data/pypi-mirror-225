...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~newgram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, newgram.Client):
                self.add_handler(newgram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        newgram.handlers.EditedMessageHandler(func, self),
