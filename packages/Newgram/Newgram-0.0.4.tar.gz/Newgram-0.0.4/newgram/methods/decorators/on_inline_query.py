...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~newgram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, newgram.Client):
                self.add_handler(newgram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        newgram.handlers.InlineQueryHandler(func, self),
