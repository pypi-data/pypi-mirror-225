...
from newgram.errors import PhoneMigrate, NetworkMigrate
from newgram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~newgram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
