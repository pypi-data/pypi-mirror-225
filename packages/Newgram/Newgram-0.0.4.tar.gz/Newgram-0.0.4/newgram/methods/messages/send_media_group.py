...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~newgram.types.InputMediaPhoto`, :obj:`~newgram.types.InputMediaVideo`, :obj:`~newgram.types.InputMediaAudio` and :obj:`~newgram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~newgram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from newgram.types import InputMediaPhoto, InputMediaVideo
