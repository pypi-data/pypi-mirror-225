...
class MenuButton(Object):
    ...
    - :obj:`~newgram.types.MenuButtonCommands`
    - :obj:`~newgram.types.MenuButtonWebApp`
    - :obj:`~newgram.types.MenuButtonDefault`

    If a menu button other than :obj:`~newgram.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "newgram.Client") -> "raw.base.BotMenuButton":
