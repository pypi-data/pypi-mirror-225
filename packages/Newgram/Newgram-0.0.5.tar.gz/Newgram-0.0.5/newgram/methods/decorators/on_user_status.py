...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~newgram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, newgram.Client):
                self.add_handler(newgram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        newgram.handlers.UserStatusHandler(func, self),
