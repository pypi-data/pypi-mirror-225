...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <newgram.api.functions>` package and may accept compound
        data types from :obj:`types <newgram.api.types>` as well as bare types such as ``int``, ``str``, etc...
