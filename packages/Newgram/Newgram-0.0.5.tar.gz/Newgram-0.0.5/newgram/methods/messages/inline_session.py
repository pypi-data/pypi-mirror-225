...
from newgram.errors import AuthBytesInvalid
from newgram.session import Session
from newgram.session.auth import Auth


async def get_session(client: "newgram.Client", dc_id: int):
