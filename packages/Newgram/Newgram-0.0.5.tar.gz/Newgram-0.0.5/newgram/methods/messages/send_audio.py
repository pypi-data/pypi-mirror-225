...
import newgram
from newgram import StopTransmission, enums
from newgram import raw
from newgram import types
from newgram import utils
from newgram.errors import FilePartMissing
from newgram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~newgram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~newgram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~newgram.Client.stop_transmission`, None is returned.
