...
class BotCommandScope(Object):
    ...
    - :obj:`~newgram.types.BotCommandScopeDefault`
    - :obj:`~newgram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~newgram.types.BotCommandScopeAllGroupChats`
    - :obj:`~newgram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~newgram.types.BotCommandScopeChat`
    - :obj:`~newgram.types.BotCommandScopeChatAdministrators`
    - :obj:`~newgram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "newgram.Client") -> "raw.base.BotCommandScope":
