...
class InputMedia(Object):
    ...
    - :obj:`~newgram.types.InputMediaAnimation`
    - :obj:`~newgram.types.InputMediaDocument`
    - :obj:`~newgram.types.InputMediaAudio`
    - :obj:`~newgram.types.InputMediaPhoto`
    - :obj:`~newgram.types.InputMediaVideo`
    """
