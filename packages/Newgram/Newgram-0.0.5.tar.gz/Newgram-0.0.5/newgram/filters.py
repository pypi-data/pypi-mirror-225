...
from newgram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "newgram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~newgram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~newgram.handlers.MessageHandler` the *update* argument will be a :obj:`~newgram.types.Message`; in a :obj:`~newgram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~newgram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~newgram.filters.command` or :meth:`~newgram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~newgram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~newgram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~newgram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~newgram.types.Message`.
    ...
    async def func(flt, client: newgram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~newgram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~newgram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~newgram.types.InlineQuery`: The filter will match ``query``.
