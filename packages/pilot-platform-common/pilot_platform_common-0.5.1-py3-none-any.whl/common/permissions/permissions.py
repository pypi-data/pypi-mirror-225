...
async def has_permissions(
    auth_url: str, project_code: str, permissions: List[Dict[str, str]], current_identity: Dict[str, Any]
) -> dict[str, bool]:
    ...
    assertions = await auth_client.get_assertions(permission_request)
