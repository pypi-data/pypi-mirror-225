...
# and deploy the selected version to production.
# From that point on, you will use "EnvType.PROD" with the "production version"
new_version = "0.0.2"
new_env_type = EnvType.EVAL
print(f"switching to version: {new_version}, and EnvType: {new_env_type}")
dc_client.version_name("0.0.2").env_type(EnvType.EVAL)
