...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["m-singleton", "Werkzeug", "Flask", "m-caching", "requests", "confluent_kafka>=1.7.0", "python-magic", "mobio-admin-sdk", "m-filetypes"]
        return requirements


version_dev='0.2.13'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
version_prod='0.2.12'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='0.2.13',  # Required, Phần này cũng không được format file.
