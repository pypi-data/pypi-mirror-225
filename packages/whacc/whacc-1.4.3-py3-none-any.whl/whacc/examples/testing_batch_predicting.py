...
def batch_process_videos_on_colab(bd, local_temp_dir, video_batch_size=2, custom_image_extract_size=None):
    ...
    while True:  # keep going until there are no more files to process
        ...
        PT = PoleTracking(video_directory=local_temp_dir, template_png_full_name=template_dir, custom_image_extract_size=custom_image_extract_size)
