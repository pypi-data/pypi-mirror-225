...
class PipelineSourceInterface(traits.api.HasStrictTraits):
    """
    ...
    **Example:**
    ...
    Then build a :py:class:`Pipeline` with this pipeline source by wrapping it in a :py:class:`~ovito.pipeline.PythonScriptSource` object:
