...
setuptools.setup(
    name="telexy",                     # This is the name of the package
    version="1.23.816",                        # The initial release version
    author="Telexy",                     # Full name of the author
    author_email="support@telexy.com", # Full email of author
    description="Interface with Telexy Cloud",
    ...
    py_modules=["REST", "Fuse", "FusionFS"],             # Name of the python package
    #package_dir={'':'/Telexy'},     # Directory of the source code of the package
    install_requires=['requests', "jupyter"]                     # Install other dependencies if any
)