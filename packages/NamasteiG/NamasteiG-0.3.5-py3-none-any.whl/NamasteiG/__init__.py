...
class Instagram:
    ...
    def __init__(self,User,Password,Proxy=None):
        ...
        self.UserAgent = "Instagram 296.0.0.35.109 Android (" + ["23/6.0", "24/7.0", "25/7.1.1", "26/8.0", "27/8.1", "28/9.0"][random.randint(0, 5)] + "; " + str(random.randint(100, 1300)) + "dpi; " + str(random.randint(200, 2000)) + "x" + str(random.randint(200, 2000)) + "; " + ["SAMSUNG", "HUAWEI", "LGE/lge", "HTC", "ASUS", "ZTE", "ONEPLUS", "XIAOMI", "OPPO", "VIVO", "SONY", "REALME"][random.randint(0, 11)] + "; SM-T" + rnd + "; SM-T" + rnd + "; qcom; en_US; 505599021)"
        self.Blockversion = '6c430a3ed39744544edbb8460326bdb3adc57c3fdf63df43ab94b3cdb76230b6'
        self.proxy = Proxy
