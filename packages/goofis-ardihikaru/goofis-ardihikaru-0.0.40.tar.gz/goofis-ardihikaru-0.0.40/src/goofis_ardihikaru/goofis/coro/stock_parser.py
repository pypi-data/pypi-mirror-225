...
class StockParser(AbcParser, ABC):
    ...
    async def contains_day_range(self, general_info_text_list: List) -> bool:
    ...
    async def contains_ceo_row(self, general_info_text_list: List) -> bool:
        """
    ...
    async def update_general_info(self, general_info_list: List, general_info_text_list: List):
    ...
    async def parser(self, html: Response):
        ...
        general_info_list, general_info_text_list = await self.fetch_general_info(selector)
        await self.update_general_info(general_info_list, general_info_text_list)
        ...
        self.info.current_price_change_percent = await self.fetch_current_price_percent_v2()
        self.info.current_price_change_value = await self.fetch_current_price_value_v2()
