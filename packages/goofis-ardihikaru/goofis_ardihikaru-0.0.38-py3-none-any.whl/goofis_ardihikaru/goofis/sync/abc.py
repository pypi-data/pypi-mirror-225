...
class AbcParser(object):
    ...
    @staticmethod
    def fetch_current_price(selector: Selector, lang: str) -> float:
        """
    ...
    @staticmethod
    def fetch_current_price_percent(selector: Selector, lang: str) -> float:
        """
        fetches current price
        """
        try:
    ...
    def fetch_current_price_percent_v2(self) -> float:
        """
    ...
    @staticmethod
    def fetch_current_price_value(last_closed_price: float, current_price: float) -> float:
        """
    ...
    def fetch_current_price_value_v2(self) -> float:
        """
    ...
    @staticmethod
    def fetch_about_info(selector: Selector) -> str:
        """
    ...
    @staticmethod
    def fetch_name(selector: Selector, about: str, lang: str) -> str:
        """
