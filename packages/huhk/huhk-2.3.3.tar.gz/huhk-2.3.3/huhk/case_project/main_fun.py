...
def running_testcase(running, case_path, report_path):
    running_path_list = []
    ...
    if running_path_list:
        ...
        os.system(cmd_str)
        if not case_path and not report_path:
...
if __name__ == '__main__':
    install_project('e7f7ea25-aa2f-40b9-bd4c-1277b3173ae8')
    # running_testcase(["remoteinterfacelog"], case_path=r"D:\projects\python_test\huhk-common\testcase",
    #                  report_path=r"D:\projects\python_test\huhk-common\report\test1")