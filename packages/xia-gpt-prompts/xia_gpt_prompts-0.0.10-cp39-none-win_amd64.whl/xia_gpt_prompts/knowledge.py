...
class KnowledgeNode(Document):
    ...
    @classmethod
    def parse_output(cls, output_text: str, output_type: str = None, output_format: str = None):
        ...
        """
        if not output_type and not output_format:
            output_type, output_format = cls.parse_format(output_text)
