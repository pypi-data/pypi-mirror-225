...
from dl_matrix.infrence.utility.retriever import DataRetriever
...
class DataEngine:
    def __init__(
        ...
        huggingface_dataset_name: Optional[str] = "Diomandeee/Synergetic",
        prompt_directory: str = "conversation",
        ...
        self.data_helper = DataHelper(self.dataset_loader).start()
    ...
    def find_similar(self, text: str, top_n: int = 1, pair_type: str = None):
        """
        ...
        """
        return self.data_retriever.find_similar(text, top_n, pair_type)
