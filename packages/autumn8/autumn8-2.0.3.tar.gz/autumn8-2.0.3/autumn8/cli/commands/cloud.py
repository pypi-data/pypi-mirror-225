...
@click.option(
    ...
    "--input",
    type=str,
    help="JSON HTTP Body input to pass within the HTTP request",
)
async def run_docker(
    ...
    try:
        final_input = json.loads(input) if input is not None else input
    except json.decoder.JSONDecodeError:
        raise AttributeError("Provided model input is not a valid JSON")
    ...
    async with httpx.AsyncClient(
        ...
        response: httpx.Response = await httpClient.post(
            ...
            json={
                ...
                "http_request_input": final_input,
