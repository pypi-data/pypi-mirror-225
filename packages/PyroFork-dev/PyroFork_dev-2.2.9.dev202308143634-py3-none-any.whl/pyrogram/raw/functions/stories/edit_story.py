...
class EditStory(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "media", "caption", "entities", "privacy_rules"]

    ID = 0x2aae7a41
    QUALNAME = "functions.stories.EditStory"

    def __init__(self, *, id: int, media: "raw.base.InputMedia" = None, caption: Optional[str] = None, entities: Optional[List["raw.base.MessageEntity"]] = None, privacy_rules: Optional[List["raw.base.InputPrivacyRule"]] = None) -> None:
        self.id = id  # int
    ...
    def read(b: BytesIO, *args: Any) -> "EditStory":
        ...
        return EditStory(id=id, media=media, caption=caption, entities=entities, privacy_rules=privacy_rules)
