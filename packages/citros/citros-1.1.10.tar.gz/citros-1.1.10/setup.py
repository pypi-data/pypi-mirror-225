...
setup(
    ...
    package_data={
        citros_meta.__title__: [
            'data/schemas/schema_flow.json',
            'data/schemas/schema_param_setup.json',
            'data/schemas/schema_settings.json',
            'data/schemas/schema_simulation.json'
        ],
        citros_meta.__title__: [
            'data/defaults/default_flow.json',
            'data/defaults/default_settings.json',
            'data/defaults/default_simulation.json',
        ]
    },
    scripts=[
        'bin/citros',    
