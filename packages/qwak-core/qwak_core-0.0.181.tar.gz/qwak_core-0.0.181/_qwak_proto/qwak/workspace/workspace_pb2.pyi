...
class WorkspaceSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_pod_compute_resources", b"client_pod_compute_resources", "image_type", b"image_type", "tags", b"tags", "workspace_name", b"workspace_name"]) -> None: ...
