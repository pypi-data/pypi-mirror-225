...
class Whatsapp:
    ...
    def verificar_opt_in(self, celular:str, return_list=False):   
    ...
    def enviar_texto_e_img_whatsapp(self, celular: str, texto: str,url_imagem:str, sistema_envio: str, template='template_informa_com_img', return_list=False):    
    ...
    def get_status_entrega_whatsapp(self, id_msg: str):
        try:
            # Get ID da mensagem
