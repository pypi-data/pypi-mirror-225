...
/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login */ "./lib/login.js");
...
function updateVDKMenu(commands, docManager, fileBrowser, notebookTracker, statusButton) {
    commands.addCommand('jp-vdk:menu-login', {
        ...
        execute: _login__WEBPACK_IMPORTED_MODULE_1__.startLogin
    });
    // Add Run job command
...
async function startLogin() {
    ...
    const redirect_url = await (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('login?initial_url=' + encodedURL + "&origin=" + encodeURIComponent(window.location.origin), {
        method: 'GET'
    });
    console.log('open login window with redirect url: ' + redirect_url);
    const oauthWindow = window.open(redirect_url, 'oauthWindow', 'width=500,height=800');
    if (oauthWindow == null) {
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.abbfce9501f2a49064ad.js.map