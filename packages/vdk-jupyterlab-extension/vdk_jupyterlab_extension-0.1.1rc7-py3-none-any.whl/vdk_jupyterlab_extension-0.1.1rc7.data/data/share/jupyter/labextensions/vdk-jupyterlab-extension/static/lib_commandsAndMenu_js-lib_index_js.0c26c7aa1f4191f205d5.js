...
async function safeFetchTokenLocation() {
    let tokenLocation = null;
    try {
        tokenLocation = await fetchTokenLocation();
    }
    catch (error) {
        console.error('Error fetching token location', error);
    }
...
async function checkToken() {
    const tokenLocation = await safeFetchTokenLocation();
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.0c26c7aa1f4191f205d5.js.map