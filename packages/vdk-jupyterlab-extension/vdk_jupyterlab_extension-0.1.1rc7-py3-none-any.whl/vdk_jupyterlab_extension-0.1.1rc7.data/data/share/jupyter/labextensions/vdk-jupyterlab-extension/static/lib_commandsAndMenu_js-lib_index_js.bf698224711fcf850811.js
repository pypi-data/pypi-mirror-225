...
async function fetchTokenLocation() {
    const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('tokenlocation', {
        method: 'GET'
    });
    if (data) {
        return data || '';
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.bf698224711fcf850811.js.map