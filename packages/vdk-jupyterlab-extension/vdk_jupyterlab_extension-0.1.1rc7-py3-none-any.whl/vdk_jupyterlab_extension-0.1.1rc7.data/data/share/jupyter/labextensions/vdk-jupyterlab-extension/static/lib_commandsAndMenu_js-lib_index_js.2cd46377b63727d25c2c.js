...
async function startLogin() {
    const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('login', {
        method: 'GET'
    });
    if (data) {
        console.log(data);
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.2cd46377b63727d25c2c.js.map