...
async function fetchTokenLocation() {
    const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('vdkAccessToken', {
        method: 'GET'
    });
    if (data) {
        return data || '';
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.1d35baf8e1241d832a9d.js.map