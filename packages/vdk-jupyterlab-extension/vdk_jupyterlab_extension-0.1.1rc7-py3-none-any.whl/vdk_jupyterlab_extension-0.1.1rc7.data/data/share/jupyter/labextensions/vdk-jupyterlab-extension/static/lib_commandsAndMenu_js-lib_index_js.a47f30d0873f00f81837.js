...
async function startLogin() {
    let initial_url = window.location.pathname + window.location.search;
    const redirect_url = await (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('login?initial_url=' + initial_url, {
        method: 'GET'
    });
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.a47f30d0873f00f81837.js.map