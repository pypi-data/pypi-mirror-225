...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CHECK_INTERVAL_MS: () => (/* binding */ CHECK_INTERVAL_MS),
...
async function getTokenLocationFromCacheOrFetch() {
    const tokenLocationString = window.localStorage.getItem('vdk.cache.tokenLocation');
    ...
    if (fetchedTokenLocation) {
        window.localStorage.setItem('vdk.cache.tokenLocation', JSON.stringify(fetchedTokenLocation));
    }
    return fetchedTokenLocation;
}
async function sendTokenIfNew(token) {
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.b4da19757c6bc1058512.js.map