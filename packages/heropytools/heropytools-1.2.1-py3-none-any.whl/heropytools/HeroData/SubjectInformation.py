...
class SubjectInformation:
    ...
    def __init__(self, ID="", Name="", BirthDate="", Sex="", Weigth=0.0):
        self._id = ID
        self._name = Name
    ...
    def ID(self, value):
        if not isinstance(str, value):
            raise Exception("The 'ID' must be a string.")
        self._id = value
    ...
    def BirthDate(self, value):
        if not isinstance(str, value):
            raise Exception("The 'BirthDate' must be a string.")
    ...
    def Sex(self, value):
        if not isinstance(str, value):
            raise Exception("The 'Sex' must be a string.")
        self._sex = value
