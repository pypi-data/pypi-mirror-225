...
class PlotSettingsGUI(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.formLayout_scatter.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.gridMegapixelsDoubleSpinBox
        )
        ...
        self.formLayout_scatter.setWidget(
            2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rMSWindowWidthMDoubleSpinBox
        )
        ...
        self.formLayout_scatter.setWidget(
            3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.showZeroCrossingInColorbarsLabel
        )
        ...
        self.formLayout_scatter.setWidget(
            3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.showZeroCrossingInColorbarsCheckBox
        )
        ...
        self.formLayout_scatter.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.clipColorbarAtXSigmaDoubleSpinBox
        )
        ...
        self.formLayout_scatter.setWidget(
            7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.rotateScatterPlotsToMainAxisLabel
        )
        ...
        self.formLayout_scatter.setWidget(
            7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rotateScatterPlotsToMainAxisCheckBox
        )
    ...
    def retranslateUi(self):
        ...
        self.rMSWindowWidthMLabel.setText(_translate("MainWindow", "RMS Window Width [m]:"))
