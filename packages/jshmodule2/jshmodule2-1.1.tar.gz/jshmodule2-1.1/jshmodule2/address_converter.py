...
class AddressConverter:
    def __init__(self, api_key):
        ...
        self.korea_gdf = gpd.read_file('data/HangJeongDong_ver20230701.geojson')
        self.bj_gdf = gpd.read_file('data/emd.shp', encoding='cp949')
    ...
    def get_bjdong(self, address):
        ...
        try:
            ...
            if mask.sum() > 0:
                return self.bj_gdf[mask]['EMD_KOR_NM'].values[0]
            else:
                raise ValueError()
        except:
            return "해당하는 지역명을 찾을 수 없습니다."
