...
class FinQLFrequencyFeature(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class time_period(
                ...
                def YEAR(cls):
                    return cls("year")
            frequency = schemas.NumberSchema
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["time_period", "frequency", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["time_period", "frequency", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        frequency: typing.Union[MetaOapg.properties.frequency, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FinQLFrequencyFeature':
