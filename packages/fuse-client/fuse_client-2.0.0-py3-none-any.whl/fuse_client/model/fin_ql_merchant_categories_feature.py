...
class FinQLMerchantCategoriesFeature(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        class items(
                    ...
                    class result(
                        ...
                        class MetaOapg:
                            ...
                            class items(
                                ...
                                def __getitem__(self, name: typing.Union[typing_extensions.Literal["merchant", "value", ], str]):
                                ...
                                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["merchant", "value", ], str]):
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["category", "result", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["category", "result", ], str]):
                return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        _arg: typing.Union[typing.Tuple[typing.Union[MetaOapg.items, dict, frozendict.frozendict, ]], typing.List[typing.Union[MetaOapg.items, dict, frozendict.frozendict, ]]],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'FinQLMerchantCategoriesFeature':
        return super().__new__(
            cls,
            _arg,
            _configuration=_configuration,
