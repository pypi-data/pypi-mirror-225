...
class QottoAuthService:
    ...
    def create_application(self, code: str, name: str = None, description: str = None, uuid: str = None) -> Application:
    ...
    def register_application(self, code: str, name: str = None, description: str = None, uuid=None) -> Application:
        payload = self.api.mutation(
    ...
    def create_permission(
            self, application: Union[Application, str],
            code: str, name: str = None, description: str = None, uuid: str = None,
    ) -> Permission:
        application_id = application.id if isinstance(application, Application) else application
        payload = self.api.mutation(
    ...
    def create_organization(
            self,
            namespace: Union[Namespace, str], name: str = None, uuid: str = None,
    ) -> Organization:
        payload = self.api.mutation(
    ...
    def register_organization(
            self, namespace: Union[Namespace, str], name: str = None, uuid: str = None,
    ) -> Organization:
        payload = self.api.mutation(
    ...
    def update_user(
            ...
            set_archived: bool = None, set_superuser: bool = None,
            set_name: str = None, set_email: str = None,
            set_given_name: str = None, set_middle_name: str = None, set_family_name: str = None,
            set_picture: str = None, set_birthdate: Union[date, str] = None,
            set_country: str = None, set_address: str = None, set_phone_number: str = None, set_job_title: str = None,
    ) -> User:
