...
class PermissionRegistry:
    ...
    def add(self, key: str, id: int, name: str, category: str) -> PermissionDefinition:
    ...
    def get_categories_with_permissions(self) -> List[Dict[str, Union[str, List[Dict[str, Union[int, str]]]]]]:
        ...
        for c in self._categories:
            result.append(dict(
                ...
                permissions=[dict(id=p.id, name=p.name, key=p.key) for p in self._index_by_category[c]],
            ))
        return result
