...
from ts_sdk.task.__util_adapters.endpoint_adapter import get_private_endpoint
...
def get_endpoint():
    return get_private_endpoint(
        select_versioned_value(
            {
                CommunicationFormat.V0: "ORCHESTRATOR_ENDPOINT",
                CommunicationFormat.V1: "KERNEL_ENDPOINT",
            }
        )
    )
