...
def calculate_cost(PQVA_matrix_prediction: ndarray, data: OptimalPowerFlowData) -> ndarray:
    """
    ...
    active_powers_generation = (active_powers + data.active_power_demands) * data.baseMVA

    return np.sum(polynomial_costs(active_powers_generation, data.cost_coefficients))
