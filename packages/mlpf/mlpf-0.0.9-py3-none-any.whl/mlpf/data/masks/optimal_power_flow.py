...
class BusTypeMasks:
    """
    A class with static fields defining bus type masks in the (active power, reactive power, voltage magnitude, voltage angle)
...
def create_optimal_power_flow_feature_mask(bus_types: ndarray) -> ndarray:
    ...
    feature_mask[pv_indices] = np.array(BusTypeMasks.PVAR)
