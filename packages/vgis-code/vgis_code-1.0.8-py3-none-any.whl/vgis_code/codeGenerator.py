...
class BuildDjango:
    ...
    def generate_cude_code_in_viewer(self, api_path, table_cname, table_class, not_same_field_cn_list,
        ...
        # create方法重载
        create_code_str = "def create(self, request, *args, **kwargs):{}".format(line_break_str)
        create_code_str += "{}api_path = \"{}\"{}".format(tab_str, api_path, line_break_str)
        ...
        for index in range(len(not_same_field_en_list)):
            ...
            info = "res = LoggerHelper.set_end_log_info_in_exception(logger, start, api_path,request.auth.user, request,function_title, error_info, None)"
            create_code_str += "{}{}{}{}{}".format(tab_str, tab_str, tab_str, info, line_break_str)
        ...
        create_code_str += "{}{}{}{}".format(tab_str, tab_str,
                                             "res = LoggerHelper.set_end_log_info_in_exception(logger, start, api_path,request.auth.user, request,function_title, None, exp)",
                                             line_break_str)
        create_code_str += "{}{}{}{}".format(tab_str, tab_str,
                                             "return Response(res)", line_break_str)
        ...
        # update方法重载
        update_code_str = "def update(self, request, *args, **kwargs):{}".format(line_break_str)
        update_code_str += "{}api_path = \"{}\"{}".format(tab_str, api_path, line_break_str)
        ...
        #  根据编号查询详情方法重载
        getdetail_code_str = "def get_object(self, *args, **kwargs):{}".format(line_break_str)
        getdetail_code_str += "{}api_path = \"{}\"{}".format(tab_str, api_path, line_break_str)
        ...
        getdetail_code_str += "{}{}{}{}{}".format(tab_str, tab_str, tab_str, info,
                                                  line_break_str)
        info = "LoggerHelper.set_end_log_info(logger, start, api_path + str(id), request.auth.user,request,function_title)"
        getdetail_code_str += "{}{}{}{}{}".format(tab_str, tab_str, tab_str, info,
                                                  line_break_str)
        info = " return result"
        getdetail_code_str += "{}{}{}{}{}".format(tab_str, tab_str, tab_str, info,
        ...
        #  list方法重载
        list_code_str = "def get_queryset(self, *args, **kwargs):{}".format(line_break_str)
        list_code_str += "{}api_path = \"{}\"{}".format(tab_str, api_path, line_break_str)
        ...
        list_code_str += "{}{}{}{}{}".format(tab_str, tab_str, tab_str, info,
                                             line_break_str)
        info = "LoggerHelper.set_end_log_info(logger, start, api_path, request.auth.user,request,function_title)"
        list_code_str += "{}{}{}{}{}".format(tab_str, tab_str, tab_str, info,
                                             line_break_str)
