...
setup(
    ...
    keywords="code,generator,setuptools,development",  # Optional 搜索关键字

    packages=find_packages(),  # Required

    python_requires=">=3.7, <4",  # python 版本要求

    install_requires=["vgis_utils", "vgis_database", "vgis_encrption", "loguru"],  # Optional 第三方依赖库
