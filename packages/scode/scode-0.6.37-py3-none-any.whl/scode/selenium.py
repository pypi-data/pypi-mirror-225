...
def find_testdriver():
    ...
    if zip_link:
        ...
        with open("chromedriver-win32.zip", "wb") as zip_file:
            zip_file.write(zip_response.content)

        with zipfile.ZipFile("chromedriver-win32.zip", "r") as zip_ref:
            zip_ref.extractall(f"C:\\chromedriver\\{chrome_ver}\\")

        os.remove("chromedriver-win32.zip")

        source_path = f"C:\\chromedriver\\{chrome_ver}\\chromedriver-win32\\chromedriver.exe"
