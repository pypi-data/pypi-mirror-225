...
class CompleteModelBodyParams(BaseModel):
    ...
    """
    max_generated_token_count: Optional[constr(strict=True, min_length=1)] = Field(None, alias="maxGeneratedTokenCount", description="The maximum number of tokens to generate.")
