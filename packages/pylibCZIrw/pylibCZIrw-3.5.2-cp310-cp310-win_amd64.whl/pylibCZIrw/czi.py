# pylibCZIrw is a Python wrapper for libCZI
# Copyright (C) 2022 Carl Zeiss Microscopy GmbH
#
...
class CziReader:
    ...
    def __init__(
        ...
        filepath : str
            File path.
        """
        self._czi_reader = _pylibCZIrw.czi_reader(filepath)
...
def open_czi(filepath: str) -> Generator:
