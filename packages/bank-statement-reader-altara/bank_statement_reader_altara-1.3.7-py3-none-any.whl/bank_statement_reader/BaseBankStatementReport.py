...
class BankStatementReport:
    ...
    def get_account_name(self, text=None) -> str | None:
    ...
    def get_account_number(self, text) -> str:
    ...
    def get_closing_balance(self, text) -> float | None:
    ...
    def get_total_deposit(self, text) -> float:
    ...
    def export_to_excel(self, dataframe, name, start_date, end_date, is_salary=False) -> str:
