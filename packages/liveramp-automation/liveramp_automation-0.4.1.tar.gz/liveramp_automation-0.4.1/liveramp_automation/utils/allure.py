...
def allure_page_screenshot(page, attach_name):
    ...
    allure.attach(resource=page.screenshot(), name=attachment_title, attachment_type=allure.attachment_type.PNG)
...
def allure_drive_screenshot(driver, attach_name):
    ...
    """
    attachment_title = f"Screenshot: {attach_name}"
    allure.attach(resource=driver.get_screenshot_as_png(), name=attachment_title, attachment_type=allure.attachment_type.PNG)
...
def allure_attach_video(attach_name,path):
    ...
    :return: None
    """
    allure.attach.file(body=path, name=attach_name, attachment_type=allure.attachment_type.MP4)
...
def allure_attach_json(title,json_content):
    ...
    :return: None
    """
    allure.attach(body=json_content, name=title, attachment_type=allure.attachment_type.JSON)
