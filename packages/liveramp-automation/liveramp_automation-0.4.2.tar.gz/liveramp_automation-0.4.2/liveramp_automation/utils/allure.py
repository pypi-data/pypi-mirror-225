...
def allure_page_screenshot(page, attach_name):
    ...
    allure.attach(source=page.screenshot(), name=attachment_title, attachment_type=allure.attachment_type.PNG)
...
def allure_drive_screenshot(driver, attach_name):
    ...
    """
    attachment_title = f"Screenshot: {attach_name}"
    allure.attach(source=driver.get_screenshot_as_png(), name=attachment_title, attachment_type=allure.attachment_type.PNG)
