...
def open_one_leg_strategy_obsolete( symbol, exp_date, otype, strike, credit):                
...
def open_vertical_spread_strategy_obsolete( symbol,exp_date,otype,s_strike,l_strike):                 
...
def open_iron_condor_strategy_obsolete( strategy, symbol, exp_date, ps_strike,pl_strike,cs_strike, cl_strike):                 
