...
vips = ""
headersx = {'host': 'bot.ninjakrypto.online','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        self.status = '💎 {party_size}/16 Use Code MTDX #Ad 💎'
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://bot.ninjakrypto.online/default",headers={
                'host': 'bot.ninjakrypto.online',
            ...
            b = requests.get(f"https://bot.ninjakrypto.online/kick",headers={
                'host': 'bot.ninjakrypto.online',
            ...
            dasda = requests.get('https://bot.ninjakrypto.online/password',headers=headersx,cookies={"omgjaichanger": "None"}).json()['password']
            password = dasda
              
            y = requests.get(f"https://bot.ninjakrypto.online/restart",headers={
                'host': 'bot.ninjakrypto.online',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://bot.ninjakrypto.online/default",headers={
                'host': 'bot.ninjakrypto.online',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://bot.ninjakrypto.online/kick",headers={
                'host': 'bot.ninjakrypto.online',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://bot.ninjakrypto.online/restart",headers={
                'host': 'bot.ninjakrypto.online',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.24',
                'enable-super-fast': "None",
                'x-gorgon': "NC28AH28SJ19S",
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://bot.ninjakrypto.online/add_auto",headers={
                'host': 'bot.ninjakrypto.online',
    ...
    async def checker_status(self):
        q = requests.get(f"https://bot.ninjakrypto.online/status",headers={
                'host': 'bot.ninjakrypto.online',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://bot.ninjakrypto.online/skinbl",headers={
                'host': 'bot.ninjakrypto.online',
