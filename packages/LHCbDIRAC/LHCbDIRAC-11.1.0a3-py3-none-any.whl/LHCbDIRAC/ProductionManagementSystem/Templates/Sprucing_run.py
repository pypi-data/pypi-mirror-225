...
if not pr.publishFlag:
    sprucTestData = "LFN:/lhcb/data/2022/RAW/FULL/LHCb/COLLISION22/256170/256170_00100013_0000.raw"
    sprucInputDataList.append(sprucTestData)
...
if pr.testFlag:
    pr.dataTakingConditions = "Beam6800GeV-VeloOpen-MagDown-Excl-UT"
    pr.events = ["2000"]
    pr.processingPass = "Real Data/Commissioning23"
    pr.bkFileType = "MDF"
    mergingGroupSize = "1"
    sprucCPU = "200000"
    pr.startRun = "262956"
    pr.endRun = "262956"
    pr.eventType = "94000000"
    pr.dqFlag = "ALL"
