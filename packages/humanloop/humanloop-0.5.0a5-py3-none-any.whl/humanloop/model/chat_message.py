...
class ChatMessage(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tool_call() -> typing.Type['ToolCall']:
                return ToolCall
            __annotations__ = {
                "role": role,
                "content": content,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tool_call"]) -> 'ToolCall': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tool_call"]) -> typing.Union['ToolCall', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tool_call: typing.Union['ToolCall', schemas.Unset] = schemas.unset,
