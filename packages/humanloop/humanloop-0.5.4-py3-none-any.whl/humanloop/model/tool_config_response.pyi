...
class ToolConfigResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "name", "description", "other", "source", "setup_schema", "parameter_schema", "signature", "is_preset", "preset_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "name", "description", "other", "source", "setup_schema", "parameter_schema", "signature", "is_preset", "preset_name", ], str]):
