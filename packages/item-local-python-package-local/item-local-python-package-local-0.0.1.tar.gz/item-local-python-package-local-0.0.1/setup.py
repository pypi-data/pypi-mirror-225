...
setuptools.setup(
     ...
     name='item-local-python-package-local',  
     # TODO: Please update the URL bellow
     version='0.0.1', # https://pypi.org/project/item-local-python-package/
     author="Circles",
     author_email="info@circles.life",
     # TODO: Please update the description and delete this line
     description="PyPI Package for Circles item-local-python-package Local/Remote Python",
