...
from mltable.mltable import DataType, from_delimited_files, from_parquet_files, from_delta_lake, \
...
class TestSchema:
    ...
    def test__with_partition_size(self, empty_mltable):
        ...
        self._check_mltable_passes_schema(
            from_delimited_files([{'file': 'sample.csv'}])._with_partition_size(partition_size=1))
