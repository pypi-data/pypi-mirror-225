...
class PyZoneHandler:
    ...
    def draw_zone(self,
        ...
        if zone.valid:
            scaled_points = help.scaled_points(zone.boundary_points, draw_scale_matrix=draw_scale_matrix)
            ...
            if draw_zone_label:
                center = help.scaled_points([zone.center], draw_scale_matrix=draw_scale_matrix)[0]
