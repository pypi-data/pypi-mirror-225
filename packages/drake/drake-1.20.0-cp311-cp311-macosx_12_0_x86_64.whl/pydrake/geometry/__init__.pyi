...
class DrakeVisualizer_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_𝓣AutoDiffXd𝓤):
    ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_𝓣AutoDiffXd𝓤, scene_graph: SceneGraph_𝓣AutoDiffXd𝓤, lcm: pydrake.lcm.DrakeLcmInterface = ..., params: DrakeVisualizerParams = ...) -> DrakeVisualizer_𝓣AutoDiffXd𝓤: ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_𝓣AutoDiffXd𝓤, query_object_port: pydrake.systems.framework.OutputPort_𝓣AutoDiffXd𝓤, lcm: pydrake.lcm.DrakeLcmInterface = ..., params: DrakeVisualizerParams = ...) -> DrakeVisualizer_𝓣AutoDiffXd𝓤: ...
    @classmethod
    def DispatchLoadMessage(cls, scene_graph: SceneGraph_𝓣AutoDiffXd𝓤, lcm: pydrake.lcm.DrakeLcmInterface, params: DrakeVisualizerParams = ...) -> None: ...
...
class MeshcatVisualizer_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_𝓣AutoDiffXd𝓤):
    ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_𝓣AutoDiffXd𝓤, scene_graph: SceneGraph_𝓣AutoDiffXd𝓤, meshcat: Meshcat, params: MeshcatVisualizerParams = ...) -> MeshcatVisualizer_𝓣AutoDiffXd𝓤: ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_𝓣AutoDiffXd𝓤, query_object_port: pydrake.systems.framework.OutputPort_𝓣AutoDiffXd𝓤, meshcat: Meshcat, params: MeshcatVisualizerParams = ...) -> MeshcatVisualizer_𝓣AutoDiffXd𝓤: ...
    def Delete(self) -> None: ...
    def DeleteRecording(self) -> None: ...
    def PublishRecording(self) -> None: ...
    def ResetRealtimeRateCalculator(self) -> None: ...
