...
class IntegratorBase_𝓣AutoDiffXd𝓤:
    ...
    def ResetStatistics(self) -> None: ...
    def StartDenseIntegration(self) -> None: ...
    def StopDenseIntegration(self) -> pydrake.trajectories.PiecewisePolynomial_𝓣AutoDiffXd𝓤: ...
    def get_actual_initial_step_size_taken(self) -> pydrake.autodiffutils.AutoDiffXd: ...
    def get_context(self) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    def get_dense_output(self) -> pydrake.trajectories.PiecewisePolynomial_𝓣AutoDiffXd𝓤: ...
    def get_fixed_step_mode(self) -> bool: ...
    ...
    def get_mutable_context(self) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    def get_num_derivative_evaluations(self) -> int: ...
    def get_num_step_shrinkages_from_error_control(self) -> int: ...
    def get_num_step_shrinkages_from_substep_failures(self) -> int: ...
    def get_num_steps_taken(self) -> int: ...
    ...
    def reset_context(self, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
    def set_fixed_step_mode(self, flag: bool) -> None: ...
    @overload
...
class IntegratorBase_𝓣Expression𝓤:
    ...
    def ResetStatistics(self) -> None: ...
    def StartDenseIntegration(self) -> None: ...
    def StopDenseIntegration(self) -> pydrake.trajectories.PiecewisePolynomial_𝓣Expression𝓤: ...
    def get_actual_initial_step_size_taken(self) -> pydrake.symbolic.Expression: ...
    def get_context(self) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
    def get_dense_output(self) -> pydrake.trajectories.PiecewisePolynomial_𝓣Expression𝓤: ...
    def get_fixed_step_mode(self) -> bool: ...
    ...
    def get_mutable_context(self) -> pydrake.systems.framework.Context_𝓣Expression𝓤: ...
    def get_num_derivative_evaluations(self) -> int: ...
    def get_num_step_shrinkages_from_error_control(self) -> int: ...
    def get_num_step_shrinkages_from_substep_failures(self) -> int: ...
    def get_num_steps_taken(self) -> int: ...
    ...
    def reset_context(self, context: pydrake.systems.framework.Context_𝓣Expression𝓤) -> None: ...
    def set_fixed_step_mode(self, flag: bool) -> None: ...
    @overload
...
class RungeKutta2Integrator_𝓣AutoDiffXd𝓤(IntegratorBase_𝓣AutoDiffXd𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣AutoDiffXd𝓤, max_step_size: pydrake.autodiffutils.AutoDiffXd, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤 = ...) -> None: ...

class RungeKutta2Integrator_𝓣Expression𝓤(IntegratorBase_𝓣Expression𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣Expression𝓤, max_step_size: pydrake.symbolic.Expression, context: pydrake.systems.framework.Context_𝓣Expression𝓤 = ...) -> None: ...
...
class RungeKutta3Integrator_𝓣AutoDiffXd𝓤(IntegratorBase_𝓣AutoDiffXd𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣AutoDiffXd𝓤, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤 = ...) -> None: ...
...
class Simulator_𝓣AutoDiffXd𝓤:
    ...
    def get_actual_realtime_rate(self) -> float: ...
    def get_context(self) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    def get_integrator(self) -> IntegratorBase_𝓣AutoDiffXd𝓤: ...
    def get_monitor(self) -> Callable[[pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤],pydrake.systems.framework.EventStatus]: ...
    def get_mutable_context(self) -> pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤: ...
    def get_mutable_integrator(self) -> IntegratorBase_𝓣AutoDiffXd𝓤: ...
    def get_num_discrete_updates(self) -> int: ...
    def get_num_publishes(self) -> int: ...
    def get_num_steps_taken(self) -> int: ...
    def get_num_unrestricted_updates(self) -> int: ...
    def get_system(self) -> pydrake.systems.framework.System_𝓣AutoDiffXd𝓤: ...
    def get_target_realtime_rate(self) -> float: ...
    def has_context(self) -> bool: ...
    def reset_context(self, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤) -> None: ...
    def set_monitor(self, monitor: Callable[[pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤],Optional[pydrake.systems.framework.EventStatus]]) -> None: ...
    def set_publish_at_initialization(self, publish: bool) -> None: ...
    def set_publish_every_time_step(self, publish: bool) -> None: ...
    def set_target_realtime_rate(self, realtime_rate: float) -> None: ...
...
class _TemporaryName_N5drake7systems21RungeKutta2IntegratorIN5Eigen14AutoDiffScalarINS2_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEE(IntegratorBase_𝓣AutoDiffXd𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣AutoDiffXd𝓤, max_step_size: pydrake.autodiffutils.AutoDiffXd, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤 = ...) -> None: ...

class _TemporaryName_N5drake7systems21RungeKutta2IntegratorINS_8symbolic10ExpressionEEE(IntegratorBase_𝓣Expression𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣Expression𝓤, max_step_size: pydrake.symbolic.Expression, context: pydrake.systems.framework.Context_𝓣Expression𝓤 = ...) -> None: ...

class _TemporaryName_N5drake7systems21RungeKutta3IntegratorIN5Eigen14AutoDiffScalarINS2_6MatrixIdLin1ELi1ELi0ELin1ELi1EEEEEEE(IntegratorBase_𝓣AutoDiffXd𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣AutoDiffXd𝓤, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤 = ...) -> None: ...
...
@overload
def ApplySimulatorConfig(config: SimulatorConfig, simulator: Simulator_𝓣AutoDiffXd𝓤) -> None: ...
@overload
def ExtractSimulatorConfig(simulator: Simulator) -> SimulatorConfig: ...
@overload
def ExtractSimulatorConfig(simulator: Simulator_𝓣AutoDiffXd𝓤) -> SimulatorConfig: ...
...
@overload
def PrintSimulatorStatistics(arg0: Simulator_𝓣AutoDiffXd𝓤) -> None: ...
def RandomSimulation(make_simulator: Callable[[pydrake.common._module_py.RandomGenerator],Simulator], output: Callable[[pydrake.systems.framework.System,pydrake.systems.framework.Context],float], final_time: float, generator: pydrake.common._module_py.RandomGenerator) -> float: ...
...
@overload
def ResetIntegratorFromFlags(simulator: Simulator_𝓣AutoDiffXd𝓤, scheme: str, max_step_size: pydrake.autodiffutils.AutoDiffXd) -> IntegratorBase_𝓣AutoDiffXd𝓤: ...
