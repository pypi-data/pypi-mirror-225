...
class MathematicalProgram:
    ...
    @overload
    def AddLinearConstraint(self, a: numpy.ndarray[numpy.float64[1,n]], lb: float, ub: float, vars: numpy.ndarray[object[m,1]]) -> Binding𝓣LinearConstraint𝓤: ...
    @overload
    ...
    def EvalBindingAtInitialGuess(self, binding: Binding𝓣EvaluatorBase𝓤) -> numpy.ndarray[numpy.float64[m,1]]: ...
