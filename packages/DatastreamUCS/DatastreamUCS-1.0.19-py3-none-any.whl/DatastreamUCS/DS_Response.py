...
#------------------------------------------------------- 
    def post_user_request(self, tickers, fields=None, start='', end='', freq='', kind=1, retName=False):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.post_user_request', 'Exception occured:', exp)
            raise exp
    ...
    def get_data(self, tickers, fields=None, start='', end='', freq='', kind=1):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_data', 'Exception occured:', exp)
            raise exp
    ...
    def get_bundle_data(self, bundleRequest=None, retName=False):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_bundle_data', 'Exception occured:', exp)
            raise exp
...
#-------Helper Functions---------------------------------------------------
    def _get_Response(self, reqUrl, raw_request):
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_Response', 'Exception occured:', exp)
            raise exp
    ...
    def _get_json_Response(self, reqUrl, raw_request):
        try:
          ...
          httpResponse.raise_for_status()
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_json_Response', 'JSON decoder Exception occured:', jdecodeerr)
            raise
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_json_Response', 'Exception occured:', exp)
            raise
    ...
    def _get_token(self, isProxy=False):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_token', 'Exception occured:', exp)
            raise exp
    ...
    def jsonDateTime_to_datetime(self, jsonDate):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.jsonDateTime_to_datetime', 'Exception occured:', exp)
            raise exp
    ...
    def _get_Date(self, jsonDate):
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSResponse.get_Date', 'Exception occured:', exp)
            raise exp
