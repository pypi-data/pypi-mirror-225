...
class DSTimeSeriesFrequencyConversion(IntEnum):
    ...
    SumValues = 2 # The sum of all the values for the requested period will be returned. For example, GDP is usally reported quarterly. 
...
class TimeseriesClient(DSConnect):
    ...
    def GetAllItems(self):
        ...
        """
        try:
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.GetAllItems', 'GetAllItems requested')
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.GetAllItems', 'GetAllItems returned')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'TimeseriesClient.GetAllItems', 'Exception occured.', exp)
            raise exp
       ...
       """
        try:
            ...
            if reqCheck is not None:
                ...
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'TimeseriesClient.GetItem', 'Error: ' + reqCheck)
                return resp
            
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.GetItem', 'Requesting ' + itemId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.GetItem', itemId + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'TimeseriesClient.GetItem', 'Exception occured.', exp)
            raise exp
    ...
    def GetTimeseriesDateRange(self, startDate, endDate, frequency = DSUserObjectFrequency.Daily):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'TimeseriesClient.GetTimeseriesDateRange', 'Error: ' + resp.ErrorMessage)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.GetTimeseriesDateRange', 'Requesting date range')
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.GetTimeseriesDateRange', 'GetTimeseriesDateRange returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'TimeseriesClient.GetTimeseriesDateRange', 'Exception occured.', exp)
            raise exp
    ...
    def CreateItem(self, newItem, overWrite = False, skipItemReturn = False):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'TimeseriesClient.CreateItem', 'Error: ' + reqCheck)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.CreateItem', 'Creating ' + newItem.Id)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            json_Response = self._get_json_Response(request_url, raw_request)
            decoded = self.__JsonResponseDecoder(json_Response, self.__TimeseriesResponseType.GetItemResponse)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.CreateItem', newItem.Id + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'TimeseriesClient.CreateItem', 'Exception occured.', exp)
            raise exp
    ...
    def UpdateItem(self, item, skipItemReturn = False):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'TimeseriesClient.UpdateItem', 'Error: ' + reqCheck)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.UpdateItem', 'Updating ' + item.Id)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            json_Response = self._get_json_Response(request_url, raw_request)
            decoded = self.__JsonResponseDecoder(json_Response, self.__TimeseriesResponseType.GetItemResponse)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.UpdateItem', item.Id + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'TimeseriesClient.UpdateItem', 'Exception occured.', exp)
            raise exp
    ...
    def DeleteItem(self, itemId):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'TimeseriesClient.DeleteItem', 'Error: ' + reqCheck)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.DeleteItem', 'Deleting ' + itemId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            json_Response = self._get_json_Response(request_url, raw_request)
            decoded = self.__JsonResponseDecoder(json_Response, self.__TimeseriesResponseType.GetItemResponse)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'TimeseriesClient.DeleteItem', itemId + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'TimeseriesClient.DeleteItem', 'Exception occured.', exp)
            raise exp
