...
#--------------- Constructor ----------------------------------------------------------------------------------------  
    ...
    def _get_Token(self):
        ...
        """
        try:
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'DSConnect._get_Token', 'Requesting new token')
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'DSConnect._get_Token', 'New token received.')
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSConnect._get_Token', 'Exception occured.', exp)
            raise exp
    ...
    def Check_Token(self):
        ...
        if self.tokenExpiry <= timeRenew : 
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogTrace, 'DatastreamUCS.py', 'DSConnect.Check_Token', 'Token has expired. Refrefreshing')
            self._get_Token()
    ...
    def _json_Request(self, reqObject, customEncoderClass = DSUserCreatedJsonDateTimeEncoder):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSConnect._json_Request', 'Exception occured:', exp)
            raise exp
    ...
    def _get_json_Response(self, reqUrl, raw_request, customEncoderClass = DSUserCreatedJsonDateTimeEncoder):
        ...
        try:
            ...
            # post the request
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogTrace, 'DatastreamUCS.py', 'DSConnect._get_json_Response', 'Starting web request:', raw_request)
            ...
            if httpResponse.ok:
                ...
                DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogTrace, 'DatastreamUCS.py', 'DSConnect._get_json_Response', 'Web response received:', json_Response)
                ...
                try:
                    ...
                    if 'Message' in tryJson.keys() and 'Code' in tryJson.keys():
                        ...
                        DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'DSConnect._get_json_Response', 'API service returned a DSFault:', 
            ...
            DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'DSConnect._get_json_Response', 'JSON decoder Exception occured:', jdecodeerr.msg)
            raise
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'DSConnect._get_json_Response', 'Exception occured:', exp)
            raise
