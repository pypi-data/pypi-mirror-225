...
class EconomicFilters:
    ...
    def _get_Token(self):
        ...
        """
        try:
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters._get_Token', 'Requesting new token.')
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters._get_Token', 'New token received.')
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters._get_Token', 'Exception occured.', exp)
            raise exp
    ...
    def Check_Token(self):
        ...
        if self.tokenExpiry <= timeRenew : 
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogTrace, 'DatastreamUCS.py', 'EconomicFilters.Check_Token', 'Token has expired. Refrefreshing')
            self._get_Token()
    ...
    def _json_Request(self, reqObject):
        ...
        try:
            ...
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters._json_Request', 'Exception occured:', exp)
            raise exp
    ...
    def _get_Response(self, reqUrl, raw_request):
        ...
        # post the request
        DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogTrace, 'DatastreamUCS.py', 'EconomicFilters._get_Response', 'Starting web request:', raw_request)
    ...
    def _get_json_Response(self, reqUrl, raw_request):
        ...
        try:
            ...
            if httpResponse.ok:
                ...
                DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogTrace, 'DatastreamUCS.py', 'EconomicFilters._get_json_Response', 'Web response received:', json_Response)
                ...
                try:
                    ...
                    if 'Message' in tryJson.keys() and 'Code' in tryJson.keys():
                        ...
                        DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters._get_json_Response', 'API service returned a DSFault:', 
            ...
            DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters._get_json_Response', 'JSON decoder Exception occured:', jdecodeerr.msg)
            raise
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters._get_json_Response', 'Exception occured:', exp)
            raise
    ...
    def GetAllFilters(self, getType = DSFilterGetAllAction.AllFilters):
        ...
        try:
            if not isinstance(getType, DSFilterGetAllAction):
                ...
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters.GetAllFilters', 'Error: ' + resp.ErrorMessage)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.GetAllFilters', 'GetAllFilters requested.')
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.GetAllFilters', 'GetAllFilters returned response.')
            return response
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters.GetAllFilters', 'Exception occured.', exp)
            raise exp
    ...
    def GetFilter(self, filterId):
        ...
        try:
            ...
            if filterchk is not None:
                ...
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters.GetFilter', 'Error: ' + filterchk)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.GetFilter', 'Requesting filter ' + filterId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.GetFilter', 'Filter ' + filterId + ' returned a response.')
            return response
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters.GetFilter', 'Exception occured.', exp)
            raise exp
    ...
    def CreateFilter(self, newFilter):
        ...
        try:
            ...
            if filterchk is not None:
                ...
                resp.ResponseStatus = DSFilterResponseStatus.FilterFormatError
                resp.ErrorMessage = filterchk
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters.CreateFilter', 'Error: ' + filterchk)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.CreateFilter', 'Creating filter ' + newFilter.FilterId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            response = DSEconomicsFilterResponse(json_Response)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.CreateFilter', 'Filter ' + newFilter.FilterId + ' returned a response.')
            return response
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters.CreateFilter', 'Exception occured.', exp)
            raise exp
    ...
    def UpdateFilter(self, filter, updateAction):
        ...
        try:
            ...
            if filterchk is not None:
                ...
                resp.ResponseStatus = DSFilterResponseStatus.FilterFormatError
                resp.ErrorMessage = filterchk
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters.UpdateFilter', 'Error: ' + filterchk)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.UpdateFilter', 'Updating filter ' + filter.FilterId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            response = DSEconomicsFilterResponse(json_Response)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.UpdateFilter', 'Filter ' + filter.FilterId + ' returned a response.')
            return response
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters.UpdateFilter', 'Exception occured.', exp)
            raise exp
    ...
    def DeleteFilter(self, filterId):
        ...
        try:
            ...
            if filterchk is not None:
                ...
                resp.ResponseStatus = DSFilterResponseStatus.FilterFormatError
                resp.ErrorMessage = filterchk
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters.DeleteFilter', 'Error: ' + filterchk)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.DeleteFilter', 'Deleting filter ' + filterId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            response = DSEconomicsFilterResponse(json_Response)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.DeleteFilter', 'DeleteFilter (' + filterId + ') returned a response.')
            return response
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters.DeleteFilter', 'Exception occured.', exp)
            raise exp
    ...
    def GetEconomicChanges(self, startDate = None, sequenceId = 0, filter = None):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                DSUserObjectLogFuncs.LogError('DatastreamUCS.py', 'EconomicFilters.GetEconomicChanges', 'Error: ' + reqCheck)
                return resp
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.GetEconomicChanges', stringReq)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUCS.py', 'EconomicFilters.GetEconomicChanges', 'GetEconomicChanges request returned a response.')
            return response
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUCS.py', 'EconomicFilters.GetEconomicChanges', 'Exception occured.', exp)
            raise exp
