...
class ConfigFile(ConfigSource):
    ...
    def get_active_profile_from_file(self) -> Optional[str]:
        return self._cfg.get("active_profile") if self._cfg else None
    ...
    def create_file(
        ...
        **params,
        ...
        doc.add("active_profile", active_profile or "default")
        t = tomlkit.table()
