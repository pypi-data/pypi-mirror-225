...
from bliss.common.logtools import log_debug_data, log_debug
...
class nanodac:
    ...
    def __init__(self, host_ip):
        ...
        self._load_cmds()
        self._init_com()
        global_map.register(self, children_list=[self.com])
...
class Nanodac(Controller):
    ...
    def initialize_controller(self):
        ...
        global_map.register(self, children_list=[self.hw_controller])
    ...
    def initialize_loop(self, tloop):
        ...
        """
        log_debug(self, "initialize_loop")
    ...
    def set_output_value(self, toutput, value):
        ...
        """
        log_debug(self, "Controller:set_output_value: %s %s" % (toutput, value))
