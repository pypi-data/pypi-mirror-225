...
from bliss.common.utils import BOLD, RED, shorten_signature, typecheck
from blissdata.data.lima_image import read_video_last_image
...
class LimaTakeDisplay(ScanProgress):
    ...
    def scan_new_callback(self):
        ...
        print(self.HEADER.format(**self.scan_info))

    def scan_end_callback(self):
        print(self.build_display_line())
        start = datetime.datetime.fromtimestamp(self.scan_info["start_timestamp"])
