...
class ShapeSelector(Selector):
    ...
    def stop(self):
        ...
        # Clear stuffs added to the plot
        try:
...
class ShapesSelector(Selector):
    ...
    def start(self):
        ...
        roiWidget = RoiSelectionWidget(
            plot, kinds=self.__kinds, loadFromDeviceName=self.__deviceName
        )
