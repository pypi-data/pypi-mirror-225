locale = {
    ...
    'ensure this value contains valid import path or valid callable: {error_message}':
        '確保此值包含有效的導入路徑或有效的可調用對象: {error_message}',
