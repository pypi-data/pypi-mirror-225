...
print ("##############################################################")  
print ("Which orbital will be analyzed ? =============================")
print ("--------------------------------------------------------------") 
print ("Enter which orbital will be analyzed -------------------------")
if (lorbit <= 10):  print ("s p d f")
if (lorbit >= 11): print ("s px py pz dxy dyz dz2 dxz dx2 fyx2 fxyz fyz2 fzz2 fxz2 fzx2 fxx2")
print ("##############################################################")
orb_esc = input ("Orbital  "); orb_esc = str(orb_esc)
print (" ")
...
print ("##############################################################")
print ("What is the number of Orbital Contours you want to obtain? ===")
print ("##############################################################")
...
linha += 1; lines.insert(linha, f'n_contour = {n_contour}        #  Number of Orbital Contours to be obtained \n')
