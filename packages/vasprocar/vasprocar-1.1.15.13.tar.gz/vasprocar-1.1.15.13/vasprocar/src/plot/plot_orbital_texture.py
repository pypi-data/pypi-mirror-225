...
for i in range(6):
    ...
    if (i == 0):
       orbital = countour[:,3]; l_orb = '_S'
    if (i == 1):
       orbital = countour[:,4]; l_orb = '_P'
    if (i == 2):
       orbital = countour[:,5]; l_orb = '_D'
    if (i == 3):
       orbital = countour[:,7]; l_orb = '_Px'
    if (i == 4):
       orbital = countour[:,8]; l_orb = '_Py'
    if (i == 5):
       orbital = countour[:,9]; l_orb = '_Pz'
