...
from yaoys_checkin.aliyunpan_checkin.aliyunpan_task.aliyunpan_task import create_album, create_quick_pass, delete_file, delete_lastTime_album, delete_photo_from_album, follow_user, get_lucky_bittle, play_video_by_mobile, play_video_by_windows, upload_file, upload_photo
                ...
                try:
                    ...
                    for i in range(len(self.daily_task_json)):
                        ...
                        # 播放 30s 视频
                            ...
                            is_success, message = play_video_by_mobile(aligo=self.aligo, access_token=self.access_token)
                            break
                        # 备份盘上传十个文件
