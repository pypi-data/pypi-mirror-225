...
class ESGHint(object):
    ...
    def research_news_recent(cls, company_name, seleya_headlines):
        human_message = cls.query_recent(company_name=company_name, seleya_headlines=seleya_headlines, method=PromptsMessage.Human)
        system_message = cls.research_assistant()
        return [system_message, human_message]
    ...
    def query_summary(cls, company_name, controv, search_term, method):
        ...
        query = f"""
                                ...
                                Please extract the relative information, and respond in about 200 words in concise and professional tone in markdown text.
                                Please highlight item headers and important phrases in bold.
                                ...
                                Please rank your findings by recency of the source articles.
