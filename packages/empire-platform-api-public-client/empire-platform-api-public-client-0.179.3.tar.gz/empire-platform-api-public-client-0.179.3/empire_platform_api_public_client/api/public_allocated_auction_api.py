...
class PublicAllocatedAuctionApi(object):
    ...
    @validate_arguments
    def get_public_aggregated_allocated_auctions(self, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescale : Annotated[Optional[AuctionTimescale], Field(description="Auction Timescale (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, **kwargs) -> List[AggregatedAllocatedAuction]:  # noqa: E501
    ...
    @validate_arguments
    def get_public_aggregated_allocated_auctions_with_http_info(self, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescale : Annotated[Optional[AuctionTimescale], Field(description="Auction Timescale (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_public_aggregated_allocated_auctions  # noqa: E501
    ...
    @validate_arguments
    def get_public_allocated_auctions(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : AllocatedAuctionSortBy, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescale : Annotated[Optional[AuctionTimescale], Field(description="Auction Timescale (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, query : Optional[StrictStr] = None, **kwargs) -> AllocatedAuctionBatch:  # noqa: E501
