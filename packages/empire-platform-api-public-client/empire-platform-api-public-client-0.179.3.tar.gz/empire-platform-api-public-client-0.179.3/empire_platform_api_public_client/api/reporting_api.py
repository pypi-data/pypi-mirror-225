...
class ReportingApi(object):
    ...
    @validate_arguments
    def get_auctions_schedule_report(self, product_types : Annotated[conlist(AuctionProductType), Field(..., description="List of Auction Product Types")], border_direction : Annotated[BorderDirectionWithBoth, Field(..., description="Border Direction with additional 'BOTH' option")], statuses : conlist(AuctionStatus), bidding_period_start : date, bidding_period_end : date, delivery_period_start : date, delivery_period_end : date, **kwargs) -> bytearray:  # noqa: E501
    ...
    @validate_arguments
    def get_auctions_schedule_report_with_http_info(self, product_types : Annotated[conlist(AuctionProductType), Field(..., description="List of Auction Product Types")], border_direction : Annotated[BorderDirectionWithBoth, Field(..., description="Border Direction with additional 'BOTH' option")], statuses : conlist(AuctionStatus), bidding_period_start : date, bidding_period_end : date, delivery_period_start : date, delivery_period_end : date, **kwargs) -> ApiResponse:  # noqa: E501
        """get_auctions_schedule_report  # noqa: E501
    ...
    @validate_arguments
    def get_finance_billing_report(self, x_participant_ids : Annotated[conlist(StrictStr), Field(..., description="List of internal IDs of Participant-type Organisations")], border_direction : Annotated[BorderDirectionWithBoth, Field(..., description="Border Direction with additional 'BOTH' option")], delivery_period_start : date, delivery_period_end : date, invoice_period : date, accounting_codes : conlist(SageCode), **kwargs) -> bytearray:  # noqa: E501
        ...
        >>> thread = api.get_finance_billing_report(x_participant_ids, border_direction, delivery_period_start, delivery_period_end, invoice_period, accounting_codes, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_billing_report_with_http_info(x_participant_ids, border_direction, delivery_period_start, delivery_period_end, invoice_period, accounting_codes, **kwargs)  # noqa: E501

    @validate_arguments
    def get_finance_billing_report_with_http_info(self, x_participant_ids : Annotated[conlist(StrictStr), Field(..., description="List of internal IDs of Participant-type Organisations")], border_direction : Annotated[BorderDirectionWithBoth, Field(..., description="Border Direction with additional 'BOTH' option")], delivery_period_start : date, delivery_period_end : date, invoice_period : date, accounting_codes : conlist(SageCode), **kwargs) -> ApiResponse:  # noqa: E501
        """get_finance_billing_report  # noqa: E501
        ...
        >>> thread = api.get_finance_billing_report_with_http_info(x_participant_ids, border_direction, delivery_period_start, delivery_period_end, invoice_period, accounting_codes, async_req=True)
        >>> result = thread.get()
