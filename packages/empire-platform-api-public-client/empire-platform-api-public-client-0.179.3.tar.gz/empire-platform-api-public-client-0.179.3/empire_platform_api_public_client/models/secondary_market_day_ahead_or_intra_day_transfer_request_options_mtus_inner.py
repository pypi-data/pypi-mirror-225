...
class SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner(BaseModel):
    """
    SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner:
        """Create an instance of SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner:
        """Create an instance of SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner.parse_obj(obj)

        _obj = SecondaryMarketDayAheadOrIntraDayTransferRequestOptionsMtusInner.parse_obj({
            "mtu": obj.get("mtu"),
