...
class SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner(BaseModel):
    """
    SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner:
        """Create an instance of SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner:
        """Create an instance of SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner.parse_obj(obj)

        _obj = SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner.parse_obj({
            "mtu": obj.get("mtu"),
