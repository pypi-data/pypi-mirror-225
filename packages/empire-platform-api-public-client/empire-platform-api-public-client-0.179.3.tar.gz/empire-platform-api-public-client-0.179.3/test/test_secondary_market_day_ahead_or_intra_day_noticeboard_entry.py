...
class TestSecondaryMarketDayAheadOrIntraDayNoticeboardEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry.SecondaryMarketDayAheadOrIntraDayNoticeboardEntry()  # noqa: E501
        if include_optional :
