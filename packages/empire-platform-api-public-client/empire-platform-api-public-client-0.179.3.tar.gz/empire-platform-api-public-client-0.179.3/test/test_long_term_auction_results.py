...
class TestLongTermAuctionResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.long_term_auction_results.LongTermAuctionResults()  # noqa: E501
        if include_optional :
            return LongTermAuctionResults(
                congestion_rent = empire_platform_api_public_client.models.auction_result_congestion_rent.AuctionResultCongestionRent(
                    ...
                    total_revenue = 1.337, ), 
                bids = [
                    empire_platform_api_public_client.models.day_ahead_or_intra_day_auction_mtu_results_bids_inner.DayAheadOrIntraDayAuctionMtuResults_bids_inner(
                ...
                allocated_capacity = [
                    empire_platform_api_public_client.models.long_term_auction_results_allocated_capacity_inner.LongTermAuctionResults_allocatedCapacity_inner(
