...
class TestPublicLongTermAuction(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.public_long_term_auction.PublicLongTermAuction()  # noqa: E501
        if include_optional :
            return PublicLongTermAuction(
                ...
                reserve_price = empire_platform_api_public_client.models.long_term_reserve_price.LongTermReservePrice(
                    steps = [
                        empire_platform_api_public_client.models.long_term_reserve_price_steps_inner.LongTermReservePrice_steps_inner(
                            from = 56, 
                            to = 56, 
                            reserve_price = 1.337, )
                        ], 
                    publish = 'PRELIMINARY_SPEC_PUBLISHED', ), 
                bidding_results = empire_platform_api_public_client.models.long_term_bidding_results.LongTermBiddingResults(
