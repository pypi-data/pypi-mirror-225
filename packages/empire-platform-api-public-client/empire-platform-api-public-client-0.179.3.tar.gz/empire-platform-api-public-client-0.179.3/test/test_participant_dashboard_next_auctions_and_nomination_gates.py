...
class TestParticipantDashboardNextAuctionsAndNominationGates(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.participant_dashboard_next_auctions_and_nomination_gates.ParticipantDashboardNextAuctionsAndNominationGates()  # noqa: E501
        if include_optional :
