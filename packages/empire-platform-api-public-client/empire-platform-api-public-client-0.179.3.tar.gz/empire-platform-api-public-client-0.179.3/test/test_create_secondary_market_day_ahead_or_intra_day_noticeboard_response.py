...
class TestCreateSecondaryMarketDayAheadOrIntraDayNoticeboardResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.create_secondary_market_day_ahead_or_intra_day_noticeboard_response.CreateSecondaryMarketDayAheadOrIntraDayNoticeboardResponse()  # noqa: E501
        if include_optional :
