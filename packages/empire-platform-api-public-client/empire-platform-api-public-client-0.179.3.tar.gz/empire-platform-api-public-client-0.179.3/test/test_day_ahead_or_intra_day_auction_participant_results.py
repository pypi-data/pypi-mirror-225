...
class TestDayAheadOrIntraDayAuctionParticipantResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.day_ahead_or_intra_day_auction_participant_results.DayAheadOrIntraDayAuctionParticipantResults()  # noqa: E501
        if include_optional :
            return DayAheadOrIntraDayAuctionParticipantResults(
                mtus = [
                    empire_platform_api_public_client.models.day_ahead_or_intra_day_auction_participant_results_mtus_inner.DayAheadOrIntraDayAuctionParticipantResults_mtus_inner(
