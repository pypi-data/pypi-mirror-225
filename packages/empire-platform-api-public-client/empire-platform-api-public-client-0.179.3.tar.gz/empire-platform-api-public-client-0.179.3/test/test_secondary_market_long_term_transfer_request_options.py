...
class TestSecondaryMarketLongTermTransferRequestOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.secondary_market_long_term_transfer_request_options.SecondaryMarketLongTermTransferRequestOptions()  # noqa: E501
        if include_optional :
