...
class TestDayAheadOrIntraDayAuctionBidGroupResultBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.day_ahead_or_intra_day_auction_bid_group_result_batch.DayAheadOrIntraDayAuctionBidGroupResultBatch()  # noqa: E501
        if include_optional :
                ...
                entries = [
                    empire_platform_api_public_client.models.day_ahead_or_intra_day_auction_bid_group_result.DayAheadOrIntraDayAuctionBidGroupResult(
                        ...
                        participant = empire_platform_api_public_client.models.auction_bid_participant.AuctionBidParticipant(
                            ...
                            name = '', ), 
                        bids = [
                            empire_platform_api_public_client.models.day_ahead_or_intra_day_auction_bid_group_result_bids_inner.DayAheadOrIntraDayAuctionBidGroupResult_bids_inner(
