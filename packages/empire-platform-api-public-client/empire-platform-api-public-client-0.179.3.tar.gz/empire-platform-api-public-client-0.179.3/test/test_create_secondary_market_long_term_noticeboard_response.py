...
class TestCreateSecondaryMarketLongTermNoticeboardResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.create_secondary_market_long_term_noticeboard_response.CreateSecondaryMarketLongTermNoticeboardResponse()  # noqa: E501
        if include_optional :
