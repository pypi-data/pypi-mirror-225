...
class TestSecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry_response.SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse()  # noqa: E501
        if include_optional :
            return SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse(
                mtus = [
                    empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry_response_mtus_inner.SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse_mtus_inner(
