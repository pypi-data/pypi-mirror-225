...
class SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse(BaseModel):
    ...
    """
    mtus: conlist(SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner) = Field(...)
    ...
    def from_dict(cls, obj: dict) -> SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse:
        ...
        _obj = SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse.parse_obj({
            "mtus": [SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponseMtusInner.from_dict(_item) for _item in obj.get("mtus")] if obj.get("mtus") is not None else None,
