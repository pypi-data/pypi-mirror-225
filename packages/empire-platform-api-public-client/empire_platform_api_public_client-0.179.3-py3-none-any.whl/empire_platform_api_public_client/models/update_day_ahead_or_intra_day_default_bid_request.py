...
class UpdateDayAheadOrIntraDayDefaultBidRequest(BaseModel):
    ...
    bids: conlist(CreateDayAheadOrIntraDayDefaultBidRequestBidsInner) = Field(...)
    ...
    def from_dict(cls, obj: dict) -> UpdateDayAheadOrIntraDayDefaultBidRequest:
        ...
        _obj = UpdateDayAheadOrIntraDayDefaultBidRequest.parse_obj({
            ...
            "bids": [CreateDayAheadOrIntraDayDefaultBidRequestBidsInner.from_dict(_item) for _item in obj.get("bids")] if obj.get("bids") is not None else None
        })
        return _obj
