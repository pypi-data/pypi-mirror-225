...
class SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner(BaseModel):
    """
    SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner:
        """Create an instance of SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner:
        """Create an instance of SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner.parse_obj(obj)

        _obj = SubmitDayAheadOrIntraDayBidsRequestBidGroupsInnerBidsInner.parse_obj({
            "mtu": obj.get("mtu"),
