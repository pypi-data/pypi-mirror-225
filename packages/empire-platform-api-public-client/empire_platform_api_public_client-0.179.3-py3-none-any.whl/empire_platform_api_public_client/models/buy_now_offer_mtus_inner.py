...
class BuyNowOfferMtusInner(BaseModel):
    """
    BuyNowOfferMtusInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BuyNowOfferMtusInner:
        """Create an instance of BuyNowOfferMtusInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BuyNowOfferMtusInner:
        """Create an instance of BuyNowOfferMtusInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BuyNowOfferMtusInner.parse_obj(obj)

        _obj = BuyNowOfferMtusInner.parse_obj({
            "mtu": obj.get("mtu"),
            "oc": obj.get("oc")
        })
        return _obj
