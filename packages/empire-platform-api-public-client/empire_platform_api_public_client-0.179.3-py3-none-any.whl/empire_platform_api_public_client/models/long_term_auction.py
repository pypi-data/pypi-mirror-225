...
class LongTermAuction(BaseModel):
    ...
    bidding_results: Optional[LongTermBiddingResults] = Field(None, alias="biddingResults")
    __properties = ["id", "name", "displayId", "productType", "borderDirection", "status", "processing", "deliveryPeriod", "allocationMtuSize", "allocationResolution", "biddingConfiguration", "processSteps", "offeredCapacity", "reservePrice", "biddingResults"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of bidding_results
        if self.bidding_results:
            _dict['biddingResults'] = self.bidding_results.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: dict) -> LongTermAuction:
        ...
        _obj = LongTermAuction.parse_obj({
            ...
            "bidding_results": LongTermBiddingResults.from_dict(obj.get("biddingResults")) if obj.get("biddingResults") is not None else None
        })
        return _obj
