...
class AggregatedNominationsMnsOrGbMtusInner(BaseModel):
    """
    AggregatedNominationsMnsOrGbMtusInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AggregatedNominationsMnsOrGbMtusInner:
        """Create an instance of AggregatedNominationsMnsOrGbMtusInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AggregatedNominationsMnsOrGbMtusInner:
        """Create an instance of AggregatedNominationsMnsOrGbMtusInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AggregatedNominationsMnsOrGbMtusInner.parse_obj(obj)

        _obj = AggregatedNominationsMnsOrGbMtusInner.parse_obj({
            "mtu": obj.get("mtu"),
