...
class ReportingApi(object):
    ...
    @validate_arguments
    def get_finance_billing_report(self, x_participant_ids : Annotated[conlist(StrictStr), Field(..., description="List of internal IDs of Participant-type Organisations")], border_direction : Annotated[BorderDirectionWithBoth, Field(..., description="Border Direction with additional 'BOTH' option")], accounting_codes : conlist(SageCode), delivery_period_start : Optional[date] = None, delivery_period_end : Optional[date] = None, invoice_period : Optional[date] = None, **kwargs) -> bytearray:  # noqa: E501
        ...
        >>> thread = api.get_finance_billing_report(x_participant_ids, border_direction, accounting_codes, delivery_period_start, delivery_period_end, invoice_period, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_billing_report_with_http_info(x_participant_ids, border_direction, accounting_codes, delivery_period_start, delivery_period_end, invoice_period, **kwargs)  # noqa: E501

    @validate_arguments
    def get_finance_billing_report_with_http_info(self, x_participant_ids : Annotated[conlist(StrictStr), Field(..., description="List of internal IDs of Participant-type Organisations")], border_direction : Annotated[BorderDirectionWithBoth, Field(..., description="Border Direction with additional 'BOTH' option")], accounting_codes : conlist(SageCode), delivery_period_start : Optional[date] = None, delivery_period_end : Optional[date] = None, invoice_period : Optional[date] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_finance_billing_report  # noqa: E501
        ...
        >>> thread = api.get_finance_billing_report_with_http_info(x_participant_ids, border_direction, accounting_codes, delivery_period_start, delivery_period_end, invoice_period, async_req=True)
        >>> result = thread.get()
