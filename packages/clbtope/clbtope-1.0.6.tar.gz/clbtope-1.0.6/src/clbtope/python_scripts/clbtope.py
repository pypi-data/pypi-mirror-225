...
model_path = os.path.join(filepath, 'model', 'clbtope_dpc400model.onnx')
...
if not os.path.exists(model_path):
    ...
    # Use tqdm to display a progress bar during download
...
def main():    
    ...
    if Job == 1:
        ...
        df1 = lenchk(dfseq)
        X = feature_gen(df1)
        mlres = model_run(X,nf_path+'/model/clbtope_dpc400model.onnx')
