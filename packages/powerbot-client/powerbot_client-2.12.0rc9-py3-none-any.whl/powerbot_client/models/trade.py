...
class Trade(object):
    ...
    def buy_clearing_account_type(self):
        ...
        Defines if the order is entered on its own account, or as an agent.  **Note**: Only relevant for M7 based exchanges (HUPX, SouthPool, TGE, EPEX, SEMO).  # noqa: E501
    ...
    def location(self):
        ...
        Location within the delivery area.  **Note**: At this moment only M7 (HUPX, SouthPool, TGE, EPEX, SEMO) supports this field.  # noqa: E501
