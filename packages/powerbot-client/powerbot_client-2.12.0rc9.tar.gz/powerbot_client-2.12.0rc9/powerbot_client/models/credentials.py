...
class Credentials(object):
    ...
    def mfa_secret(self):
        ...
        Multi factor authentication secret. This is only required if MFA is activated.  **Note**: At this moment only M7 (HUPX, SouthPool, TGE, EPEX, SEMO) supports MFA.  # noqa: E501
