...
class DeliveryArea(object):
    ...
    def market_eic(self):
        ...
        The Energy Identification Code of the market area.  **Note**: Only relevant for M7 based exchanges (HUPX, SouthPool, TGE, EPEX, SEMO).  # noqa: E501
    ...
    def long_name(self):
        ...
        The long name of the delivery area.  **Note**: Only relevant for M7 based exchanges (HUPX, SouthPool, TGE, EPEX, SEMO).  # noqa: E501
