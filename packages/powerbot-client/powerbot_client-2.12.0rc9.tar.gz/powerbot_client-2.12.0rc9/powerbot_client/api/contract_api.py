...
class ContractApi(object):
    ...
    def get_order_books(self, **kwargs):  # noqa: E501
        ...
        :param portfolio_id: Providing a portfolio ID that corresponds with a shadow trading portfolio will result in the application of order book changes according to shadow trades made with the given portfolio. Shadow orders will also be added to the respective side of the order book. Note that this parameter is mandatory for tenants which have shadow trading portfolios. Additionally, only one shadow trading portfolio can be retrieved per request.
        :type portfolio_id: list[str]
