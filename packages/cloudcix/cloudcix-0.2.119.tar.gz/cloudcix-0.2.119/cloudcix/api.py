...
class contact(object):
    ...
    activity = APIClient(
        application=_application_name,
        service_uri='activity/')
    activity_type = APIClient(
        application=_application_name,
        service_uri='activity_type/')
    auth = APIClient(
        application=_application_name,
        service_uri='auth/')
    campaign = APIClient(
    ...
    conversation = APIClient(
        application=_application_name,
        service_uri='conversation/')
    corpus = APIClient(
        application=_application_name,
        service_uri='corpus/')
    corpus_data = APIClient(
        application=_application_name,
        service_uri='corpus_data/')
    group = APIClient(
        application=_application_name,
        service_uri='group/')
