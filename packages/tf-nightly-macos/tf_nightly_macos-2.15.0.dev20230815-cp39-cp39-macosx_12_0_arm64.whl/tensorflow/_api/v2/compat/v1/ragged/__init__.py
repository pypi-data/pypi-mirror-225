...
* `tf.math.bessel_i1e`(**x**, name=`None`)
* `tf.math.bincount`(**arr**, weights=`None`, minlength=`None`, maxlength=`None`, dtype=`tf.int32`, name=`None`, axis=`None`, binary_output=`False`)
...
* `tf.ones_like`(**input**, dtype=`None`, name=`None`, layout=`None`)
* `tf.ones_like`(**input**, dtype=`None`, name=`None`, layout=`None`)
...
* `tf.zeros_like`(**input**, dtype=`None`, name=`None`, layout=`None`)n
"""
