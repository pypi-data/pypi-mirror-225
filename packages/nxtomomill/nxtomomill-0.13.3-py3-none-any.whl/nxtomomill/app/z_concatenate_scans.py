...
from tomoscan.esrf.scan.hdf5scan import HDF5TomoScan, ImageKey
...
def main(argv):
    ...
    for i_stage in range(args.first_stage, args.last_stage + 1):
        ...
        scan = HDF5TomoScan(filename, args.entry_name)
        ...
        invalid_nxt = nxtomomill.nexus.NXtomo(args.entry_name)
    ...
    with h5py.File(output_file, "r+") as output_target:
        ...
        if do_flat or (args.cors_file is not None):
            ...
            if do_flat:
                ...
                # save metadata
                scan = HDF5TomoScan(output_file, args.entry_name)
...
def add_flat_to_dict(
    ...
    if args.flats_from_reduced:
        ...
        scan = HDF5TomoScan(args.scan_before, args.entry_name)
        ...
        scan = HDF5TomoScan(args.scan_after, args.entry_name)
