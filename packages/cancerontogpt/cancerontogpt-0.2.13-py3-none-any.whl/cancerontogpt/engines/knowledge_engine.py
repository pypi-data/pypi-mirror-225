...
from cancerontogpt import DEFAULT_MODEL
from cancerontogpt.clients import OpenAIClient
from cancerontogpt.templates.core import ExtractionResult, NamedEntity
...
class KnowledgeEngine(ABC):
    ...
    def _get_template_class(self, template: TEMPLATE_NAME) -> ClassDefinition:
        ...
        if class_name is None:
            ...
            class_name = roots[0]
        mod = importlib.import_module(f"cancerontogpt.templates.{module_name}")
