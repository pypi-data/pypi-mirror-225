...
There are a number of pre-defined LinkML data models already developed here - [src/cancerontogpt/templates/](src/ontogpt/templates/) which you can use as reference when creating your own data models.
