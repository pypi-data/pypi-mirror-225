...
from cancerontogpt.ontex.extractor import (
    Answer,
    Axiom,
    Explanation,
    GPTReasonMethodType,
...
from cancerontogpt.prompts.reasoning import DEFAULT_REASONING_PROMPT
from cancerontogpt.utils.parse_utils import split_on_one_of
...
class ReasonerEngine(KnowledgeEngine):
    ...
    >>> from cancerontogpt.ontex.extractor import OntologyExtractor, Task
