...
from cancerontogpt.engines.knowledge_engine import DATAMODELS
from cancerontogpt.engines.spires_engine import SPIRESEngine
from cancerontogpt.io.html_exporter import HTMLExporter
from cancerontogpt.utils.gene_set_utils import GeneSet
...
def start():
    ...
    uvicorn.run("cancerontogpt.webapp.main:app", host="127.0.0.1", port=8000, reload=True)
