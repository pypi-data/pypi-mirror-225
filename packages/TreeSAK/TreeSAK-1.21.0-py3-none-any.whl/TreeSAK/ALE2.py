...
TreeSAK ALE2 -i ALE1_op_dir -s Marker_set_1_PA_75_C60_PMSF_concatenated_rooted.treefile -t 10 -f -o ALE2_op_dir -runALE -docker gregmich/alesuite_new
...
def ALE2(args):
    ...
    for qualified_og in og_to_process_list:
        ...
        if os.path.isfile(pwd_gene_tree_ufboot) is False:
            ...
            ALEobserve_stdout           = '%s_log_ALEobserve.txt'               % qualified_og
            ALEml_undated_stdout        = '%s_log_ALEml_undated.txt'            % qualified_og
...
cd /Users/songweizhi/Desktop/demo
python3 /Users/songweizhi/PycharmProjects/TreeSAK/TreeSAK/ALE2.py -i ALE1_op_dir -s gnm.treefile -t 6 -f -o ALE2_op_dir_test
python3 /Users/songweizhi/PycharmProjects/TreeSAK/TreeSAK/ALE2.py -i ALE1_op_dir -s gnm.treefile -t 6 -f -o ALE2_op_dir_test -docker gregmich/alesuite_new
