...
class PrintJob(PrinterReservationPolymorphic):
    """
    PrintJob
    """
    ...
    __properties = ["created", "created_by", "deleted", "deleted_by_cascade", "end_dt", "id", "notes", "polymorphic_ctype", "printer", "start_dt", "title", "workspace", "progress", "estimated_print_seconds", "clear_dt", "status", "batch"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(PrintJobTyped):
        """Create an instance of PrintJob from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(PrintJobTyped):
        """Create an instance of PrintJob from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("PrintJob failed to lookup discriminator value from " +
