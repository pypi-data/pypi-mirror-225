...
class PatchedUserRequest(BaseModel):
    ...
    email: Optional[constr(strict=True, max_length=254, min_length=1)] = None
    __properties = ["name", "email"]
    ...
    def from_dict(cls, obj: dict) -> PatchedUserRequest:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PatchedUserRequest) in the input: " + obj)
