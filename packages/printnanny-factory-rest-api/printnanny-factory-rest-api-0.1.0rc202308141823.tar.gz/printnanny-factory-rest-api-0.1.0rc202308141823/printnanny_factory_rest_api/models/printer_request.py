...
class PrinterRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrinterRequest:
        """Create an instance of PrinterRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrinterRequest:
        """Create an instance of PrinterRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrinterRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PrinterRequest) in the input: " + obj)

        _obj = PrinterRequest.parse_obj({
            "name": obj.get("name"),
