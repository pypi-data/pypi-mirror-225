...
class MaintenanceJobRequest(PrinterReservationPolymorphicRequest):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(MaintenanceJobTypedRequest):
        """Create an instance of MaintenanceJobRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(MaintenanceJobTypedRequest):
        """Create an instance of MaintenanceJobRequest from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("MaintenanceJobRequest failed to lookup discriminator value from " +
