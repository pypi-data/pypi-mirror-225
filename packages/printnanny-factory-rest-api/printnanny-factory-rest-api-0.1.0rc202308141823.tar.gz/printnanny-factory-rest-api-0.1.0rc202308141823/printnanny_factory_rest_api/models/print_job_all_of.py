...
class PrintJobAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrintJobAllOf:
        """Create an instance of PrintJobAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrintJobAllOf:
        """Create an instance of PrintJobAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrintJobAllOf.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PrintJobAllOf) in the input: " + obj)

        _obj = PrintJobAllOf.parse_obj({
