...
class PatchedDuetPrinterBackendRequest(BaseModel):
    """
    PatchedDuetPrinterBackendRequest
    """
    ...
    __properties = ["network", "job", "status", "last_message", "last_message_at", "tz", "printer"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedDuetPrinterBackendRequest:
        """Create an instance of PatchedDuetPrinterBackendRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedDuetPrinterBackendRequest:
        """Create an instance of PatchedDuetPrinterBackendRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedDuetPrinterBackendRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PatchedDuetPrinterBackendRequest) in the input: " + obj)

        _obj = PatchedDuetPrinterBackendRequest.parse_obj({
