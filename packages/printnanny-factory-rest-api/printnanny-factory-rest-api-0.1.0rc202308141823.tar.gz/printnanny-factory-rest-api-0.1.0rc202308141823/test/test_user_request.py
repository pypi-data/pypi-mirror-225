...
from printnanny_factory_rest_api.models.user_request import UserRequest  # noqa: E501
...
class TestUserRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = printnanny_factory_rest_api.models.user_request.UserRequest()  # noqa: E501
        if include_optional :
            return UserRequest(
                name = '',
                email = '0'
