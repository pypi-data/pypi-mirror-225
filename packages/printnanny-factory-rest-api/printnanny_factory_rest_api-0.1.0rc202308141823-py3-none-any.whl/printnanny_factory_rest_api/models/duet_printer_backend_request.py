...
class DuetPrinterBackendRequest(BaseModel):
    """
    DuetPrinterBackendRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DuetPrinterBackendRequest:
        """Create an instance of DuetPrinterBackendRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DuetPrinterBackendRequest:
        """Create an instance of DuetPrinterBackendRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DuetPrinterBackendRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DuetPrinterBackendRequest) in the input: " + obj)

        _obj = DuetPrinterBackendRequest.parse_obj({
