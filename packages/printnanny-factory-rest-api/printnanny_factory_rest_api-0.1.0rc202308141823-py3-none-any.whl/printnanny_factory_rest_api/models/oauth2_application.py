...
class Oauth2Application(BaseModel):
    ...
    client_id: Optional[constr(strict=True, max_length=100)] = None
    ...
    default_scopes: Optional[StrictStr] = None
    ...
    __properties = ["id", "api_url", "client_id", "client_secret", "default_scopes", "authorization_grant_type", "client_type", "name", "created", "workspace", "printer"]
    ...
    def from_dict(cls, obj: dict) -> Oauth2Application:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Oauth2Application) in the input: " + obj)
