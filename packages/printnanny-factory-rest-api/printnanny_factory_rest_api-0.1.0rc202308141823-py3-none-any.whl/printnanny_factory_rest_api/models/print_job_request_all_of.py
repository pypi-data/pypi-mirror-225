...
class PrintJobRequestAllOf(BaseModel):
    """
    PrintJobRequestAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrintJobRequestAllOf:
        """Create an instance of PrintJobRequestAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrintJobRequestAllOf:
        """Create an instance of PrintJobRequestAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrintJobRequestAllOf.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PrintJobRequestAllOf) in the input: " + obj)

        _obj = PrintJobRequestAllOf.parse_obj({
