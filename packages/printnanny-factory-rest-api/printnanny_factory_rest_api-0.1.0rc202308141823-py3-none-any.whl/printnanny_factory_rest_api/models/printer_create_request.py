...
class PrinterCreateRequest(BaseModel):
    ...
    __properties = ["name", "bed_cleared", "oem", "filament", "nozzle", "bed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrinterCreateRequest:
        """Create an instance of PrinterCreateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrinterCreateRequest:
        """Create an instance of PrinterCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrinterCreateRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PrinterCreateRequest) in the input: " + obj)

        _obj = PrinterCreateRequest.parse_obj({
            "name": obj.get("name"),
