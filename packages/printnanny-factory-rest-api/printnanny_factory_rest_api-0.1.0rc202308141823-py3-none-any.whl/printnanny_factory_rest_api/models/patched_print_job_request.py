...
class PatchedPrintJobRequest(PatchedPrinterReservationPolymorphicRequest):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(PatchedPrintJobTypedRequest):
        """Create an instance of PatchedPrintJobRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(PatchedPrintJobTypedRequest):
        """Create an instance of PatchedPrintJobRequest from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("PatchedPrintJobRequest failed to lookup discriminator value from " +
