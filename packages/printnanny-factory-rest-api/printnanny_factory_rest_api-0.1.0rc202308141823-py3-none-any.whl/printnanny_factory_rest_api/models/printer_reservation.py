...
class PrinterReservation(PrinterReservationPolymorphic):
    """
    PrinterReservation
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(PrinterReservationTyped):
        """Create an instance of PrinterReservation from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(PrinterReservationTyped):
        """Create an instance of PrinterReservation from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("PrinterReservation failed to lookup discriminator value from " +
