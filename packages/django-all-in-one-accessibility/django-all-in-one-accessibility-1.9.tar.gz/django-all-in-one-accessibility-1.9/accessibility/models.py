...
class all_in_one_accessibility(models.Model):
    aioa_license_Key = models.CharField(max_length=150,blank=True,validators=[validate_token],default=None,verbose_name='License Key',help_text=aioa_NOTE)
    ...
    aioa_icon_size = RadioGridField(rows=ROWS,values=CHOICES1,require_all_fields = False,default=('aioa-default-icon', format_html('<img class="csticontype" src="https://skynettechnologies.com/sites/default/files/python/{}" width="55" height="55" />',value_i)), verbose_name='Icon Size For Desktop',help_text=icon_change)
    ...
    def __str__(self):
        return '{}, {}, {}'.format(self.aioa_place,self.aioa_color_code, self.aioa_license_Key,self.aioa_icon_type, self.aioa_icon_size)
