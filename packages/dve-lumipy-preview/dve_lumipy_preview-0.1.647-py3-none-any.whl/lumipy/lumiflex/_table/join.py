...
class Join(BaseTable):
    ...
    def _ipython_display_(self):
        return display(join_table_widget(self))
    ...
    def inner_join(self, other: Table, on: Column, right_alias) -> Join:
        ...
        """
        return Join(join_type='inner', client=self.client_, parents=(self, other.with_alias(right_alias), on))
    ...
    def left_join(self, other: Table, on: Column, right_alias) -> Join:
        ...
        """
        return Join(join_type='left', client=self.client_, parents=(self, other.with_alias(right_alias), on))
