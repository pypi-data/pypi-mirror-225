...
class OrganizationDataset(BaseModel):
    ...
    __properties = ["dataset", "lastFileCreated", "totalFileSize", "totalFileCount", "totalItemCount", "totalItemCountChecklistOK", "totalItemCountChecklistFailed", "tags", "category", "bucket"]
