...
class OrganizationAddDatasetRequestBucket(BaseModel):
    ...
    data_item_naming_levels_deep: StrictInt = Field(..., alias="dataItemNamingLevelsDeep", description="Number of levels deep for data items, e.g. if you have folder \"test/abc\", with value 1 \"test\" will be a data item, with value 2 \"test/abc\" will be a data item.")
