...
class Blaze:
    ...
    Performance = pd.DataFrame({'Naive':[rmse_naive, mape_naive, mase_naive],
                    ...
                    'Hybrid (SARIMA and Prophet)': [(rmse_SARIMA+rmse_Prophet)/2, (mape_SARIMA+mape_Prophet)/2, 
    ...
    Hybrid_Forecast_All['Hybrid Forecast']=(Hybrid_Forecast_All['SARIMA Forecast']/2 + Hybrid_Forecast_All['Prophet Forecast']/2)
    Hybrid_Forecast_All['Hybrid Lower Limit']=(Hybrid_Forecast_All['SARIMA Lower Limit']/2 + Hybrid_Forecast_All['Prophet Lower Limit']/2)
    Hybrid_Forecast_All['Hybrid Upper Limit']=(Hybrid_Forecast_All['SARIMA Upper Limit']/2 + Hybrid_Forecast_All['Prophet Upper Limit']/2)

    Hybrid_Forecast_Final=Hybrid_Forecast_All[['Hybrid Forecast', 'Hybrid Lower Limit', 'Hybrid Upper Limit', 'SARIMA Forecast', 'Prophet Forecast' ]]
