...
class CloudAnalyticsEventCloudResource(object):
    ...
    allowable_values = [UNSPECIFIED, AWS_VPC, AWS_SUBNET, AWS_SECURITY_GROUP, AWS_S3_BUCKET, AWS_IAM_ROLE, AWS_EFS, AWS_CLOUDFORMATION, GCP_PROJECT, GCP_VPC, GCP_SUBNET, GCP_SERVICE_ACCOUNT, GCP_WORKLOAD_IDENTITY_PROVIDER, GCP_FIREWALL_POLICY, GCP_FILESTORE, GCP_STORAGE_BUCKET, GCP_DEPLOYMENT]  # noqa: E501
