...
def cloud_edit(
    ...
    if any([aws_s3_id, aws_efs_id, aws_efs_mount_target_ip]):
        CloudController().edit_aws_cloud(
            cloud_name=cloud_name or name,
            cloud_id=cloud_id,
            aws_s3_id=aws_s3_id,
        ...
        raise click.ClickException(
            "Please provide at least one of the following arguments: --aws-s3-id, --aws-efs-id, --aws-efs-mount-target-ip"
        )
