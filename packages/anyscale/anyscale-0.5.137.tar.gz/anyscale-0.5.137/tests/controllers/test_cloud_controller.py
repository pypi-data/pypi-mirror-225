...
@pytest.mark.parametrize(
    (
        "has_cloud_resource",
        "get_mount_target_ip_succeed",
        "static_verify_succeed",
        "api_call_succeed",
    ),
    [
...
def test_edit_cloud(
    ...
    mock_validate_functional_verification_args = Mock(return_value="")
    ...
    with patch.multiple(
        ...
        mock_validate_functional_verification_args,
    ):
        cloud_controller = CloudController()
        cloud_controller.log = Mock()
        cloud_controller.api_client.get_cloud_api_v2_clouds_cloud_id_get = Mock()
        ...
        if all(
            ...
            cloud_controller.edit_aws_cloud(
                cloud_name="mock_cloud_name",
                cloud_id="",
        ...
        # error path.
            ...
            with pytest.raises(ClickException) as e:
                ...
                e.match("Cloud verification failed.")
