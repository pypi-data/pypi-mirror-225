...
claude_v2 = Model(name="claude-v2", base_provider="anthropic", best_provider=None)
...
class ModelUtils:
    convert: dict[str, Model] = {
        ...
        "sage-assistant": sage_assistant,
        "claude-v2-100k": claude_v2_100k,
    }
