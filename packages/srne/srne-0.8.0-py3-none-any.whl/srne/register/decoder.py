...
def decode_default(values: List[int]) -> None | int | List[int]:
...
def decode_datetime(values: List[int]) -> str:
...
def decode_version(values: List[int]) -> str:
...
def decode_load_and_charge_status(values: List[int]) -> Dict[str, Any]:
...
def decode_alarm_message(values: List[int]) -> List[str]:
...
def decode_controller_and_battery_temperature(values: List[int]) -> Dict[str, int]:
    high, low = split16(values[0])
    temperatures = {
...
def decode_current_fault_bits(values: List[int]) -> int:
...
def decode_charge_discharge_cutoff_soc(values: List[int]) -> Dict[str, int]:
    high, low = split16(values[0])
    cutoff_soc = {
...
def decode_special_power_control(values: List[int]) -> Dict[str, Any]:
    bits = values[0]
...
def decode_record(values: List[int]) -> Dict[str, Any]:
    validity = "valid_record" if values[0] else "invalid_record"
    timestamp = decode_datetime(values[1:4])
    packets = values[4:]
    record = {
        "validity": validity,
