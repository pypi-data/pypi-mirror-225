    ...
    Args:
        ...
        checkers (list[dict[str, Any]]): A list of dictionaries, where each dictionary
            ...
            Each dictionary must have keys:
               - checker: type of checker to use.
               - comparer: comparer function or operator used for value comparison.
               - expected_value: the value to be compared against the response data.
               - (optional) "dict_path": The dot-separated path to the value in the
                    response data. Defaults to None.
               - (optional) "search_query": A search query to use to find the value in
