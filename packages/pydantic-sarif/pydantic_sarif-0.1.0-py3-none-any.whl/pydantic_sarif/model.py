...
#   timestamp: 2023-08-15T13:22:27+00:00
...
class ToolComponent(BaseModel):
    ...
    dottedQuadFileVersion: Optional[constr(regex=r'[0-9]+(\.[0-9]+){3}')] = Field(
        None,
    ...
    language: Optional[
        constr(regex=r'^[a-zA-Z]{2}|^[a-zA-Z]{2}-[a-zA-Z]{2}]?$')
    ] = Field(
        'en-US',
...
class Artifact(BaseModel):
    ...
    mimeType: Optional[constr(regex=r'[^/]+/.+')] = Field(
