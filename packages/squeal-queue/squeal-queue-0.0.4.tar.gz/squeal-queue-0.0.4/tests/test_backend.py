...
class TestBackend:
    ...
    def test_uniqueness(self, backend_class: Type[TemporaryBackendMixin]):
        with backend_class() as bk:
            bk.batch_put(
                data=[(b"a", 1, b'0000000000000000'), (b"b", 1, b'0000000000000001'), (b"c", 1, b'0000000000000002')],
                priority=0,
                delay=0,
                failure_base_delay=0,
                visibility_timeout=0,
    ...
    def test_uniqueness_doesnt_preclude_redoing_messages(self, backend_class: Type[TemporaryBackendMixin]):
        with backend_class() as bk:
            bk.batch_put(
