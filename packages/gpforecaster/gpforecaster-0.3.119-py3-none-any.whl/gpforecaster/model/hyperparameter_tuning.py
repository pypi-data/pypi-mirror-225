...
def single_trial(
    ...
    try:
        model, like = gpf.train(
            ...
            k=hyperparameters["k"],
            b=hyperparameters["b"],
            like_noise=hyperparameters["like_noise"],
...
def optimize_hyperparameters_bayesian(
    ...
    if hyperparameters_list is None:
        hyperparameters_list = [
            ...
            "scale_periodic_kernel_outputscale", "m", "k", "b", "like_noise",
    ...
    all_hyperparameters = {
        ...
        "periodic_kernel_lengthscale": Real(0.01, 0.2, name="periodic_kernel_lengthscale"),
        ...
        "like_noise": Real(0.0001, 0.1, name="like_noise"),
