...
class Trainer:
    ...
    def logged_metrics(self) -> _OUT_DICT:
        ...
        This includes metrics logged via :meth:`~pytorch_lightning.core.module.LightningModule.log` with the
        :paramref:`~pytorch_lightning.core.module.LightningModule.log.logger` argument set.
    ...
    def progress_bar_metrics(self) -> _PBAR_DICT:
        ...
        This includes metrics logged via :meth:`~pytorch_lightning.core.module.LightningModule.log` with the
        :paramref:`~pytorch_lightning.core.module.LightningModule.log.prog_bar` argument set.
