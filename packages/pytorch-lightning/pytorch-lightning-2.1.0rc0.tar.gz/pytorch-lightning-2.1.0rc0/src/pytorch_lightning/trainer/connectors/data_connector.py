...
from pytorch_lightning.utilities.imports import _lightning_graphcore_available
...
class _DataLoaderSource:
    ...
    1. from a ``*_dataloader()`` method on the :class:`~pytorch_lightning.core.module.LightningModule`,
