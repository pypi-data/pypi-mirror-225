...
class ModelCheckpoint(Checkpoint):
    ...
    :meth:`~pytorch_lightning.core.module.LightningModule.log` or
    :meth:`~pytorch_lightning.core.module.LightningModule.log_dict` is a candidate for the monitor key.
