...
# region cneuro_
l_cneuro_text = {
    'ru': "🦾 <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> нейро-постинг: генерация фото/текста на основе постов/описания/контента @{0}-бота",
    'en': "文<b>Click</b> on ✅/☑️ to <b>enable/disable</b> auto-translate for <i>outgoing</i> bot messages into the user's language when /start-starting the bot",
    'es': "文<b>Haga clic</b> en ✅/☑️ para <b>habilitar/deshabilitar</b> la traducción automática de los mensajes <i>salientes</i> del bot al idioma del usuario cuando/inicie el bot",
    'fr': "文<b>Cliquez</b> sur ✅/☑️ pour <b>activer/désactiver</b> la traduction automatique des messages <i>sortants</i> du bot dans la langue de l'utilisateur lors du/démarrage du bot",
    'zh': "文<b>单击</b>✅/☑️<b>启用/禁用</b>在/启动机器人时将<i>传出的</i>机器人消息自动翻译成用户的语言",
...
l_cneuro_media = {
    'ru': "🦾 1. <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> генерацию фото на основе постов/описания/контента @{0}-бота\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
...
l_cneuro_caption = {
    'ru': "🦾 2. <b>Жми</b> на ✅/☑️ чтобы <b>Вкл/Выкл</b> генерацию <u>текста</u> на основе описания и контента @{0}-бота\n\n👩🏽‍💻 <b>Напиши</b> экстра-промпт, если необходимо\n\n(<i>жми «➡️️/Next», чтобы перейти к следующему шагу</i>)",
    'en': "☑️☐Off incoming translation",
    'es': "☑️☐Traducción entrante desactivada",
    'fr': "☑️☐Désactiver la traduction entrante",
    'zh': "☑️☐关闭传入翻译",
...
# region cdecor_
l_cdecor_text = {
    'ru': "🪄 <b>Жми</b> на ✅/☑️, чтобы <b>Вкл/Выкл</b> авто-декор публикуемого поста: <i><b>пагинация</b> (порядковый номер поста)/креативный <b>формат текста</b> (<b>жирный</b>/<i>курсив</i>/<u>подчеркнутый</u>/моно/<tg-spoiler>спойлер</tg-spoiler>/#хэштег/$кэштег/<a href='{0}'>ссылка</a>)/<b>футер</b> (текстовое окончание поста)</i>\n\n👩🏽‍💻 Например, опция <b>[✅☑Вкл формат текста]</b> означает креативное изменение поста с использованием 8 стилей",
...
l_post_whisper_skip = {
    'ru': "👩🏽‍💻 Вы не видите этот шёпот, потому что он был отправлен не вам",
    'en': "👩🏽‍💻 <b>Пользователь</b>: {name} нажал на: [{button}] (пост #<u>{post_id}</u>)",
    'es': "👩🏽‍💻 <b>Regístrese para obtener</b> una\n\n¹ <i>suscripción</i> mensual a @{0}-bot [{1} ₽]\n▪️ sin anuncios\n▪️ tareas creativas\n² Suscríbase a <u>todos</u> los bots [{2} ₽]",
    'fr': "👩🏽‍💻 <b>Inscrivez-vous pour</b> un <i>abonnement</i>\n\n¹ mensuel à @{0}-bot [{1} ₽]\n▪️ pas de publicité\n▪️ tâches créatives\n² Abonnez-vous à <u>tous</u> les bots [{2} ₽]",
    'zh': "👩🏽‍💻<b>注册</b>每月\n\n¹<i>订阅</i>@{0}-bot [{1} ₽]\n▪️ 无广告\n▪️ 创意任务\n² 订阅<u>所有</u>机器人 [{2} ₽]",
