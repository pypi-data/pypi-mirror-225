...
from structgenie.examples.selector import ExampleSelector
from structgenie.input_output import init_input_schema, init_output_model, build_output_schema
...
from structgenie.base import BasePromptBuilder, BaseOutputModel
...
class PromptBuilder(BasePromptBuilder):
    ...
    def __init__(self, instruction: str, output_model: BaseOutputModel = None, input_schema: str = None, **kwargs):
        """Prompt Builder constructor"""
        self.instruction: str = instruction
        self.output_model: BaseOutputModel = init_output_model(output_model, **kwargs)
        self.input_schema: Union[str, dict, list] = init_input_schema(input_schema)
    ...
    def _prep_inputs(self, template: str):
        """Prepare inputs"""
        return self._pass_placeholder(template, input=self.input_schema)
