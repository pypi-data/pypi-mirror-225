...
class Org(Base):
    ...
    def add_user(self, email: str, org_name=None, role='admin', type_='internal', **kwargs):
        ...
        if type_ == 'internal':
            ...
            new_url = parsed_url._replace(path='/api/v1/users/links-invitation/' + url.split('/')[-1] + '/register')
...
class StarInterface:
    ...
    def __init__(self, email, password, host='star.inhandcloud.cn', proxy=False):
        """ 须确保用户关闭了多因素认证
        ...
        """
        self.api = InRequest(host, email, password, 'star', body_remove_none_key=True, param_remove_none_key=True, proxy=proxy)
...
if __name__ == '__main__':
    ...
    star = StarInterface('liwei@inhand.com.cn', 'inhand123456', 'star.inhandcloud.com', proxy=False)
    star.org.update_user('liwei@inhand.com.cn', password='123456')
