...
class TestNftService:
    ...
    async def test_unsupported_chains(self, client: Client):
        async for res in client.nft_service.get_chain_collections("fantom-mainnet"):
            assert res == "250/fantom-mainnet chain not supported, currently supports: 1/eth-mainnet 56/bsc-mainnet 137/matic-mainnet 10/optimism-mainnet 42161/arbitrum-mainnet "
