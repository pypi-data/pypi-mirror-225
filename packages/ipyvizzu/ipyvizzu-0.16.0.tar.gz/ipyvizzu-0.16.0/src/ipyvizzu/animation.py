...
class ConfigAttr(type):
    ...
    [Vizzu Code reference](https://lib.vizzuhq.com/0.8/reference/modules/Presets/#interfaces).
    """
    ...
    def __init__(self, data: Optional[Union[dict, RawJavaScript]]):
        ...
        Args:
            data:
                ...
                [Vizzu Code reference](https://lib.vizzuhq.com/0.8/reference/interfaces/Config.Chart/#properties).
        """  # pylint: disable=line-too-long
    ...
    def __init__(self, data: Optional[dict]):
        ...
        Args:
            data:
                ...
                chapter or the
                [Vizzu Code reference](https://lib.vizzuhq.com/0.8/reference/interfaces/Styles.Chart/#properties).
        """  # pylint: disable=line-too-long
        ...
        **options: Optional[Union[str, int, float, dict]],
        ...
        Args:
            ...
            **options: Dictionary of animation options for example `duration=1`.
                ...
                [Vizzu Code reference](https://lib.vizzuhq.com/0.8/reference/interfaces/Anim.Options/#properties).
