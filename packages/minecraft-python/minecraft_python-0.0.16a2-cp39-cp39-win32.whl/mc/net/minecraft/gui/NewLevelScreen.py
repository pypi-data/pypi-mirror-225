...
class NewLevelScreen(Screen):
    ...
    def init(self, minecraft, width, height):
        ...
        self._buttons.clear()
        self._buttons.append(Button(0, self._y // 2 - 100, self._w // 3, 200, 20, 'Small'))
        self._buttons.append(Button(1, self._y // 2 - 100, self._w // 3 + 32, 200, 20, 'Normal'))
        self._buttons.append(Button(2, self._y // 2 - 100, self._w // 3 + 64, 200, 20, 'Huge'))
        self._buttons.append(Button(3, self._y // 2 - 100, self._w // 3 + 96, 200, 20, 'Cancel'))
    ...
    def render(self, xm, ym):
        ...
        self.drawCenteredString('Generate new level', self._y // 2, 40, 0xFFFFFF)
        super().render(xm, ym)
