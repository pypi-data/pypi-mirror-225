...
class HumanbodyAttr(attr.BaseAttr):
    ...
    def HumanIKTargetDoMove(self, index: int, position: list, duration: float, speed_based: bool = True,
                            relative: bool = False):
        """
        ...
        self._send_data('HumanIKTargetDoMove', index, position, float(duration), speed_based, relative)

    def HumanIKTargetDoRotate(self, index: int, rotation: list, duration: float, speed_based: bool = True,
                              relative: bool = False):
        """
        ...
        self._send_data('HumanIKTargetDoRotate', index, rotation, float(duration), speed_based, relative)

    def HumanIKTargetDoRotateQuaternion(self, index: int, quaternion: list, duration: float, speed_based: bool = True,
                                        relative: bool = False):
        """
        ...
        self._send_data('HumanIKTargetDoRotateQuaternion', index, quaternion, float(duration), speed_based, relative)
