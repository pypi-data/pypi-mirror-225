...
class Client(BaseClient):
    ...
    def checkout(self, input: CheckoutInput) -> Checkout:
        query = gql(
            """
        ...
        response = self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return Checkout.parse_obj(data)
    ...
    def checkout_data(self, input: CheckoutDataInput) -> CheckoutData:
        query = gql(
            """
            query CheckoutData($input: CheckoutDataInput!) {
        ...
        response = self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return CheckoutData.parse_obj(data)
    ...
    def usage_history(self, usage_history_input: UsageHistoryInput) -> UsageHistory:
        query = gql(
            """
