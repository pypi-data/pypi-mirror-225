...
class QTL2631 (PowerModule):
    ...
    def __init__(self,dut):
        ...
        self.calibrations["POWER_1"] = {
            "Voltage":self.QTL2631_VoltageCalibration(self,"POWER_1"),
            "DeltaVolts":self.QTL2631_deltaVoltCalibration(self,"POWER_1")
            }
        # populate POWER_2 channel with calibrations
        self.calibrations["POWER_2"] = {
            "Voltage":self.QTL2631_VoltageCalibration(self,"POWER_2"),
            "DeltaVolts":self.QTL2631_deltaVoltCalibration(self,"POWER_2")
            }
        # populate POWER_3 channel with calibrations
        self.calibrations["POWER_3"] = {
            "Voltage":self.QTL2631_VoltageCalibration(self,"POWER_3"),
            "DeltaVolts":self.QTL2631_deltaVoltCalibration(self,"POWER_3")
            }
        # populate POWER_4 channel with calibrations
        self.calibrations["POWER_4"] = {
            "Voltage":self.QTL2631_VoltageCalibration(self,"POWER_4"),
            "DeltaVolts":self.QTL2631_deltaVoltCalibration(self,"POWER_4")
            }

        self.verifications = {}
        # populate POWER_1 channel with verifications
        self.verifications["POWER_1"] = {
            "Voltage":self.QTL2631_VoltageVerification(self,"POWER_1"),
            "Current":self.QTL2631_deltaVoltVerification(self,"POWER_1")
            }
        self.verifications["POWER_2"] = {
            "Voltage":self.QTL2631_VoltageVerification(self,"POWER_2"),
            "Current":self.QTL2631_deltaVoltVerification(self,"POWER_2")
            }
        self.verifications["POWER_3"] = {
            "Voltage":self.QTL2631_VoltageVerification(self,"POWER_3"),
            "Current":self.QTL2631_deltaVoltVerification(self,"POWER_3")
            }
        self.verifications["POWER_4"] = {
            "Voltage":self.QTL2631_VoltageVerification(self,"POWER_4"),
            "Current":self.QTL2631_deltaVoltVerification(self,"POWER_4")
            }
    ...
    class QTL2631Calibration (Calibration):
    ...
    class QTL2631_VoltageCalibration (QTL2631Calibration):
    ...
    class QTL2631_deltaVoltCalibration (QTL2631Calibration):
        ...
        def readRef(self):
            ...
            # V= IR = current*0.005*1000000           
            return self.powerModule.calInstrument.measureLoadCurrent()*0.005*1000000
