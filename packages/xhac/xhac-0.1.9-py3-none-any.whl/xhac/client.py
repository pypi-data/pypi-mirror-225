    ...
    def connect(self):
        ...
        for device in self._home_db['devices']:
            for service in device['services']:
                ...
                did, sid = device['did'], service["sid"],
...
class Entity():
    def __init__(self, _type, client, name, did, sid, ver):
        self.type = _type
        self._client = client
        self.name = name
        self.did = did
...
class Light(Entity):
    ...
    def __init__(self, client, name, did, sid, ver, attrs):
        super().__init__(ServiceType.LIGHT, client, name, did, sid, ver)
...
class Switch(Entity):
    ...
    def __init__(self, client, name, did, sid, ver, attrs):
        super().__init__(ServiceType.SWITCH, client, name, did, sid, ver)
...
class Thermostat(Entity):
    ...
    def __init__(self, client, name, did, sid, ver, attrs):
        super().__init__(ServiceType.THERMOSTAT, client, name, did, sid, ver)
...
class CardSwitch(Entity):
    ...
    def __init__(self, client: HomeClient, name, did, sid, ver, attrs):
        super().__init__(ServiceType.CARD_SWITCH, client, name, did, sid, ver)
...
class MotionSensor(Entity):
    ...
    def __init__(self, client: HomeClient, name, did, sid, ver, attrs):
        super().__init__(ServiceType.MOTION_SENSOR, client, name, did, sid, ver)
