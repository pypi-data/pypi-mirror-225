...
class DateTime (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = dlllib.DateTime_CreateDateTime(1, 1, 1, 0, 0, 0, 0)
    ...
    def __init__(self, year:int, month:int, day:int, hour:int, minute:int, second:int, millisecond:int):
        dlllib.DateTime_CreateDateTime.argtypes=[ c_int,c_int,c_int,c_int,c_int,c_int,c_int]
        dlllib.DateTime_CreateDateTime.restype = c_void_p
        intPtr = dlllib.DateTime_CreateDateTime(year, month, day, hour, minute, second, millisecond)
        super(DateTime, self).__init__(intPtr)
    ...
    def Add(self ,value:'TimeSpan')->'DateTime':
        ...
        intPtr = dlllib.DateTime_Add(self.Ptr, intPtrvalue)
    ...
    def AddDays(self ,value:float)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddDays(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddHours(self ,value:float)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddHours(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddMilliseconds(self ,value:float)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddMilliseconds(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddMinutes(self ,value:float)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddMinutes(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddMonths(self ,months:int)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddMonths(self.Ptr, months)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddSeconds(self ,value:float)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddSeconds(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddTicks(self ,value:int)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddTicks(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def AddYears(self ,value:int)->'DateTime':
        ...
        intPtr = dlllib.DateTime_AddYears(self.Ptr, value)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def Compare(t1:'DateTime',t2:'DateTime')->int:
        ...
        ret = dlllib.DateTime_Compare( intPtrt1,intPtrt2)
        return ret
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.DateTime_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:'DateTime')->int:
        ...
        ret = dlllib.DateTime_CompareToV(self.Ptr, intPtrvalue)
        return ret
    ...
    def DaysInMonth(year:int,month:int)->int:
        ...
        ret = dlllib.DateTime_DaysInMonth( year,month)
        return ret
    ...
    def Equals(self ,value:SpireObject)->bool:
        ...
        ret = dlllib.DateTime_Equals(self.Ptr, intPtrvalue)
        return ret
    ...
    def Equals(self ,value:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_EqualsV(self.Ptr, intPtrvalue)
        return ret
    ...
    def Equals(t1:'DateTime',t2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_EqualsTT( intPtrt1,intPtrt2)
        return ret
    ...
    def FromBinary(dateData:int)->'DateTime':
        ...
        intPtr = dlllib.DateTime_FromBinary( dateData)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def FromFileTime(fileTime:int)->'DateTime':
        ...
        intPtr = dlllib.DateTime_FromFileTime( fileTime)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def FromFileTimeUtc(fileTime:int)->'DateTime':
        ...
        intPtr = dlllib.DateTime_FromFileTimeUtc( fileTime)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def FromOADate(d:float)->'DateTime':
        ...
        intPtr = dlllib.DateTime_FromOADate( d)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def IsDaylightSavingTime(self)->bool:
        ...
        ret = dlllib.DateTime_IsDaylightSavingTime(self.Ptr)
        return ret
...
#        intPtr = dlllib.DateTime_SpecifyKind( intPtrvalue,enumkind)
#        ret = None if intPtr==None else DateTime(intPtr)
#        return ret
#
    ...
    def ToBinary(self)->int:
        ...
        ret = dlllib.DateTime_ToBinary(self.Ptr)
        return ret
    ...
    def Date(self)->'DateTime':
        ...
        intPtr = dlllib.DateTime_get_Date(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def Day(self)->int:
        ...
        ret = dlllib.DateTime_get_Day(self.Ptr)
        return ret
...
#        ret = dlllib.DateTime_get_DayOfWeek(self.Ptr)
...
#        return objwraped
    ...
    def DayOfYear(self)->int:
        ...
        ret = dlllib.DateTime_get_DayOfYear(self.Ptr)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.DateTime_GetHashCode(self.Ptr)
        return ret
    ...
    def Hour(self)->int:
        ...
        ret = dlllib.DateTime_get_Hour(self.Ptr)
        return ret
...
#        ret = dlllib.DateTime_get_Kind(self.Ptr)
...
#        return objwraped
    ...
    def Millisecond(self)->int:
        ...
        ret = dlllib.DateTime_get_Millisecond(self.Ptr)
        return ret
    ...
    def Minute(self)->int:
        ...
        ret = dlllib.DateTime_get_Minute(self.Ptr)
        return ret
    ...
    def Month(self)->int:
        ...
        ret = dlllib.DateTime_get_Month(self.Ptr)
        return ret
    ...
    def get_Now()->'DateTime':
        ...
        intPtr = dlllib.DateTime_get_Now()
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def get_UtcNow()->'DateTime':
        ...
        intPtr = dlllib.DateTime_get_UtcNow()
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def Second(self)->int:
        ...
        ret = dlllib.DateTime_get_Second(self.Ptr)
        return ret
    ...
    def Ticks(self)->int:
        ...
        ret = dlllib.DateTime_get_Ticks(self.Ptr)
        return ret
    ...
    def TimeOfDay(self)->'TimeSpan':
        ...
        intPtr = dlllib.DateTime_get_TimeOfDay(self.Ptr)
    ...
    def get_Today()->'DateTime':
        ...
        intPtr = dlllib.DateTime_get_Today()
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def Year(self)->int:
        ...
        ret = dlllib.DateTime_get_Year(self.Ptr)
        return ret
    ...
    def IsLeapYear(year:int)->bool:
        ...
        ret = dlllib.DateTime_IsLeapYear( year)
        return ret
    ...
    def Parse(s:str)->'DateTime':
        ...
        if GETSPIREPRODUCT(__file__) == "DOC":
            ...
            intPtr = dlllib.DateTime_Parse(sPtr)
            ret = None if intPtr==None else DateTime(intPtr)
            return ret
        else:
            dlllib.DateTime_Parse.argtypes=[ c_void_p]
            dlllib.DateTime_Parse.restype=c_void_p
            intPtr = dlllib.DateTime_Parse( s)
            ret = None if intPtr==None else DateTime(intPtr)
            return ret
...
#        intPtr = dlllib.DateTime_ParseSP( s,intPtrprovider)
#        ret = None if intPtr==None else DateTime(intPtr)
#        return ret
#
...
#        intPtr = dlllib.DateTime_ParseExact( s,format,intPtrprovider)
#        ret = None if intPtr==None else DateTime(intPtr)
#        return ret
#
    ...
    def Subtract(self ,value:'DateTime')->TimeSpan:
        ...
        intPtr = dlllib.DateTime_Subtract(self.Ptr, intPtrvalue)
        ret = None if intPtr==None else TimeSpan(intPtr)
        return ret
    ...
    def Subtract(self ,value:TimeSpan)->'DateTime':
        ...
        intPtr = dlllib.DateTime_SubtractV(self.Ptr, intPtrvalue)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def ToOADate(self)->float:
        ...
        ret = dlllib.DateTime_ToOADate(self.Ptr)
        return ret
    ...
    def ToFileTime(self)->int:
        ...
        ret = dlllib.DateTime_ToFileTime(self.Ptr)
        return ret
    ...
    def ToFileTimeUtc(self)->int:
        ...
        ret = dlllib.DateTime_ToFileTimeUtc(self.Ptr)
        return ret
    ...
    def ToLocalTime(self)->'DateTime':
        ...
        intPtr = dlllib.DateTime_ToLocalTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def ToString(self)->str:
        ...
        ret = PtrToStr(dlllib.DateTime_ToString(self.Ptr))
        return ret
    ...
    def ToString(self ,format:str)->str:
        ...
        if GETSPIREPRODUCT(__file__) == "DOC":
            ...
            ret = PtrToStr(dlllib.DateTime_ToStringF(self.Ptr, formatPtr))
            return ret
        else:
            dlllib.DateTime_ToStringF.argtypes=[c_void_p ,c_void_p]
            dlllib.DateTime_ToStringF.restype=c_void_p
            ret = PtrToStr(dlllib.DateTime_ToStringF(self.Ptr, format))
            return ret
...
#        ret = dlllib.DateTime_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
...
#        ret = dlllib.DateTime_ToStringFP(self.Ptr, format,intPtrprovider)
#        return ret
#
    ...
    def ToUniversalTime(self)->'DateTime':
        ...
        intPtr = dlllib.DateTime_ToUniversalTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
...
#        ret = dlllib.DateTime_TryParse( s,intPtrresult)
#        return ret
    ...
    def op_Addition(d:'DateTime',t:'TimeSpan')->'DateTime':
        ...
        intPtr = dlllib.DateTime_op_Addition( intPtrd,intPtrt)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def op_Subtraction(d:'DateTime',t:TimeSpan)->'DateTime':
        ...
        intPtr = dlllib.DateTime_op_Subtraction( intPtrd,intPtrt)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def op_Subtraction(d1:'DateTime',d2:'DateTime')->TimeSpan:
        ...
        intPtr = dlllib.DateTime_op_SubtractionDD( intPtrd1,intPtrd2)
        ret = None if intPtr==None else TimeSpan(intPtr)
        return ret
    ...
    def op_Equality(d1:'DateTime',d2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_op_Equality( intPtrd1,intPtrd2)
        return ret
    ...
    def op_Inequality(d1:'DateTime',d2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_op_Inequality( intPtrd1,intPtrd2)
        return ret
    ...
    def op_LessThan(t1:'DateTime',t2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_op_LessThan( intPtrt1,intPtrt2)
        return ret
    ...
    def op_LessThanOrEqual(t1:'DateTime',t2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_op_LessThanOrEqual( intPtrt1,intPtrt2)
        return ret
    ...
    def op_GreaterThan(t1:'DateTime',t2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_op_GreaterThan( intPtrt1,intPtrt2)
        return ret
    ...
    def op_GreaterThanOrEqual(t1:'DateTime',t2:'DateTime')->bool:
        ...
        ret = dlllib.DateTime_op_GreaterThanOrEqual( intPtrt1,intPtrt2)
        return ret
    ...
    def GetDateTimeFormats(self)->List[str]:
        ...
        intPtrArray = dlllib.DateTime_GetDateTimeFormats(self.Ptr)
...
#        intPtrArray = dlllib.DateTime_GetDateTimeFormatsP(self.Ptr, intPtrprovider)
#        ret = GetVectorFromArray(intPtrArray, c_wchar_p)
#        return ret
    ...
    def GetDateTimeFormats(self ,format:int)->List[str]:
        ...
        intPtrArray = dlllib.DateTime_GetDateTimeFormatsF(self.Ptr, format)
        ret = GetVectorFromArray(intPtrArray, c_wchar_p)
        return ret
...
#        intPtrArray = dlllib.DateTime_GetDateTimeFormatsFP(self.Ptr, format,intPtrprovider)
#        ret = GetVectorFromArray(intPtrArray, c_wchar_p)
#        return ret
...
#        ret = dlllib.DateTime_GetTypeCode(self.Ptr)
...
#        intPtr = dlllib.DateTime_ParseSPS( s,intPtrprovider,enumstyles)
#        ret = None if intPtr==None else DateTime(intPtr)
#        return ret
#
...
#        intPtr = dlllib.DateTime_ParseExactSFPS( s,format,intPtrprovider,enumstyle)
#        ret = None if intPtr==None else DateTime(intPtr)
#        return ret
#
...
#        intPtr = dlllib.DateTime_ParseExactSFPS1( s,arrayformats,intPtrprovider,enumstyle)
#        ret = None if intPtr==None else DateTime(intPtr)
#        return ret
#
    ...
    def ToLongDateString(self)->str:
        ...
        ret = PtrToStr(dlllib.DateTime_ToLongDateString(self.Ptr))
        return ret
    ...
    def ToLongTimeString(self)->str:
        ...
        ret = PtrToStr(dlllib.DateTime_ToLongTimeString(self.Ptr))
        return ret
    ...
    def ToShortTimeString(self)->str:
        ...
        ret = PtrToStr(dlllib.DateTime_ToShortTimeString(self.Ptr))
        return ret
...
#        ret = dlllib.DateTime_TryParseExact( s,format,intPtrprovider,enumstyle,intPtrresult)
#        return ret
...
#        ret = dlllib.DateTime_TryParseExactSFPSR( s,arrayformats,intPtrprovider,enumstyle,intPtrresult)
#        return ret
    ...
    def ToShortDateString(self)->str:
        ...
        ret = PtrToStr(dlllib.DateTime_ToShortDateString(self.Ptr))
        return ret
...
#        ret = dlllib.DateTime_TryParseSPSR( s,intPtrprovider,enumstyles,intPtrresult)
#        return ret
    ...
    def MinValue()->'DateTime':
        ...
        intPtr = dlllib.DateTime_MinValue()
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def MaxValue()->'DateTime':
        ...
        intPtr = dlllib.DateTime_MaxValue()
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
