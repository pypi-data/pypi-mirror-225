...
#        intPtrArray = dlllib.Encoding_Convert( intPtrsrcEncoding,intPtrdstEncoding,arraybytes)
...
#        dlllib.Encoding_RegisterProvider( intPtrprovider)
    ...
    def GetEncoding(codepage:int)->'Encoding':
        ...
        intPtr = dlllib.Encoding_GetEncoding( codepage)
...
#        intPtr = dlllib.Encoding_GetEncodingCED( codepage,intPtrencoderFallback,intPtrdecoderFallback)
#        ret = None if intPtr==None else Encoding(intPtr)
#        return ret
#
    ...
    def GetEncoding(name:str)->'Encoding':
        ...
        if GETSPIREPRODUCT(__file__) == "DOC":
            ...
            intPtr = dlllib.Encoding_GetEncodingN(namePtr)
            ret = None if intPtr==None else Encoding(intPtr)
            return ret
        else:
            dlllib.Encoding_GetEncodingN.argtypes=[ c_void_p]
            dlllib.Encoding_GetEncodingN.restype=c_void_p
            intPtr = dlllib.Encoding_GetEncodingN( name)
            ret = None if intPtr==None else Encoding(intPtr)
            return ret
...
#        intPtr = dlllib.Encoding_GetEncodingNED( name,intPtrencoderFallback,intPtrdecoderFallback)
#        ret = None if intPtr==None else Encoding(intPtr)
#        return ret
#
...
#        intPtrArray = dlllib.Encoding_GetEncodings()
...
#        intPtrArray = dlllib.Encoding_GetPreamble(self.Ptr)
...
#        return ret
    ...
    def BodyName(self)->str:
        ...
        ret = PtrToStr(dlllib.Encoding_get_BodyName(self.Ptr))
        return ret
    ...
    def HeaderName(self)->str:
        ...
        ret = PtrToStr(dlllib.Encoding_get_HeaderName(self.Ptr))
        return ret
    ...
    def WebName(self)->str:
        ...
        ret = PtrToStr(dlllib.Encoding_get_WebName(self.Ptr))
        return ret
    ...
    def WindowsCodePage(self)->int:
        ...
        ret = dlllib.Encoding_get_WindowsCodePage(self.Ptr)
        return ret
    ...
    def IsBrowserDisplay(self)->bool:
        ...
        ret = dlllib.Encoding_get_IsBrowserDisplay(self.Ptr)
        return ret
    ...
    def IsBrowserSave(self)->bool:
        ...
        ret = dlllib.Encoding_get_IsBrowserSave(self.Ptr)
        return ret
    ...
    def IsMailNewsDisplay(self)->bool:
        ...
        ret = dlllib.Encoding_get_IsMailNewsDisplay(self.Ptr)
        return ret
    ...
    def IsMailNewsSave(self)->bool:
        ...
        ret = dlllib.Encoding_get_IsMailNewsSave(self.Ptr)
        return ret
    ...
    def IsSingleByte(self)->bool:
        ...
        ret = dlllib.Encoding_get_IsSingleByte(self.Ptr)
        return ret
...
#        intPtr = dlllib.Encoding_get_EncoderFallback(self.Ptr)
...
#        dlllib.Encoding_set_EncoderFallback(self.Ptr, value.Ptr)
...
#        intPtr = dlllib.Encoding_get_DecoderFallback(self.Ptr)
...
#        dlllib.Encoding_set_DecoderFallback(self.Ptr, value.Ptr)
    ...
    def Clone(self)->'SpireObject':
        ...
        intPtr = dlllib.Encoding_Clone(self.Ptr)
    ...
    def IsReadOnly(self)->bool:
        ...
        ret = dlllib.Encoding_get_IsReadOnly(self.Ptr)
        return ret
    ...
    def get_ASCII()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_ASCII()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
...
#        ret = dlllib.Encoding_GetByteCount(self.Ptr, arraychars)
#        return ret
    ...
    def GetByteCount(self ,s:str)->int:
        ...
        if GETSPIREPRODUCT(__file__) == "DOC":
            ...
            ret = dlllib.Encoding_GetByteCountS(self.Ptr, sPtr)
            return ret
        else:
            dlllib.Encoding_GetByteCountS.argtypes=[c_void_p ,c_void_p]
            dlllib.Encoding_GetByteCountS.restype=c_int
            ret = dlllib.Encoding_GetByteCountS(self.Ptr, s)
            return ret
...
#        ret = dlllib.Encoding_GetByteCountCC(self.Ptr, intPtrchars,count)
#        return ret
...
#        intPtrArray = dlllib.Encoding_GetBytes(self.Ptr, arraychars)
#        ret = GetObjVectorFromArray(intPtrArray, Byte)
#        return ret
...
#        intPtrArray = dlllib.Encoding_GetBytesCIC(self.Ptr, arraychars,index,count)
#        ret = GetObjVectorFromArray(intPtrArray, Byte)
#        return ret
...
#        intPtrArray = dlllib.Encoding_GetBytesS(self.Ptr, s)
#        ret = GetObjVectorFromArray(intPtrArray, Byte)
#        return ret
...
#        ret = dlllib.Encoding_GetBytesSCCBB(self.Ptr, s,charIndex,charCount,arraybytes,byteIndex)
#        return ret
...
#        ret = dlllib.Encoding_GetCharCount(self.Ptr, arraybytes)
#        return ret
...
#        ret = dlllib.Encoding_GetCharCountBC(self.Ptr, intPtrbytes,count)
#        return ret
...
#        intPtrArray = dlllib.Encoding_GetChars(self.Ptr, arraybytes)
...
#        intPtrArray = dlllib.Encoding_GetCharsBIC(self.Ptr, arraybytes,index,count)
#        ret = GetObjVectorFromArray(intPtrArray, Char)
#        return ret
...
#        ret = dlllib.Encoding_GetString(self.Ptr, intPtrbytes,byteCount)
#        return ret
#
    ...
    def CodePage(self)->int:
        ...
        ret = dlllib.Encoding_get_CodePage(self.Ptr)
        return ret
    ...
    def IsAlwaysNormalized(self)->bool:
        ...
        ret = dlllib.Encoding_IsAlwaysNormalized(self.Ptr)
        return ret
...
#        ret = dlllib.Encoding_IsAlwaysNormalizedF(self.Ptr, enumform)
#        return ret
...
#        intPtr = dlllib.Encoding_GetDecoder(self.Ptr)
...
#
    ...
    def get_Default()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_Default()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
...
#        intPtr = dlllib.Encoding_GetEncoder(self.Ptr)
...
#        ret = dlllib.Encoding_GetStringB(self.Ptr, arraybytes)
#        return ret
#
...
#        ret = dlllib.Encoding_GetStringBIC(self.Ptr, arraybytes,index,count)
#        return ret
#
    ...
    def get_Unicode()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_Unicode()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
    ...
    def get_BigEndianUnicode()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_BigEndianUnicode()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
    ...
    def get_UTF7()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_UTF7()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
    ...
    def get_UTF8()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_UTF8()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
    ...
    def get_UTF32()->'Encoding':
        ...
        intPtr = dlllib.Encoding_get_UTF32()
        ret = None if intPtr==None else Encoding(intPtr)
        return ret
    ...
    def Equals(self ,value:'SpireObject')->bool:
        ...
        ret = dlllib.Encoding_Equals(self.Ptr, intPtrvalue)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.Encoding_GetHashCode(self.Ptr)
        return ret
...
#        intPtrArray = dlllib.Encoding_ConvertSDBIC( intPtrsrcEncoding,intPtrdstEncoding,arraybytes,index,count)
#        ret = GetObjVectorFromArray(intPtrArray, Byte)
#        return ret
    ...
    def EncodingName(self)->str:
        ...
        ret = PtrToStr(dlllib.Encoding_get_EncodingName(self.Ptr))
        return ret
...
#        ret = dlllib.Encoding_GetByteCountCIC(self.Ptr, arraychars,index,count)
#        return ret
...
#        ret = dlllib.Encoding_GetBytesCCCBB(self.Ptr, arraychars,charIndex,charCount,arraybytes,byteIndex)
#        return ret
...
#        ret = dlllib.Encoding_GetBytesCCBB(self.Ptr, intPtrchars,charCount,intPtrbytes,byteCount)
#        return ret
...
#        ret = dlllib.Encoding_GetCharCountBIC(self.Ptr, arraybytes,index,count)
#        return ret
...
#        ret = dlllib.Encoding_GetCharsBBBCC(self.Ptr, arraybytes,byteIndex,byteCount,arraychars,charIndex)
#        return ret
...
#        ret = dlllib.Encoding_GetCharsBBCC(self.Ptr, intPtrbytes,byteCount,intPtrchars,charCount)
#        return ret
    ...
    def GetMaxByteCount(self ,charCount:int)->int:
        ...
        ret = dlllib.Encoding_GetMaxByteCount(self.Ptr, charCount)
        return ret
    ...
    def GetMaxCharCount(self ,byteCount:int)->int:
        ...
        ret = dlllib.Encoding_GetMaxCharCount(self.Ptr, byteCount)
        return ret
