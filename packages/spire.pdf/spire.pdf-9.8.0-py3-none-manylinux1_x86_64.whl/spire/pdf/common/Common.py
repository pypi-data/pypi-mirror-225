...
def GetIntValue(ptr:c_void_p, valueName:str, paraValues:str)->int:
    if GETSPIREPRODUCT(__file__) == "DOC":
        ...
        ret = dlllib.Spire_GetIntValue(ptr, valueNamePtr, paraValuesPtr)
        return ret
    else:
...
def GetObjIntPtr(ptr:c_void_p, valueName:str, paraValues:str)->c_void_p:
    if GETSPIREPRODUCT(__file__) == "DOC":
        ...
        ret = dlllib.Spire_GetIntPtr(ptr,valueNamePtr, paraValuesPtr)
        return ret
    else:
        dlllib.Spire_GetIntValue.argtypes=[c_void_p, c_wchar_p, c_wchar_p]
        dlllib.Spire_GetIntValue.restype=c_void_p
...
def ReleasePtr(intPtr):
    dlllib.MemoryManagement_ReleasePtr.argtypes=[c_void_p]
    dlllib.MemoryManagement_ReleasePtr(intPtr)