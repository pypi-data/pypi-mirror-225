...
from vehicle.yolo.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, clean_url, colorstr, emojis,
                                    yaml_load)
from vehicle.yolo.utils.checks import check_file, check_font, is_ascii
from vehicle.yolo.utils.downloads import download, safe_download, unzip_file
from vehicle.yolo.utils.ops import segments2boxes
from . import fkey
        ...
        if im.format.lower() in ('jpg', 'jpeg'):
            ...
            with open(im_file, 'rb') as f:
                ...
                if f.read() != b'\xff\xd9':  # corrupt JPEG
                    ...
                    # ImageOps.exif_transpose(im).save(im_file, 'JPEG', subsampling=0, quality=100)
...
class HUBDatasetStats():
    ...
    Usage
        from vehicle.yolo.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        ...
        from vehicle.yolo.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Usage:
        from pathlib import Path
        from vehicle.yolo.data.utils import compress_one_image
...
def delete_dsstore(path):
    ...
    Usage:
        from vehicle.yolo.data.utils import delete_dsstore
...
def zip_directory(dir, use_zipfile_library=True):
    ...
    Usage:
        from vehicle.yolo.data.utils import zip_directory
