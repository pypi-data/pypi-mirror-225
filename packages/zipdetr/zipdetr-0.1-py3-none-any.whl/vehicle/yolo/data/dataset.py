...
class YOLODataset(BaseDataset):
    ...
    def __init__(self, *args, data=None, use_segments=False, use_keypoints=False, **kwargs):
        ...
        self.small_image_idx = [image_id for image_id, image_path in enumerate(self.im_files)
                                if int(os.path.basename(image_path).split("_")[0])]
        self.large_image_idx = [image_id for image_id, image_path in enumerate(self.im_files)
                                if not int(os.path.basename(image_path).split("_")[0])]
