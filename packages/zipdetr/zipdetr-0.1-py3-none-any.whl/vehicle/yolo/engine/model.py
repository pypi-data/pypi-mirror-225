...
from vehicle import yolo  # noqa
from vehicle.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel,
                                  attempt_load_one_weight, guess_model_task, nn, yaml_model_load)
from vehicle.yolo.cfg import get_cfg
from vehicle.yolo.engine.exporter import Exporter
from vehicle.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, NUM_THREADS, RANK, ROOT,
                                    callbacks, is_git_dir, yaml_load)
from vehicle.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from vehicle.yolo.utils.downloads import GITHUB_ASSET_STEMS
from vehicle.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        if not hasattr(self.predictor, 'trackers'):
            from vehicle.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from vehicle.yolo.utils.benchmarks import benchmark
    ...
    def tune(self,
        ...
        try:
            from vehicle.yolo.utils.tuner import (ASHAScheduler, RunConfig, WandbLoggerCallback, default_space,
