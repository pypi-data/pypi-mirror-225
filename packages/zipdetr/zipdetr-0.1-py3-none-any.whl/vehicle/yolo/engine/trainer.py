...
from vehicle.yolo.data.utils import check_cls_dataset, check_det_dataset
from vehicle.yolo.utils import (DEFAULT_CFG, LOGGER, RANK, SETTINGS, TQDM_BAR_FORMAT, __version__, callbacks,
                                    clean_url, colorstr, emojis, yaml_save)
from vehicle.yolo.utils.autobatch import check_train_batch_size
from vehicle.yolo.utils.checks import check_amp, check_file, check_imgsz, print_args
from vehicle.yolo.utils.dist import ddp_cleanup, generate_ddp_command
from vehicle.yolo.utils.files import get_latest_run, increment_path
from vehicle.yolo.utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, init_seeds, one_cycle,
...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.plot_idx = [i for i in range(65)]
