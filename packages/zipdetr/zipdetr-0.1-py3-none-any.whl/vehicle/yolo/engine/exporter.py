...
from vehicle.nn.modules import C2f, Detect, Segment
from vehicle.nn.tasks import DetectionModel, SegmentationModel
from vehicle.yolo.cfg import get_cfg
from vehicle.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                                    get_default_args, yaml_save)
from vehicle.yolo.utils.checks import check_imgsz, check_requirements, check_version
from vehicle.yolo.utils.files import file_size
from vehicle.yolo.utils.ops import Profile
from vehicle.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
