...
from vehicle.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from vehicle.yolo.utils.checks import check_requirements, check_suffix, check_yaml
from vehicle.yolo.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8PoseLoss, v8SegmentationLoss
from vehicle.yolo.utils.plotting import feature_visualization
from vehicle.yolo.utils.torch_utils import (fuse_conv_and_bn, fuse_deconv_and_bn, initialize_weights,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        """Compute the classification loss between predictions and true labels."""
        from vehicle.vit.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight):
    ...
    """
    from vehicle.yolo.utils.downloads import attempt_download_asset
