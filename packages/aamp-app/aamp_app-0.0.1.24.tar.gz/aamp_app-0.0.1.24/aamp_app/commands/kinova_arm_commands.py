...
from aamp_app.devices.kinova_arm import KinovaArm
...
class KinovaArmMoveArmAngular(KinovaArmParentCommand):
    ...
    def execute(self) -> None:
        self._result = CommandResult(
            *self._receiver.move_arm_angular(self._params["pose_name"])
        )
...
class KinovaArmExecuteAction(KinovaArmParentCommand):
    ...
    def execute(self) -> None:
        self._result = CommandResult(
            *self._receiver.execute_action(self._params["action_name"])
        )
...
class KinovaArmOpenGripper(KinovaArmParentCommand):
    ...
    def execute(self) -> None:
        self._result = CommandResult(
            *self._receiver.open_gripper(self._params["grip_speed"])
        )
...
class KinovaArmCloseGripper(KinovaArmParentCommand):
    ...
    def execute(self) -> None:
        self._result = CommandResult(
            *self._receiver.close_gripper(self._params["grip_speed"])
        )
