...
class TestGoogleSettings(CriscoTestCase):
	def setUp(self):
		settings = criscostack.get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		criscostack.db.set_single_value("Google Settings", "enable", 1)
		criscostack.db.set_single_value("Google Settings", "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		criscostack.db.set_single_value("Google Settings", "enable", 0)
		criscostack.db.set_single_value("Google Settings", "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()
