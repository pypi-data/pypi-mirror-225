...
from criscostack.utils import cint, cstr, get_system_timezone
...
class TokenCache(Document):
	...
	def get_auth_header(self):
		...
		raise criscostack.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			criscostack.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
	...
	def get_expires_in(self):
		...
		modified = criscostack.utils.get_datetime(self.modified)
