	...
	<div>
		<div class="row form-section visible-section shaded-section">
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div class="criscostack-control" :data-fieldtype="column.type" v-for="(column, index) in columns" :key="index" :class="column.class">
		...
		<div class="row form-section visible-section">
			...
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div class="form-group criscostack-control input-max-width" data-fieldtype="Check">
							<div class="checkbox">
								<label>
						...
						<div class="criscostack-control" data-fieldtype="Table">
							<div>
								<div class="form-grid">
																		...
																		<div class="section-body">
																			<div class="form-column col-sm-12">
																				<form>
																					...
																					<div class="criscostack-control input-max-width">
																						<div class="form-group">
																					...
																					<div class="criscostack-control" v-if="call.explain_result[0]">
																						<div class="form-group">
...
onMounted(async () => {
	...
	if (req && (req.headers || req.form_dict || req.calls)) {
		...
		let r = await criscostack.call({
			method: "criscostack.recorder.get",
			args: {
				uuid: req?.uuid || id,
			}
		});
