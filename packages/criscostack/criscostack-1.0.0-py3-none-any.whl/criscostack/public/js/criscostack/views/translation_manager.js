criscostack.views.TranslationManager = class TranslationManager {
	constructor(opts) {
	...
	get_translations_data() {
		return criscostack.db.get_list("Translation", {
	...
	update_translations({ source, translation_data = [] }) {
		...
		return criscostack
			.call({
				method: "criscostack.translate.update_translations_for_source",
