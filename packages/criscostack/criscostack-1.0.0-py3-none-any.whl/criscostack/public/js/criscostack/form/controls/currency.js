criscostack.ui.form.ControlCurrency = class ControlCurrency extends criscostack.ui.form.ControlFloat {
	...
	get_precision() {
		...
		if (typeof this.df.precision != "number" && !this.df.precision) {
			if (criscostack.boot.sysdefaults.currency_precision) {
				this.df.precision = criscostack.boot.sysdefaults.currency_precision;
			} else {
