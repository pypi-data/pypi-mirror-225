criscostack.ui.form.ControlButton = class ControlButton extends criscostack.ui.form.ControlData {
	can_write() {
	...
	set_label(label) {
		...
		label = (this.df.icon ? criscostack.utils.icon(this.df.icon) : "") + __(this.df.label);
