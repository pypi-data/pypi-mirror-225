criscostack.ui.form.ControlCode = class ControlCode extends criscostack.ui.form.ControlText {
	make_input() {
	...
	make_ace_editor() {
		...
		let change_content = criscostack.utils.debounce(() => {
	...
	load_lib() {
		...
		if (criscostack.boot.developer_mode) {
			this.root_lib_path = "/assets/criscostack/node_modules/ace-builds/src-noconflict/";
		} else {
			this.root_lib_path = "/assets/criscostack/node_modules/ace-builds/src-min-noconflict/";
		}

		this.library_loaded = new Promise((resolve) => {
			criscostack.require(this.root_lib_path + "ace.js", () => {
