criscostack.ui.form.ControlSignature = class ControlSignature extends criscostack.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		criscostack.require("/assets/criscostack/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${criscostack.utils.icon("restriction", "md")}</i>
