criscostack.ui.form.ControlFloat = class ControlFloat extends criscostack.ui.form.ControlInt {
	make_input() {
		super.make_input();
	...
	get_number_format() {
		var currency = criscostack.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(criscostack.boot.sysdefaults.float_precision, null);
	}
};

criscostack.ui.form.ControlPercent = criscostack.ui.form.ControlFloat;
