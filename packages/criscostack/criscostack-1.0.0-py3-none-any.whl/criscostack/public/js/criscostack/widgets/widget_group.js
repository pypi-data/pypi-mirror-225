...
criscostack.provide("criscostack.widget");

criscostack.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
criscostack.widget.make_widget = (opts) => {
	const widget_class = criscostack.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = criscostack.widget.make_widget({
			...widget,
...
criscostack.widget.WidgetGroup = WidgetGroup;
criscostack.widget.SingleWidgetGroup = SingleWidgetGroup;
