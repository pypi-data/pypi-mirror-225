criscostack.ui.form.on("Report", {
	refresh: function (frm) {
		if (frm.doc.is_standard === "Yes" && !criscostack.boot.developer_mode) {
			...
			frm.add_custom_button(
				...
				function () {
					switch (doc.report_type) {
						case "Report Builder":
							criscostack.set_route("List", doc.ref_doctype, "Report", doc.name);
							break;
						case "Query Report":
							criscostack.set_route("query-report", doc.name);
							break;
						case "Script Report":
							criscostack.set_route("query-report", doc.name);
							break;
