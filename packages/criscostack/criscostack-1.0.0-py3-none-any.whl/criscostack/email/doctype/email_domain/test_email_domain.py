...
test_records = criscostack.get_test_records("Email Domain")


class TestDomain(CriscoTestCase):
	def setUp(self):
		make_test_objects("Email Domain", reset=True)

	def tearDown(self):
		criscostack.delete_doc("Email Account", "Test")
		criscostack.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = criscostack.get_doc("Email Domain", "test.com")
		mail_account = criscostack.get_doc("Email Account", "Test")
