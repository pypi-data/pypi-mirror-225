...
criscostack.ui.form.on("Notification Log", {
	...
	open_reference_document: function (frm) {
		...
		criscostack.set_route("Form", dt, dn);
	},
	...
	set_attachment: function (frm) {
		...
		$wrapper.find(".attached-file-link").click(() => {
			const w = window.open(
				criscostack.urllib.get_full_url(`/api/method/criscostack.utils.print_format.download_pdf?
