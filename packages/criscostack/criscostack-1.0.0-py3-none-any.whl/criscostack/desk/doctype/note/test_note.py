# Copyright (c) 2015, Crisco Technologies Pvt. Ltd. and Contributors and Contributors
# License: MIT. See LICENSE

import criscostack
from criscostack.tests.utils import CriscoTestCase

test_records = criscostack.get_test_records("Note")


class TestNote(CriscoTestCase):
	def insert_note(self):
		criscostack.db.delete("Version")
	...
	def test_version(self):
		...
		version = criscostack.get_doc("Version", dict(docname=note.name))
