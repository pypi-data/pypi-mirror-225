...
criscostack.ui.form.on("Global Search Settings", {
	refresh: function (frm) {
		criscostack.realtime.on("global_search_settings", (data) => {
			if (data.progress) {
		...
		frm.add_custom_button(__("Reset"), function () {
			criscostack.call({
				method: "criscostack.desk.doctype.global_search_settings.global_search_settings.reset_global_search_settings_doctypes",
				callback: function () {
