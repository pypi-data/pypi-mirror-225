...
criscostack.ui.form.on("Onboarding Step", {
	setup: function (frm) {
	...
	refresh: function (frm) {
		criscostack.boot.developer_mode &&
			frm.set_intro(
				__(
...
function setup_fields(frm) {
	if (frm.doc.reference_document && frm.doc.action == "Update Settings") {
		criscostack.model.with_doctype(frm.doc.reference_document, () => {
			let fields = criscostack
