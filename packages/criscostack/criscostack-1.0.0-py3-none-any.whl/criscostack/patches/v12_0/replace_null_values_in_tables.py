...
def execute():
	...
	for table in criscostack.db.get_tables():
		if update_column_table_map.get(table) and criscostack.db.exists("DocType", re.sub("^tab", "", table)):
			criscostack.db.sql(
