...
def execute():
	...
	if criscostack.db.count("Communication", filters=dict(communication_type="Comment")) > 20000:
		criscostack.db.auto_commit_on_many_writes = True

	for comment in criscostack.get_all(
	...
	# clean up
	criscostack.db.delete("Communication", {"communication_type": "Comment"})
