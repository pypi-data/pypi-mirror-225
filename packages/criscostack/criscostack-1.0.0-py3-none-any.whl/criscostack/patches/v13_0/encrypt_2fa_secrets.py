...
from criscostack.twofactor import PARENT_FOR_DEFAULTS
from criscostack.utils.password import encrypt
...
def execute():
	...
	secrets = {
		key: value
		for key, value in criscostack.defaults.get_defaults_for(parent=OLD_PARENT).items()
	...
	defvalue_cases = criscostack.qb.terms.Case()
