import criscostack
from criscostack.desk.doctype.notification_log.notification_log import make_notification_logs
...
def execute():
	...
	criscostack.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = criscostack.qb.DocType("User").as_("user")
	user_role_doctype = criscostack.qb.DocType("Has Role").as_("user_role")
	return (
