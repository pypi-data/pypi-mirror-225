...
import criscostack
from criscostack.model.document import Document, bulk_insert
...
def get_countries_and_currencies():
	from criscostack.geo.country_info import get_all as get_geo_data
	...
	for name, country in data.items():
		country = criscostack._dict(country)
		countries.append(
			criscostack.get_doc(
				doctype="Country",
				name=name,
