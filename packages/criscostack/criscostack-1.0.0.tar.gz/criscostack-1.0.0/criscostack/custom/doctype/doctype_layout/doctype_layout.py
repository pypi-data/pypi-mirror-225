...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from criscostack.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = criscostack.get_meta(self.document_type).fields
