...
from criscostack.utils import add_to_date, get_link_to_form, today
from criscostack.utils.data import is_html

# test_records = criscostack.get_test_records('Auto Email Report')


class TestAutoEmailReport(CriscoTestCase):
	def test_auto_email(self):
		criscostack.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not criscostack.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = criscostack.get_doc(
			dict(
		...
		auto_email_report = criscostack.get_doc("Auto Email Report", "Permitted Documents For User")
