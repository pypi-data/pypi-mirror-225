...
import criscostack
from criscostack import safe_decode
from criscostack.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from criscostack.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from criscostack.email.receive import Email
from criscostack.tests.utils import CriscoTestCase


class TestEmailBody(CriscoTestCase):
	def setUp(self):
		email_html = """
<div>
	<h3>Hey John Doe!</h3>
	<p>This is embedded image you asked for</p>
	<img embed="assets/criscostack/images/criscostack-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/criscostack/images/criscostack-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = criscostack.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="criscostack-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/criscostack/images/criscostack-favicon.svg" alt="test" />
...
From: test1_@criscoerp.com
Reply-To: test2_@criscoerp.com
"""
			+ text_content_bytes
		)
