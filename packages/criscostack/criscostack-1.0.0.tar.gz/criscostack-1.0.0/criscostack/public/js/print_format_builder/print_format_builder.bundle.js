...
class PrintFormatBuilder {
	constructor({ wrapper, page, print_format }) {
		...
		this.page.add_menu_item(__("Edit Print Format"), () => {
			criscostack.set_route("Form", "Print Format", this.print_format);
		});
		this.page.add_menu_item(__("Change Print Format"), () => {
			criscostack.set_route("print-format-builder-beta");
		});
...
criscostack.ui.PrintFormatBuilder = PrintFormatBuilder;
