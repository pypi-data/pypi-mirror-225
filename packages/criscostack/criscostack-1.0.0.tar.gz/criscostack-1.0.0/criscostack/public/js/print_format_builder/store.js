...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			criscostack.model.clear_doc("Print Format", print_format_name);
			criscostack.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = criscostack.get_doc("Print Format", print_format_name);
				criscostack.model.with_doctype(_print_format.doc_type, () => {
					meta.value = criscostack.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return criscostack.db.get_doc("Letter Head", _letterhead).then((doc) => {
