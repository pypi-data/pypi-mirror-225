...
criscostack.provide("criscostack.utils.logtypes");

criscostack.utils.logtypes.show_log_retention_message = (doctype) => {
	if (!criscostack.model.can_write("Log Settings")) {
		return;
	}
