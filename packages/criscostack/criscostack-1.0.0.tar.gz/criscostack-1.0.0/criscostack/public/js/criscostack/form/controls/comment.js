...
criscostack.ui.form.ControlComment = class ControlComment extends criscostack.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				<div class="comment-input-container">
					<div class="criscostack-control"></div>
		...
		// wrapper should point to criscostack-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".criscostack-control")
