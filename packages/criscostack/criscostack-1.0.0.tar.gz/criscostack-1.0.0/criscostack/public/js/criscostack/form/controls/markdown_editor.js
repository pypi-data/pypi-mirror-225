criscostack.ui.form.ControlMarkdownEditor = class ControlMarkdownEditor extends (
	criscostack.ui.form.ControlCode
) {
	...
	update_preview() {
		...
		this.markdown_preview.html(criscostack.markdown(value));
	}
