...
from criscostack.utils import cint, convert_utc_to_system_timezone
from criscostack.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> criscostack._dict:
	...
	if current_job and not current_job.startswith(criscostack.local.site):
		current_job = None
