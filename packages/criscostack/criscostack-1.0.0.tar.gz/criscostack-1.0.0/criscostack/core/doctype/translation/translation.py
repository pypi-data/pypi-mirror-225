...
from criscostack.translate import MERGED_TRANSLATION_KEY, USER_TRANSLATION_KEY, get_translator_url
...
def clear_user_translation_cache(lang):
	criscostack.cache.hdel(USER_TRANSLATION_KEY, lang)
	criscostack.cache.hdel(MERGED_TRANSLATION_KEY, lang)
