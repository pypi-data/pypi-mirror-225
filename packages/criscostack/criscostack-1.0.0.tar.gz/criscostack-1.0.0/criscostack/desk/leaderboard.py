...
def get_leaderboards():
	leaderboards = {
		"User": {
			"fields": ["points"],
			"method": "criscostack.desk.leaderboard.get_energy_point_leaderboard",
			"company_disabled": 1,
			"icon": "users",
		}
	}
...
def get_energy_point_leaderboard(date_range, company=None, field=None, limit=None):
	...
	if date_range:
		date_range = criscostack.parse_json(date_range)
		filters.append(["creation", "between", [date_range[0], date_range[1]]])
	energy_point_users = criscostack.get_all(
		"Energy Point Log",
