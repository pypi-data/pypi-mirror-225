...
class TestWorkspace(CriscoTestCase):
	def setUp(self):
		create_module("Test Module")

	def tearDown(self):
		criscostack.db.delete("Workspace", {"module": "Test Module"})
		criscostack.db.delete("DocType", {"module": "Test Module"})
		criscostack.delete_doc("Module Def", "Test Module")
	...
	# 	if criscostack.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = criscostack.get_doc(
		{"doctype": "Module Def", "module_name": module_name, "app_name": "criscostack"}
	)
...
def create_workspace(**args):
	workspace = criscostack.new_doc("Workspace")
