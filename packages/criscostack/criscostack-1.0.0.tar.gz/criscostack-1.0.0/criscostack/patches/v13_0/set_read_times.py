...
import criscostack
from criscostack.utils import markdown, strip_html_tags


def execute():
	criscostack.reload_doc("website", "doctype", "blog_post")

	for blog in criscostack.get_all("Blog Post"):
		blog = criscostack.get_doc("Blog Post", blog.name)
