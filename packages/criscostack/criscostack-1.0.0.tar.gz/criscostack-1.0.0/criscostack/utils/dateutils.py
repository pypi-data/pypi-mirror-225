...
from criscostack.utils import add_to_date, get_datetime, getdate
...
def get_user_date_format():
	if getattr(criscostack.local, "user_date_format", None) is None:
		criscostack.local.user_date_format = criscostack.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return criscostack.local.user_date_format
...
def datetime_in_user_format(date_time):
	...
	from criscostack.utils import formatdate
