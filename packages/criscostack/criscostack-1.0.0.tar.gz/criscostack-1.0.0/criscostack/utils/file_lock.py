...
Use `criscostack.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import criscostack
from criscostack.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in criscostack.local.locked_documents:
		doc.unlock()
