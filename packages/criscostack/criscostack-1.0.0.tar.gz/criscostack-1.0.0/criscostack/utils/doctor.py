...
from criscostack.utils.background_jobs import get_queue, get_queue_list, get_redis_conn
from criscostack.utils.scheduler import is_scheduler_disabled, is_scheduler_inactive
...
def doctor(site=None):
	...
	if site:
		...
		sites = criscostack.utils.get_sites()
