...
import criscostack
from criscostack.modules.patch_handler import get_all_patches, parse_as_configfile
from criscostack.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = criscostack._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.default_user_input = criscostack._dict(
			{
				"title": "Test App",
		...
		cls.bench_path = criscostack.utils.get_bench_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(criscostack.get_app_path("criscostack", "patches.txt")))
		...
		expected_patch = "criscostack.core.doctype.user.patches.delete_all_users"
