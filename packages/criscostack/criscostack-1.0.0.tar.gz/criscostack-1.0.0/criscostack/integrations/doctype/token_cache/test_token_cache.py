...
class TestTokenCache(CriscoTestCase):
	def setUp(self):
		self.token_cache = criscostack.get_last_doc("Token Cache")
		self.token_cache.update({"connected_app": criscostack.get_last_doc("Connected App").name})
