...
class SemanticSegmentationObject():
    def __init__(self):
        self.semantic_segmentation = list()
    
    def add(self, semantic_segmentation:SemanticSegmentation):
        self.semantic_segmentation.append(semantic_segmentation.__dict__)
