...
def test_cuda_awkward_ListArrayU32_compact_offsets_64_1():
...
def test_cuda_awkward_ListArrayU32_compact_offsets_64_2():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
...
def test_cuda_awkward_ListArrayU32_compact_offsets_64_3():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
...
def test_cuda_awkward_ListArrayU32_compact_offsets_64_4():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
...
def test_cuda_awkward_ListArrayU32_compact_offsets_64_5():
    tooffsets = cupy.array([123, 123, 123, 123], dtype=cupy.int64)
