...
def test_cuda_awkward_IndexedArray32_getitem_nextcarry_outindex_64_1():
...
def test_cuda_awkward_IndexedArray32_getitem_nextcarry_outindex_64_2():
...
def test_cuda_awkward_IndexedArray32_getitem_nextcarry_outindex_64_3():
    tocarry = cupy.array([123, 123, 123], dtype=cupy.int64)
    toindex = cupy.array([123, 123, 123], dtype=cupy.int32)
