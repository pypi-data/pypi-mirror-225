...
class HWTestModuleOp(_ods_ir.OpView):
  ...
  def __init__(self, module_type, parameters, *, port_attrs=None, port_locs=None, comment=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_545')) else
      _ods_ir.AttrBuilder.get('anonymous_545')(module_type, context=_ods_context))
