...
"""
    ...
    The version of the OpenAPI document: 0.0.821
...
class UpdateJobRequest(object):
    ...
    def __init__(self, name=None, author=None, description=None, image_name=None, image_tag=None, ttl=None, min_cpu=None, max_cpu=None, min_memory=None, max_memory=None, argument_definitions=None, command_line_argument_separator=None, required_resources=None, local_vars_configuration=None):  # noqa: E501
