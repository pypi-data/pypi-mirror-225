...
from vineseg import QT5
from vineseg.shape import Shape
import vineseg.utils
...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseReleaseEvent(self, ev):
        ...
        if self.movingShape and self.hShape:
            ...
            if (
                ...
                self.setMovedLabel(index, "Neuron manual", {})
                self.selectedShapes = [self.shapes[index]]
    ...
    def closeEnough(self, p1, p2):
        ...
        return vineseg.utils.distance(p1 - p2) < (self.epsilon / self.scale)
    ...
    def intersectingEdges(self, point1, point2, points):
        ...
        for i in range(4):
            ...
            if 0 <= ua <= 1 and 0 <= ub <= 1:
                ...
                d = vineseg.utils.distance(m - QtCore.QPoint(x2, y2))
                yield d, i, (x, y)
    ...
    def setMovedLabel(self, index, text, flags):
        assert text
        self.shapes[index].label = text
        self.shapes[index].flags = flags
        #self.shapesBackups[0].pop(index)
        self.storeShapes()
