...
def push(session: Session, metadata, workbook_context: WorkbookContext, datasource_output, sync_token,
    ...
    if (spy.utils.is_sdk_module_version_at_least(61, 1, 4) and not spy.utils.is_sdk_module_version_at_least(62)) or \
            spy.utils.is_sdk_module_version_at_least(62, 0, 1):
