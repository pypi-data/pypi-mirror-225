...
class OrderEntry(object):
    ...
    def clearing_acct_type(self):
        ...
        Defines if the order is entered on own account or as an agent. For the set of valid values please refer to values from attribute allowedClearingAcctTypes in SystemInfoResp message (e.g. A or P for spot markets)  # noqa: E501
