...
class MessagesApi(object):
    ...
    def get_messages(self, **kwargs):  # noqa: E501
        ...
        Allows you to retrieve communication from the exchange's backend system with the trading server backend for debugging purposes. Only master-API-keys can call this method.  # noqa: E501
