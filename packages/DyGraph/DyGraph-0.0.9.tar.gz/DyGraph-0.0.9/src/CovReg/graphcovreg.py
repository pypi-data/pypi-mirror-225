...
class GraphCovReg(CovReg):
    ...
    def fit_ggp(self, psi = None, F_start = None, reg = None, type_reg = None, F_method = 'direct', c = None, verbose = True)-> None:
        """
        ...
        while self.iteration <self.max_iter:
            C, Psi_est, F, tol_i = self.one_iteration(np.linalg.inv(Psi_pre_inv), psi, C_pre, c, Y_tilde, F_pre = F_pre, with_mean = True)    
