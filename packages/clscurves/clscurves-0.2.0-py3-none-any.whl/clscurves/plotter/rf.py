...
class RFPlotter(MetricsPlotter):
    ...
    def plot_rf(
        ...
        weighted
            ...
            all positive cases. For the RF curve, this weighting applies only
            to the TPR axis.
        scale
            Value to scale the x-axis by. By choosing a lower number like 0.1,
            you can observe greater detail in sensitive regions of the RF
            curve.
        title
            Title of plot.
        cmap
