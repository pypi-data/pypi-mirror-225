...
# body param
SchemaForRequestBodyApplicationJson = CitedDocument


request_body_cited_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remember_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_cited_document.serialize(body, content_type)
