...
from NEMO_billing.prepayments.models import Fund, FundType, ProjectPrepaymentDetail, number_of_months_between_dates
...
class TestProjectPrepayments(TestCase):
    ...
    def test_non_tax_exempt_configuration(self):
        ...
        self.assertEqual(self.project_prepayment.get_charges_amount_between(start, end)[1], 33)
