...
setup(
    ...
    name="vgis_ai",  # Required 项目名称
    version="1.0.3",  # Required 发布版本号
    description="A libary for ai operator",  # Optional 项目简单描述
    long_description=long_description,  # Optional 详细描述
    long_description_content_type="text/markdown",  # 内容类型
    url="https://github.com/gisfanmachel/vgisAi",  # Optional github项目地址
    ...
    install_requires=["opencv-python", "GDAL", "Pillow", "numpy", "pandas", "loguru", "scikit-learn", "scipy",
                      "baidu-aip",
                      "requests", "vgis_utils","vgis_log"],
    # Optional 第三方依赖库
