...
#   filename:  <stdin>
#   timestamp: 2023-02-17T08:34:42+00:00
...
class Environment(BaseModel):
    local: PromoteInfo | None = None
    dev: PromoteInfo | None = None
    qa: PromoteInfo | None = None
    stagning: PromoteInfo | None = None
    prod: PromoteInfo | None = None
