...
#   filename:  <stdin>
#   timestamp: 2023-02-17T08:37:19+00:00
...
class HistoricalStateItem(BaseModel):
...
class NumberObject(BaseModel):
    ...
    total: int | None = None
    group: list[GroupItem] | None = None


class NumberInstallationByApplicationItem(BaseModel):
    quantity: int | None = None
    application: uuid.UUID | None = None


class NumberInstallationByVersionItem(BaseModel):
    quantity: int | None = None
...
class Summary(BaseModel):
    ...
    historical_state: list[HistoricalStateItem] | None = None
    number_objects: list[NumberObject] | None = None
    number_installation_by_application: list[NumberInstallationByApplicationItem] | None = None
    number_installation_by_version: list[NumberInstallationByVersionItem] | None = None
