...
class WappstoServiceBuilder:
    ...
    def update(self, data: dict | str, replace: bool = False) -> dict:
        """
        ...
        httpxupdate = httpx.patch if replace is False else httpx.put
...
class WappstoSessionBuilder(WappstoServiceBuilder):
    ...
    def update(self, data: WappstoSchema.update.Session, replace: bool = False) -> WappstoSchema.response.Session:
        r_data = super().update(data=data.json(exclude_none=True), replace=replace)
        return pydantic.parse_obj_as(
...
class WappstoUserBuilder(WappstoServiceBuilder):
    ...
    def update(self, data: WappstoSchema.update.User, replace: bool = False) -> WappstoSchema.response.User:
        r_data = super().update(data=data.json(exclude_none=True), replace=replace)
        return pydantic.parse_obj_as(
...
class WappstoNetworkBuilder(WappstoServiceBuilder):
    ...
    def update(self, data: WappstoSchema.update.Network, replace: bool = False) -> WappstoSchema.response.Network:
        r_data = super().update(data=data.json(exclude_none=True), replace=replace)
        return pydantic.parse_obj_as(
...
class WappstoDeviceBuilder(WappstoServiceBuilder):
    ...
    def update(self, data: WappstoSchema.update.Device, replace: bool = False) -> WappstoSchema.response.Device:
        r_data = super().update(data=data.json(exclude_none=True), replace=replace)
        return pydantic.parse_obj_as(
...
class WappstoValueBuilder(WappstoServiceBuilder):
    ...
    def update(self, data: WappstoSchema.update.Value, replace: bool = False) -> WappstoSchema.response.Value:
        r_data = super().update(data=data.json(exclude_none=True), replace=replace)
        return pydantic.parse_obj_as(
...
class WappstoStateBuilder(WappstoServiceBuilder):
    ...
    def update(self, data: WappstoSchema.update.State, replace: bool = False) -> WappstoSchema.response.State:
        r_data = super().update(data=data.json(exclude_none=True), replace=replace)
        return pydantic.parse_obj_as(
