...
import ntlm_auth_md5.compute_hash as comphash
import ntlm_auth_md5.compute_keys as compkeys
import ntlm_auth_md5.messages

from ntlm_auth_md5.des import DES
from ntlm_auth_md5.constants import AvId, AvFlags, NegotiateFlags
from ntlm_auth_md5.gss_channel_bindings import GssChannelBindingsStruct
...
class ComputeResponse():
    ...
    def get_nt_challenge_response(self, lm_challenge_response,
        ...
        if self._negotiate_flags & \
            ...
            if self._server_target_info is None:
                target_info = ntlm_auth_md5.messages.TargetInfo()
            else:
    ...
    def _get_NTLMv1_response(password, server_challenge):
        ...
        session_base_key = hashlib.new('md5', ntlm_hash).digest()
