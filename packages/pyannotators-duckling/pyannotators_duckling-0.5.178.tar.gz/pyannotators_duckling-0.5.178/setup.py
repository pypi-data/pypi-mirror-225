...
entry_points = \
{'pyannotators.plugins': ['duckling = '
                          'pyannotators_duckling.duckling:DucklingAnnotator']}

setup(name='pyannotators-duckling',
      version='0.5.178',
      description='Annotator based on Facebook Duckling',
      author='Olivier Terrier',
      author_email='olivier.terrier@kairntech.com',
      url='https://github.com/oterrier/pyannotators_duckling/',
      packages=packages,
