...
class CalculatedScalar(CalculatedItem):
    ...
    def push(self, session: Session, datasource_maps, datasource_output, *, pushed_workbook_id=None,
        ...
        if item_output is None:
            ...
            if (spy.utils.is_sdk_module_version_at_least(61, 1, 4) and not spy.utils.is_sdk_module_version_at_least(
                    62)) or spy.utils.is_sdk_module_version_at_least(62, 0, 1):
