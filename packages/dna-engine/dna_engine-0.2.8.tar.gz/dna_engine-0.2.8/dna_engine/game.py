...
class Game():
    ...
    def ask(prompt : str) -> str:
        ...
        text_box = pygame.Surface((Game.__game_render.get_size()[0], Game.__game_render.get_size()[1] / 8))
        text_box.fill((0, 0, 0))
        ...
        while Game.__text_entry_toggle == True:
            ...
            prompt_surface = font.render(prompt, pygame.Color(255, 255, 32))[0]
            text_surface = font.render(Game.__text_entry_field, pygame.Color(255, 255, 255))[0]
            
            fresh_render.blit(text_box, (0, 0))
            fresh_render.blit(prompt_surface, (10, 10))
            fresh_render.blit(text_surface, (10, 40))
