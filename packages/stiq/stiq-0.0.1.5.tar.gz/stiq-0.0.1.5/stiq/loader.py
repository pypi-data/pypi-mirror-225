...
def intraday_historical_data (ticker='VNM', date='2023-07-28', cookie=rv_cookie, headers=rv_headers):
    ...
    col_label = ['Mã CK', 'Sàn GD', 'Thời gina', 'Giá tham chiếu', 'Giá trần', 'Giá sàn', 'Giá mua 3', 'KL mua 3', 'Giá mua 2', 'KL mua 2', 'Giá mua 1', 'KL mua 1', 'Giá bán 1', 'KL bán 1', 'Giá bán 2', 'KL bán 2', 'Giá bán 3', 'KL bán 3', 'Giá khớp lệnh', 'KL khớp lệnh', 'Tổng KL khớp lệnh', '+/- khớp lệnh', 'Giá cao', 'Giá thấp', 'Giá TB', 'ĐTNN Mua', 'ĐTNN Bán', 'Buổi']
