...
from ppser import SUPPORT_MODEL, __version__
...
from ppser.utils.scheduler import cosine_decay_with_warmup
...
class PPSERTrainer(object):
    ...
    def __setup_dataloader(self, is_train=False):
        ...
        # 获取测试数据
        self.test_dataset = CustomDataset(data_list_path=self.configs.dataset_conf.train_list,
                                          audio_featurizer=self.audio_featurizer,
                                          scaler_path=self.configs.dataset_conf.scaler_path,
                                          do_vad=self.configs.dataset_conf.do_vad,
