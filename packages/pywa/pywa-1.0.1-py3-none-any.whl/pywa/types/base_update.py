...
from .media import MediaUrlToCache
...
class BaseUpdate(ABC):
    ...
    def reply_image(
        ...
        Args:
            image: The image to reply with (either a media ID, URL, ``MediaUrlToCache`` obj, file path, bytes, or an open() file).
    ...
    def reply_video(
        ...
        Args:
            video: The video to reply with (either a media ID, URL, ``MediaUrlToCache`` obj, file path, bytes, or an open() file).
    ...
    def reply_document(
        ...
        Args:
            document: The document to reply with (either a media ID, URL, ``MediaUrlToCache`` obj, file path, bytes, or an open() file).
    ...
    def reply_audio(
        ...
        Args:
            audio: The audio file to reply with (either a media ID, URL, ``MediaUrlToCache`` obj, file path, bytes, or an open() file).
    ...
    def reply_sticker(
        ...
        Args:
            sticker: The sticker to reply with (either a media ID, URL, ``MediaUrlToCache`` obj, file path, bytes, or an open() file).
