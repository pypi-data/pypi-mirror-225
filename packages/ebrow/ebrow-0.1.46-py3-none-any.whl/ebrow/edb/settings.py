...
class Settings(QSettings):
    ...
    def __init__(self, iniFullPath):
        ...
        self._stats = ['classFilterStat', 'showValues', 'showGridStat', 'currentColormapStat', 'RMOBfilePrefix']
        ...
        self._filters = ['ESDfilter', 'ESDfilterThreshold', 'SATfilter', 'SATfilterThreshold', 'CAR1filter',
                         'CAR1filterThreshold', 'CAR2filter', 'CAR2filterThreshold', 'LOSfilter', 'LOSfilterThreshold',
        ...
        d['RMOBfilePrefix'] = None

        # filters
        d['ESDfilter'] = 1
        d['ESDfilterThreshold'] = 20.0
        d['SATfilter'] = 1
        d['SATfilterThreshold'] = 50.0
        d['CAR1filter'] = 1
        d['CAR1filterThreshold'] = 12.0
        d['CAR2filter'] = 1
        d['CAR2filterThreshold'] = 10.0
        d['LOSfilter'] = 1
        d['LOSfilterThreshold'] = 1.0
        d['underdenseMs'] = 200
        d['overdenseSec'] = 50
        d['acqActive'] = 0
    ...
    def readSettingAsString(self, key: str):
        d = self._settings
