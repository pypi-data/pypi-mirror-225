...
class ModelParameter(object):
    def __init__(self, key: str = '', description: str = '', defaultValue: str = ''):
        self.key = key
...
class ModelDatasetItem(object):
    def __init__(self, datasetName: str = '', datasetType: str = '', datasetDes: str = '', externalId: str = None, UdxContent: str = None):
...
class ModelEvent(object):
    def __init__(self, eventName: str = '', eventType: str = '', eventDescription: str = '', dataRef: str = '', parameterDes: str = '', optional: bool = True, multiple: bool = False):
...
class ModelState(object):
    def __init__(self, stateId: str = '', stateName: str = '', stateType: str = '', stateDes: str = '', events: list = []):
...
class ModelStateTransition(object):
    def __init__(self, sfrom: str = '', sto: str = ''):
        self.sfrom = ''
        self.sto = ''
