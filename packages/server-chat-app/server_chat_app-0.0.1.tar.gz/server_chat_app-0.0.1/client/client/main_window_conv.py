...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Chat alpha release"))
        self.label_contacts.setText(_translate("MainClientWindow", "List of contacts:"))
        ...
        self.btn_send.setText(_translate("MainClientWindow", "Send a message"))
        self.btn_clear.setText(_translate("MainClientWindow", "Clear the field"))
