...
def get_contact_by_id(contact_id):
    try:
        ...
        return result
            ...
            logger_local.exception(f"Contact.get_contact_by_id Error: {err}", object=err)
...
def get_contact_by_first_name(first_name):
    try:
        ...
        return result
            ...
            logger_local.exception(f"Contact.get_contact_by_first_name Error: {err}", object=err)
