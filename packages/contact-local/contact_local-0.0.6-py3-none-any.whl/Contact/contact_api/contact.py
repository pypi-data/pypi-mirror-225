...
from circles_local_database_python import generic_crud
...
class contact(generic_crud.GenericCRUD): 
    ...
    def insert(first_name,last_name,phone,
        ...
        try:
            ...
            logger_local.exception(f"Contact.insert Error: {err}", object=err)
        finally:
            logger_local.end("contact added" , object = {'first_name': first_name} )
    ...
    def update(person_id, name_prefix, first_name, additional_name, job_title, id):
        try:
            ...
            logger_local.exception(f"Contact.update Error: {err}", object=err)
        finally:
            logger_local.end("contact updated" , object = {'id': id} )
            cursor.close()
    ...
    def delete(contact_id):
        try:
            ...
            logger_local.exception(f"Contact.delete Error: {err}", object=err)
        finally:
            logger_local.end("contact deleted" , object = {'contact_id': contact_id} )
