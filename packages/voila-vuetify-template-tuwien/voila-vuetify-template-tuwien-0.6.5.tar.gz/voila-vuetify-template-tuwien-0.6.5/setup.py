...
class DevelopCmd(develop):
    prefix_targets = [
        ("nbconvert/templates", 'vuetify-base-tuwien'),
        ("nbconvert/templates", 'vuetify-default-tuwien'),
        ("voila/templates", 'vuetify-base-tuwien'),
        ("voila/templates", 'vuetify-default-tuwien'),
    ]
    def run(self):
