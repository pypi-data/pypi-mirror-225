...
class _GenerateAuthAcornRequest(_message.Message):
    __slots__ = ["auth_token", "expires", "permissions"]
    ...
    auth_token: str
    expires: _GenerateAuthAcornRequest.Expires
    permissions: _permissionmessages_pb2.Permissions
    def __init__(self, expires: _Optional[_Union[_GenerateAuthAcornRequest.Expires, _Mapping]] = ..., auth_token: _Optional[str] = ..., permissions: _Optional[_Union[_permissionmessages_pb2.Permissions, _Mapping]] = ...) -> None: ...

class _GenerateAuthAcornResponse(_message.Message):
