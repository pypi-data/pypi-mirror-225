...
if major >= 4 or (major == 3 and minor >= 20):
    ...
    from .v4 import permissions_pb2 as permissions_pb2
    from .v4 import permissions_pb2_grpc as permissions_pb2_grpc
    ...
    from .v319 import permissions_pb2 as permissions_pb2
    from .v319 import permissions_pb2_grpc as permissions_pb2_grpc
...
__all__ = ["auth_pb2", "auth_pb2_grpc", "cacheclient_pb2", "cacheclient_pb2_grpc", "cachepubsub_pb2", "cachepubsub_pb2_grpc", "controlclient_pb2", "controlclient_pb2_grpc", "extensions_pb2", "extensions_pb2_grpc", "permissions_pb2", "permissions_pb2_grpc", "token_pb2", "token_pb2_grpc", "vectorindex_pb2", "vectorindex_pb2_grpc"]