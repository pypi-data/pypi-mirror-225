...
def validate_class(ontology_data: List[OntologyInfo], item: Union[FileInfo, DirInfo]) -> bool:
    from sonusai import logger
...
def validate_ontology(ontology: str, items: Union[List[FileInfo], List[DirInfo]]) -> List[OntologyInfo]:
    from os.path import exists
