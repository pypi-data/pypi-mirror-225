...
def lsdb(mixdb: MixtureDatabase,
    ...
    logger.info(f'{"Feature shape":{desc_len}} {mixdb.fg.stride} x {mixdb.fg.num_bands} '
                f'({mixdb.fg.stride * mixdb.fg.num_bands} total params)')
    ...
    if list_targets:
        ...
        idx_len = max_text_width(len(mixdb.targets))
