...
class GeneralExperienceTest(unittest.TestCase):
    ...
    def test_str(self):
        ...
        edu=GeneralExperience(Institution=instit, Specialization=special)
        self.assertTrue(str(edu)=='{} at {}'.format(special, instit))
...
class CandidateTest(unittest.TestCase):
    def test_init(self):
        ...
        self.assertNotEqual(summary_text.find(name), -1)
        self.assertNotEqual(summary_text.find(workplace), -1)
    ...
    def test_eq_from_summaries(self):
        work_experience_list=[WorkExperience(Institution="new york times", Specialization="reporter")]
        education_experience_list=[EducationExperience(Institution="harvard", Specialization="english")]
        cand_0=Candidate(Name="nick kristof",WorkExperienceList=work_experience_list,
                         EducationExperienceList=education_experience_list)
        cand_1=Candidate( Name="nicholas kristof", WorkExperienceList=work_experience_list,
                         EducationExperienceList=education_experience_list)
        self.assertTrue(cand_0==cand_1)
