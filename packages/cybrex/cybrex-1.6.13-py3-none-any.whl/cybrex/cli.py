...
class CybrexCli:
    ...
    async def chat_doc(self, document_query: str, query: str, n_chunks: int = 5, minimum_score: float = 0.5):
        """
        Ask a question about content of source_document identified by DOI.

        :param document_query: query that returns unique source_document
        :param query: Text query to the source_document
    ...
    async def sum_doc(self, document_query: str):
        """
        Summarization of the source_document
