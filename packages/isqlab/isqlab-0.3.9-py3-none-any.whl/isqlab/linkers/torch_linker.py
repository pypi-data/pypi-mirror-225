...
from isqlab.neural_networks import NeuralNetwork
...
class TorchLinker(Module):
        ...
        def backward(ctx: Any, grad_output: Tensor) -> Tuple:  # type: ignore
            ...
            if input_grad is not None:
                if neural_network.sparse:
                    input_grad = sparse_coo_tensor(
                        input_grad.coords, input_grad.data)
    ...
    def forward(self, input_data: Optional[Tensor] = None) -> Tensor:
        ...
        return TorchLinker._TorchNNFunction.apply(
