...
"""
A Neural Network abstract class for all.
...
class NeuralNetwork(ABC):
    ...
    def _validate_input(
        self, input_data: Union[float, List[float], np.ndarray, None]
    ...
    def _validate_weights(
        self, weights: Union[float, List[float], np.ndarray, None]
    ) -> Optional[np.ndarray]:
        if weights is None:
            return None
    ...
    def forward(
        self,
        input_data: Union[float, List[float], np.ndarray, None],
        weights: Union[float, List[float], np.ndarray, None],
    ) -> np.ndarray:
