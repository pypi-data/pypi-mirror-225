...
from ..utils.helpers import file_path, load_yaml
...
class AnalysisCreatorUi(QtWidgets.QDialog):
    def __init__(self):
        ...
        uic.loadUi(pkg_resources.resource_filename(
            "neuronautics.ui", "analysis-creation.ui"
        ), self)
...
class AnalysisCreator:
    ...
    def create(cls, name, type):
        ...
        with open(pkg_resources.resource_filename("neuronautics.analysis.templates", jinja_template)) as file_:
