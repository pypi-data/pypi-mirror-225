...
class ContentGemApi(object):
    ...
    def create_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/gem/gem/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool prerelease: Filter results where prerelease matches value
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedgemGemContentResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/gem/gem/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedgemGemContentResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def read(self, gem_gem_content_href,  **kwargs):  # noqa: E501
        """Inspect a gem content  # noqa: E501

        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(gem_gem_content_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str gem_gem_content_href: (required)
        :param list[str] fields: A list of fields to include in the response.
        :param list[str] exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(gem_gem_content_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, gem_gem_content_href,  **kwargs):  # noqa: E501
        """Inspect a gem content  # noqa: E501

        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(gem_gem_content_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GemGemContentResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('gem_gem_content_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['gem_gem_content_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `gem_gem_content_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'gem_gem_content_href' in local_var_params:
            path_params['gem_gem_content_href'] = local_var_params['gem_gem_content_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GemGemContentResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
