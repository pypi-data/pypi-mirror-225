...
class PublicationsGemApi(object):
    ...
    def create(self, gem_gem_publication,  **kwargs):  # noqa: E501
        """Create a gem publication  # noqa: E501

        Trigger an asynchronous task to publish gem content  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(gem_gem_publication, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param GemGemPublication gem_gem_publication: (required)
        ...
        return self.create_with_http_info(gem_gem_publication,  **kwargs)  # noqa: E501

    def create_with_http_info(self, gem_gem_publication,  **kwargs):  # noqa: E501
        """Create a gem publication  # noqa: E501

        Trigger an asynchronous task to publish gem content  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(gem_gem_publication, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('gem_gem_publication' not in local_var_params or  # noqa: E501
                                                        local_var_params['gem_gem_publication'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `gem_gem_publication` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'gem_gem_publication' in local_var_params:
            body_params = local_var_params['gem_gem_publication']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/publications/gem/gem/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete(self, gem_gem_publication_href,  **kwargs):  # noqa: E501
        """Delete a gem publication  # noqa: E501

        A ViewSet for GemPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(gem_gem_publication_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str gem_gem_publication_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(gem_gem_publication_href,  **kwargs)  # noqa: E501

    def delete_with_http_info(self, gem_gem_publication_href,  **kwargs):  # noqa: E501
        """Delete a gem publication  # noqa: E501

        A ViewSet for GemPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(gem_gem_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('gem_gem_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['gem_gem_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `gem_gem_publication_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'gem_gem_publication_href' in local_var_params:
            path_params['gem_gem_publication_href'] = local_var_params['gem_gem_publication_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{gem_gem_publication_href}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedgemGemPublicationResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/publications/gem/gem/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedgemGemPublicationResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def read(self, gem_gem_publication_href,  **kwargs):  # noqa: E501
        """Inspect a gem publication  # noqa: E501

        A ViewSet for GemPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(gem_gem_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(gem_gem_publication_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, gem_gem_publication_href,  **kwargs):  # noqa: E501
        """Inspect a gem publication  # noqa: E501

        A ViewSet for GemPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(gem_gem_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GemGemPublicationResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('gem_gem_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['gem_gem_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `gem_gem_publication_href` when calling `read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GemGemPublicationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
