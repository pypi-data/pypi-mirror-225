...
def add_viewbox_transformation(transformation: Transformation, transform_origin, vwbox, origin, scale):
    ...
    if transform_origin:
        ...
        #scale = (0.0,0.0) if scale is None else scale
        ...
        #up_transformation.add_translation(vwbox["x"] + origin[0],vwbox["y"] - (vwbox["y"] * .5) + origin[1])
        #up_transformation.add_translation(vwbox["x"] + origin[0],vwbox["y"] - (vwbox["height"] * .5) + origin[1])
        ...
        #scale = (1.0,1.0) if scale is None else scale
        ...
        #up_transformation.add_scale(scale[0], -scale[1])                          # T * Scale
