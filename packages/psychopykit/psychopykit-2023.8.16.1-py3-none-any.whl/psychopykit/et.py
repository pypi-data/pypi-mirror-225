...
class EyeTracking:
    ...
    def __init__(self, hdf5_fname):
        ...
        print(f'Loading eyetracking data from {self._hdf5_fname}')
        self.load_hdf5()
    ...
    def to_bids(self, out_dir, bids_stub):
        ...
        tsv_fname = f'{bids_stub}.tsv'
        json_fname = f'{bids_stub}.json'
        log_fname = f'{bids_stub}.log'

        # Subset of dataframe columns to save
        req_cols = ['Time', 'GazeX', 'GazeY', 'PupilMeasure1', 'Status']
    ...
    def load_hdf5(self):
        ...
        with h5py.File(self._hdf5_fname, 'r') as f:
            ...
            if op.isfile(self._log_fname):
                print(f'Loading PsychoPy log file {self._log_fname}')
    ...
    def get_sampling_freq(self):
        ...
        print(f'\nMedian samp interval : {dt * 1e3:0.3f} ms')
