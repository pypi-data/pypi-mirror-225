...
class CraftAiSdk:
    ...
    _version = "0.23.2rc1"  # Would be better to share it somewhere
    ...
    def create_step(
        ...
        Returns:
            ...
            * ``"name"`` (:obj:`str`): Step name.
            * ``"inputs"`` (:obj:`list` of :obj:`dict`): List of inputs represented as
    ...
    def get_step(self, step_name):
        ...
        returned_keys = (
            ...
            "inputs",
            "outputs",
            "built_repository_branch",
            "built_repository_url",
            "commit_id",
        )
        returned_dict = {key: step[key] for key in returned_keys if key in step}
        returned_dict["repository_branch"] = returned_dict.pop(
            "built_repository_branch"
        )
        returned_dict["repository_url"] = returned_dict.pop("built_repository_url")
    ...
    def list_steps(self):
        ...
        for step in result:
            step["repository_branch"] = step.pop("built_repository_branch")
            step["repository_url"] = step.pop("built_repository_url")
        return result
    ...
    def update_step(
        ...
        Returns:
            :obj:`dict[str, str]`: The updated step represented as a :obj:`dict` with
            the following keys:
    ...
    def get_pipeline_execution(self, pipeline_name, execution_id):
        ...
        Returns:
            ...
            * ``"inputs"`` (:obj:`list` of :obj:`dict`): List of inputs represented
              ...
              * ``"mapping_value"`` (:obj:`dict`): Sources used to run the execution.
            * ``"outputs"`` (:obj:`list` of :obj:`dict`): List of outputs represented
              as a dict with the following keys:

              * ``"step_output_name"`` (:obj:`str`): Name of the output.
              * ``"mapping_value"`` (:obj:`dict`): Destinations used to run the
                execution.
        """
