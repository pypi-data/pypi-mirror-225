...
DESCRIPTION = 'Proyecto desarrollado con el propósito de agilizar la creación de páginas web mediante el uso del framework Flask'
...
setup(
    ...
    install_requires=['colorama', 'flask', 'python-dotenv', 'Flask-WTF', 'flask-sqlalchemy', 'email_validator'],
    keywords=['python'],
    classifiers=[
