...
class Cascabel:
    ...
    def create_new_project(self):
        ...
        template_dir = f'{file_dir}/data/template-1.0a2/project/'
    ...
    def make_controller(self):
        ...
        controller_template_dir = f'{file_dir}/data/template-1.0a2/controller/simple_controller.py'
    ...
    def make_request(self):
        ...
        request_template_dir = f'{file_dir}/data/template-1.0a2/request/request.py'
    ...
    def make_crud_controller(self):
        ...
        project_dir  = f'{cmd_dir}/'
        controller_template_dir = f'{file_dir}/data/template-1.0a2/controller/manager_controller.py'
...
<body>
    ...
    def make_model(self):
        ...
        with open(model_file_path, "w") as file:
            model_template_dir = f'{file_dir}/data/template-1.0a2/model/model.py'
