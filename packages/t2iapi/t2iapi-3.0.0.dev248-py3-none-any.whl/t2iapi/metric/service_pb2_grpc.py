...
class MetricServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChangeOperationModeStatus = channel.unary_unary(
                '/t2iapi.metric.MetricService/ChangeOperationModeStatus',
                request_serializer=t2iapi_dot_metric_dot_metric__requests__pb2.ChangeOperationModeStatusRequest.SerializeToString,
                response_deserializer=t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
                )
...
def add_MetricServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ChangeOperationModeStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.ChangeOperationModeStatus,
                    request_deserializer=t2iapi_dot_metric_dot_metric__requests__pb2.ChangeOperationModeStatusRequest.FromString,
                    response_serializer=t2iapi_dot_basic__responses__pb2.BasicResponse.SerializeToString,
            ),
...
class MetricService(object):
    ...
    @staticmethod
    def ChangeOperationModeStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/t2iapi.metric.MetricService/ChangeOperationModeStatus',
            t2iapi_dot_metric_dot_metric__requests__pb2.ChangeOperationModeStatusRequest.SerializeToString,
            t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
