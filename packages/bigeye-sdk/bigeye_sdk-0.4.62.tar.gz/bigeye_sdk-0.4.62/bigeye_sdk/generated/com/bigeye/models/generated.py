...
@dataclass
class RunMetricJob(betterproto.Message):
    """* StatisticJob representation"""
...
class ApplicableColumnsTablesResponse(betterproto.Message):
    columns: List["ColumnApplicableMetricTypes"] = betterproto.message_field(1)
...
class BulkMetricConfiguration(betterproto.Message):
    ...
    metric_group_overrides: List["MetricGroupOverride"] = betterproto.message_field(13)
    metric_schedule: "MetricSchedule" = betterproto.message_field(14)
    run_backfill: bool = betterproto.bool_field(15)
