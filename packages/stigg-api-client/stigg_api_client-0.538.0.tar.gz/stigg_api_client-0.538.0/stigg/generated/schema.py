...
class TransferSubscriptionInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('customer_id', 'dst_resource_id', 'src_resource_id')
    customer_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='customerId')
    dst_resource_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='dstResourceId')
    src_resource_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='srcResourceId')
