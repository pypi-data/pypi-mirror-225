...
from convisoappsec.flow.graphql_api.beta.models.issues.sast import (
        ...
        for report_path in reports:
            ...
            for issue in issues:
                issue_model = CreateSastFindingInput(
                    ...
                    deploy_id=deploy_id,
                    fingerprint=issue.get("hash_issue"),
...
@click.option(
    "--deploy-id", default=None, required=False, hidden=True, envvar="FLOW_DEPLOY_ID"
)
@click.option(
    "--sastbox-registry",
    default="",
