...
class Respuesta(BaseModel):
    ...
    def build_xml(self):
        ...
        respuesta = etree.Element('respuesta', xlmns='http://www.praxis.com.mx/')
        mensaje = etree.SubElement(respuesta, 'mensaje', {qname: 'mensaje'}, categoria=self.categoria)  # noqa: E501
