...
function GetOciSubcommands_opsi() {
    $ociSubcommands = @{
        'opsi' = 'awr-hubs database-insights enterprise-manager-bridges exadata-insights host-insights news-report news-reports operations-insights-warehouse-users operations-insights-warehouses opsi-configurations opsi-data-objects opsi-private-endpoint work-requests'
...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi news-reports create' = 'compartment-id content-types defined-tags description freeform-tags from-json help locale max-wait-seconds name news-frequency ons-topic-id status wait-for-state wait-interval-seconds'
        ...
        'opsi news-reports update' = 'content-types defined-tags force freeform-tags from-json help if-match locale max-wait-seconds news-frequency news-report-id ons-topic-id status wait-for-state wait-interval-seconds'
