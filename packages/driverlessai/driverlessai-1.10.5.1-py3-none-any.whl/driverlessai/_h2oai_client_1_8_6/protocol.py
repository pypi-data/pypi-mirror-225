...
class Client:
    @ignore_unexpected_kwargs
    def __init__(self, address: str, username: Optional[str] = None, password: Optional[str] = None, verify=True, cert=None, use_tls_authentication: bool = False, **kwargs) -> None:
    ...
    # PATCHED
    @ignore_unexpected_kwargs
    def upload_experiment_artifacts(self, model_key: str, user_note: str, artifact_path: str, name_override: str, **kwargs) -> str:
        """
