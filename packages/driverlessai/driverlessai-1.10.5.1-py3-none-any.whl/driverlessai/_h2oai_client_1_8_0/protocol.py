...
# 1.8.0
Client.update_dataset_name = protocol_patches_1_8.update_dataset_name
Client.list_datasets_with_similar_name = protocol_patches_1_8.list_datasets_with_similar_name
Client.get_data_recipe_preview = protocol_patches_1_8.get_data_recipe_preview
Client.modify_dataset_by_recipe_file = protocol_patches_1_8.modify_dataset_by_recipe_file
Client.modify_dataset_by_recipe_url = protocol_patches_1_8.modify_dataset_by_recipe_url
