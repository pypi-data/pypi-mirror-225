...
def is_server_job_failed(server_job_status: Union[int, JobStatus]) -> bool:
    return server_job_status == JobStatus.FAILED
...
def beta(func):  # type: ignore
    ...
    warn_msg = "A :ref:`beta API <beta-api>` that is subject to future changes."
    _wrapper.__doc__ = (_wrapper.__doc__ or "") + "\n\n.. warning::\n\t" + warn_msg
    return _wrapper
