...
class Client:
    ...
    def _request(self, method: str, params: dict) -> Any:
        ...
        res = self._session.post(self.address + "/rpc", data=req, headers=headers)
        if res.status_code != requests.codes.ok:
            raise RequestError(
    ...
    def perform_upload(self, file_path, skip_parse=False):
        ...
        with open(file_path, 'rb') as f:
            ...
            res = self._session.post(url, files={'dataset': f}, headers=headers)
    ...
    # PATCHED
    @ignore_unexpected_kwargs
    def upload_experiment_artifacts(self, model_key: str, user_note: str, artifact_path: str, name_override: str, repo: str, branch: str, username: str, password: str, **kwargs) -> str:
        """
...
Client.interpretation_url_path = "/mli"
Client.ts_interpretation_url_path = "/mli-ts"
