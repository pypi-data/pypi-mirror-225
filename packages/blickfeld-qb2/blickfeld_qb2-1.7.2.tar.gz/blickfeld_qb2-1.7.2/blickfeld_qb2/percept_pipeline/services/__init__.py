...
# sources: blickfeld/percept_pipeline/services/data_source.proto, blickfeld/percept_pipeline/services/health.proto, blickfeld/percept_pipeline/services/perception.proto, blickfeld/percept_pipeline/services/runtime_action.proto, blickfeld/percept_pipeline/services/zone.proto
...
@dataclass(eq=False, repr=False)
class RuntimeActionGetTareVolumeRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class RuntimeActionGetTareVolumeResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class RuntimeActionResetBackgroundRequest(betterproto.Message):
    """
...
class RuntimeAction(betterproto.ServiceStub):
    """
    The RuntimeAction service enables the system to execute runtime actions and
    updates on a running pipeline.
    """
    ...
    async def async_get_tare_volume(
        ...
        *,
        ...
        request = RuntimeActionGetTareVolumeRequest()
        request.zone_uuid = zone_uuid

        return await self._unary_unary(
            "/blickfeld.percept_pipeline.services.RuntimeAction/GetTareVolume",
            request,
            RuntimeActionGetTareVolumeResponse,
            timeout=timeout,
            deadline=deadline,
    ...
    async def async_reset_background(
        ...
        *,
        ...
        request = RuntimeActionResetBackgroundRequest()
        request.fqdns = fqdns

        return await self._unary_unary(
            "/blickfeld.percept_pipeline.services.RuntimeAction/ResetBackground",
            request,
            betterproto_lib_google_protobuf.Empty,
            timeout=timeout,
            deadline=deadline,
