...
class PromptTemplateColumnNames(NamedTuple):
...
class LLMConfigColumnNames(NamedTuple):
    model_handle_column_name: Optional[str] = None
    model_params_column_name: Optional[str] = None
    """TBD
    """
