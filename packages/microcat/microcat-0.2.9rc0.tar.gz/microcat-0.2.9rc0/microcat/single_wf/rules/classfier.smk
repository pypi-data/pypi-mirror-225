...
rule paired_bam_to_fastq:
    ...
    shell:
        '''
        bash /data/project/host-microbiome/microcat/microcat/single_wf/scripts/paired_bam_to_fastq_script.sh {input.unmapped_bam_sorted_file} {output.unmapped_r1_fastq} {output.unmapped_r2_fastq} {output.unmapped_fastq} {threads}
        '''
