...
lino.modlib.printing.Printable.get_printable_demo_objects()."""),
    'lino_welfare.modlib.isip.ContractPartnerBase' : _("""Model mixin for integration contracts
...
octroyé par la Wallonie."""),
    ...
    'lino_welfare.modlib.jobs.JobSupplyment' : _("""Model mixin for jobs.Contract
