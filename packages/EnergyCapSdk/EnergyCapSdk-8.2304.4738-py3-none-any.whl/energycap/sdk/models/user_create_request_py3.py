...
class UserCreateRequest(Model):
    ...
    def __init__(self, *, user_code: str, full_name: str, password: str, email: str, password_expiration_interval: int, strong_password: bool, force_password_change: bool, user_role_id: int, cost_center_id: int=None, topmost_cost_center_ids=None, place_id: int=None, topmost_place_ids=None, active_directory: bool=None, active: bool=None, max_approval_amount: int=None, report_group_id: int=None, user_groups=None, **kwargs) -> None:
