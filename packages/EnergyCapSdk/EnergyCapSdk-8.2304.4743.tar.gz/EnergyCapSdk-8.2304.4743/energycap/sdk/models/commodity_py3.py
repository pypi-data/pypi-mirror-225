...
class Commodity(Model):
    ...
    def __init__(self, *, commodity_id: int=None, commodity_code: str=None, commodity_info: str=None, in_use_by_vendor: bool=None, common_use_unit=None, common_demand_unit=None, **kwargs) -> None:
