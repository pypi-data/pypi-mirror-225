...
class GHGDefaultSettingResponse(Model):
    ...
    def __init__(self, *, commodity_id: int=None, commodity_code: str=None, commodity_info: str=None, in_use_by_vendor: bool=None, default_scope_category=None, default_factor=None, **kwargs) -> None:
