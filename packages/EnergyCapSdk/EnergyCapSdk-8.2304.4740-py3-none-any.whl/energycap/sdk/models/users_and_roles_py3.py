...
class UsersAndRoles(Model):
    ...
    def __init__(self, *, permission_name: str=None, permission_code: str=None, view: bool=None, manage: bool=None, description: str=None, permission_category_name: str=None, is_licensed: bool=None, permission_id: int=None, **kwargs) -> None:
